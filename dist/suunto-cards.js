...
`;function Ne(e){return G`
  ...
  `}function Re(e,t,a=64,i=6){const s=Math.max(0,Math.min(100,e)),r=(a-i)/2,n=2*Math.PI*r,o=a/2;return G`
  ...
  `}function Me(e,t,a=300,i=56){if(e.length<2)return K;const s=e.map(e=>e.v),r=Math.min(...s),n=Math.max(...s)-r||1,o=.12*i,c=i-2*o,l=a/(e.length-1),d=e.map((e,t)=>[t*l,o+c-(e.v-r)/n*c]),u=d.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),m=`${u} L${a},${i} L0,${i} Z`,[h,p]=d[d.length-1];return G`
    <svg viewBox="0 0 ${a} ${i}" preserveAspectRatio="none" class="sparkline">
      ...
      <circle cx=${h} cy=${p} r="3" fill=${t}></circle>
    </svg>
  `}function De(e){const t=e.map(e=>e.v),a=Math.min(...t);return{min:a,span:Math.max(...t)-a||1}}function Ve(e,t=300,a=70,i=!0){const s=e.filter(e=>e.points.length>=2);if(0===s.length)return K;const r=.1*a,n=a-2*r,o=i?De(s.flatMap(e=>e.points)):void 0,c=s.map(e=>{const{min:a,span:i}=o??De(e.points),s=t/(e.points.length-1),c=e.points.map((e,t)=>[t*s,r+n-(e.v-a)/i*n]),l=c.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),[d,u]=c[c.length-1];return I`
      <path
        d=${l}
        fill="none"
        stroke=${e.colorVar}
  ...
  `}function He(e,t,a=300,i=70){if(0===e.length)return K;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return I`
  ...
  `}const Pe=new Set(["unknown","unavailable",""]);let Fe=class extends Te{static getConfigElement(){return document.createElement("suunto-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-goal-card",goal_km:50}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||Pe.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_goal.title"));const r=this._config.goal_km??50,n=Number(i.state),o=r>0?n/r*100:0,c=o>=100?"var(--sc-good)":"var(--sc-amber)";return G`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ve()],Fe.prototype,"_config",void 0),Fe=e([ue("suunto-weekly-goal-card")],Fe);let Le=class extends le{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return K;const e=we(this.hass);return G`
      ${e.length>1?G`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
              ...
              @value-changed=${this._deviceChanged}
            ></ha-device-picker>
          `:G`<div class="hint">${Se(this.hass,"editor.auto_detect")}</div>`}
  ...
  `,e([pe({attribute:!1})],Le.prototype,"hass",void 0),e([ve()],Le.prototype,"_config",void 0),Le=e([ue("suunto-goal-editor")],Le);const qe=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function Oe(e){if(e)for(const[t,a]of qe)if(t.test(e))return a;return"mdi:run-fast"}const Be={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};async function Ge(e,t,a,i="mean"){const s=new Date,r=new Date(s.getTime()-36e5*a),n=await e.callWS({type:"recorder/statistics_during_period",start_time:r.toISOString(),end_time:s.toISOString(),statistic_ids:[t],period:"hour",types:["mean","min","max","sum"]});return(n?.[t]??[]).map(e=>({t:e.start,v:Number(e[i])})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}function Ie(e){const t=[...e].sort((e,t)=>e.t-t.t),a=new Map;for(let e=1;e<t.length;e++){const i=t[e].v-t[e-1].v;if(!Number.isFinite(i)||i<0)continue;const s=new Date(t[e].t).toDateString();a.set(s,(a.get(s)??0)+i)}return[...a.entries()].map(([e,t])=>({t:new Date(e).getTime(),v:t})).sort((e,t)=>e.t-t.t)}function We(e){const t=new Map;for(const a of e){const e=new Date(a.t).toDateString(),i=t.get(e)??{sum:0,count:0};i.sum+=a.v,i.count+=1,t.set(e,i)}return[...t.entries()].map(([e,{sum:t,count:a}])=>({t:new Date(e).getTime(),v:t/a})).sort((e,t)=>e.t-t.t)}function Ke(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Ue(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function Ze(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Xe(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const Je=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Qe(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of Je)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const Ye=new Set(["unknown","unavailable",""]);let et=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||Ye.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),c=i("last_avg_hr"),l=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),m=i("last_pte"),h=i("last_epoc"),p=i("last_feeling"),v=i("last_tss"),g=i("last_cal_per_km"),y=i("last_cadence"),_=i("last_pct_hrmax"),f=i("last_workout_weather"),b=i("last_workout_tags"),w=i("last_workout_achievements"),k=o?Ke(Number(o.state)):void 0,x=void 0===d&&void 0!==u,$=p&&!Ye.has(p.state)?Number(p.state):void 0,z=m&&!Ye.has(m.state)?Number(m.state):void 0,S=w?Number(w.state):0;return G`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${r?G`${Qe(new Date(r.state),a.language)} ·
        ...
        <div class="stats">
          ...
          ${void 0!==z?G`
                <div class="stat">
                  ...
                  <div class="severity">
                    ${[1,2,3,4,5].map(e=>G`<i class=${e<=Math.round(z)?`on s${e}`:""}></i>`)}
                  </div>
                </div>
              `:K}
        </div>
        ...
        ${v||h||void 0!==$||g||y||_?G`
              ...
              <div class="secondary">
                ...
                ${void 0!==$?G`
                      <div class="sec-item">
                        <div class="feeling">
                          ${[1,2,3,4,5].map(e=>G`<i class=${e<=$?"on":""}></i>`)}
                        </div>
        ...
        ${f&&!Ye.has(f.state)?G`
              <div class="weather">
                ...
                ${f.attributes.condition?G`<span class="sep">·</span><span class="cond">${f.attributes.condition}</span>`:K}
                ${void 0!==f.attributes.wind_speed_kmh?G`
                      <span class="sep">·</span>
            ...
            `:K}
        ${b&&!Ye.has(b.state)||S>0?G`
              <div class="footer">
                ${b&&!Ye.has(b.state)?G`<span class="chip"><ha-icon icon="mdi:tag-outline"></ha-icon>${b.state}</span>`:K}
                ${S>0?G`
                      <span
                        class="chip accent"
    ...
    `}_stat(e,t,a,i=!1){return G`
      <div class="stat ${i?"hr":""}">
        <div class="stat-value">${e}<span class="unit">${t}</span></div>
        <div class="stat-label">${a}</div>
      </div>
    `}_secondary(e,t,a){return G`
      <div class="sec-item">
        <div class="sec-value">${e}${a?G` <span class="sec-unit">${a}</span>`:K}</div>
    ...
    `],e([ve()],et.prototype,"_config",void 0),et=e([ue("suunto-last-workout-card")],et);const tt=e=>`var(--sc-zone-${e})`;let at=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-zones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=[];for(let e=0;e<=5;e++){const s=t[`last_zone${e}`],r=s?a.states[s]:void 0;r&&!Number.isNaN(Number(r.state))&&i.push({n:e,minutes:Number(r.state),lower:r.attributes.lower_limit_bpm,upper:r.attributes.upper_limit_bpm})}const s=i.reduce((e,t)=>e+t.minutes,0);if(0===i.length||s<=0)return this._message("mdi:heart-pulse",Se(a,"empty.hr_zones.title"),Se(a,"empty.hr_zones.subtitle"));const r=t.last_workout_start,n=r?a.states[r]:void 0,o=Se(a,"card.hr_zones.last_workout");return G`
      <ha-card class="static">
        ...
        <div class="rows">
          ${i.map(e=>{const t=Ke(e.minutes),i=Math.round(e.minutes/s*100);return G`
              <div class="row">
    ...
    `],e([ve()],at.prototype,"_config",void 0),at=e([ue("suunto-hr-zones-card")],at);const it=new Set(["unknown","unavailable",""]);let st=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||it.has(s.state))return this._message("mdi:sleep",Se(a,"empty.sleep_readiness.title"),Se(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),c=i("sleep_rem"),l=i("sleep_quality"),d=i("sleep_spo2"),u=i("sleep_hrv"),m=i("hrv_baseline"),h=i("hrv_status"),p=i("resting_hr"),v=i("resting_hr_baseline"),g=i("readiness"),y=i("nap_duration"),_=i("sleep_avg_hr"),f=i("sleep_min_hr"),b=i("sleep_time"),w=i("unusual_recovery"),k=g&&!it.has(g.state)?Number(g.state):void 0,x=void 0!==k?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,k):void 0,$=u&&m&&!it.has(m.state)?Number(u.state)-Number(m.state):void 0,z=p&&v&&!it.has(v.state)?Number(p.state)-Number(v.state):void 0,S=[n&&!it.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:Se(a,"label.deep")}:void 0,o&&!it.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:Se(a,"label.light")}:void 0,c&&!it.has(c.state)?{flexGrow:Number(c.state),colorVar:"var(--sc-sleep-rem)",title:Se(a,"label.rem")}:void 0].filter(e=>void 0!==e),A=Ke(60*Number(s.state)),C=y&&!it.has(y.state)?Number(y.state):void 0,T=!!y?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(y.attributes.date)),E={duration:`${A.value} ${A.unit}`};return G`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${p?this._stat(String(Math.round(Number(p.state))),"bpm",void 0!==z?Se(a,"stat.resting_hr_delta",{delta:Xe(z)}):Se(a,"stat.resting_hr"),void 0!==z?z<=0?"good":"bad":void 0):K}
        ...
        ${S.length?G`
              <div class="stages">
                ...
                <div class="stage-legend">
                  ${S.map(e=>{const t=Ke(e.flexGrow);return G`
        ...
        ${h&&!it.has(h.state)||C||b&&!it.has(b.state)||"on"===w?.state?G`
              <div class="footer">
                ${"on"===w?.state?G`<span class="chip bad"><ha-icon icon="mdi:shield-alert-outline"></ha-icon>${Se(a,"chip.unusual_recovery")}</span>`:K}
                ${h&&!it.has(h.state)?(()=>{const e=function(e,t){return"low"===t?{colorVar:"var(--sc-warn)",label:Se(e,"band.hrv.low")}:"high"===t?{colorVar:"var(--sc-pulse)",label:Se(e,"band.hrv.high")}:{colorVar:"var(--sc-good)",label:Se(e,"band.hrv.balanced")}}(a,h.state);return G`<span class="chip" style="color:${e.colorVar}"
                        ><ha-icon icon="mdi:heart-flash"></ha-icon>${e.label}</span
                      >`})():K}
                ${C?G`<span class="chip accent">
                      <ha-icon icon="mdi:power-sleep"></ha-icon>${Se(a,T?"chip.nap":"chip.nap_earlier",{minutes:C})}
                    </span>`:K}
                ${b&&!it.has(b.state)?G`<span class="chip">
                      <ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.bedtime",{time:Ze(new Date(b.state),a.language)})}
                    </span>`:K}
              </div>
            `:K}
      </ha-card>
    `}_stat(e,t,a,i){return G`
      <div class="stat ${i??""}">
        <div class="stat-value">${e}<span class="unit">${t}</span></div>
        <div class="stat-label">${a}</div>
      </div>
    ...
    `],e([ve()],st.prototype,"_config",void 0),st=e([ue("suunto-sleep-readiness-card")],st);const rt=new Set(["unknown","unavailable",""]);let nt=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||rt.has(s.state))return this._message("mdi:battery-heart-variant",Se(a,"empty.recovery.title"));const r=i("is_recovering"),n=i("recovery_until"),o=i("recovery_time"),c=i("stress_state"),l=i("workout_today"),d=i("unusual_recovery"),u=Number(s.state),m=function(e,t){return t>=60?{colorVar:"var(--sc-good)",label:Se(e,"band.recovery.well")}:t>=30?{colorVar:"var(--sc-warn)",label:Se(e,"band.recovery.partial")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.recovery.low")}}(a,u),h="on"===r?.state;let p=Se(a,"band.recovery.fully");if(h&&n&&!rt.has(n.state)){const e=new Date(n.state).getTime()-Date.now();if(e>0){const t=Ke(e/6e4);p=Se(a,"band.recovery.recovering",{time:`${t.value} ${t.unit}`})}}return G`
      <ha-card class="static">
        ...
        ${c||o?G`
            ...
            `:K}
        ${"on"===l?.state||"on"===d?.state?G`
              <div class="footer">
                ${"on"===l?.state?G`<span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${Se(a,"chip.workout_logged_today")}</span>`:K}
                ${"on"===d?.state?G`<span class="chip bad"><ha-icon icon="mdi:shield-alert-outline"></ha-icon>${Se(a,"chip.unusual_recovery")}</span>`:K}
              </div>
            `:K}
      </ha-card>
    `}_stat(e,t,a){return G`
      <div class="stat">
        <div class="stat-value">${e}${t?G`<span class="unit">${t}</span>`:K}</div>
        <div class="stat-label">${a}</div>
      </div>
    `}};nt.styles=[Ee,je,n`
      .readiness-row {
    ...
    `],e([ve()],ct.prototype,"_config",void 0),e([ve()],ct.prototype,"_history",void 0),ct=e([ue("suunto-training-load-card")],ct);const lt=new Set(["unknown","unavailable",""]),dt=["var(--sc-amber)","var(--sc-pulse)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let ut=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-week-stats-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("weekly_time"),n=i("workouts_7d"),o=i("workouts_30d"),c=i("lifetime_by_activity");if(!s&&!c)return this._message("mdi:calendar-week",Se(a,"empty.week_stats.title"));const l=(c?.attributes.activities??[]).slice().sort((e,t)=>t.distance_km-e.distance_km),d=l.slice(0,5),u=l.length-d.length;return G`
      <ha-card class="static">
        <div class="header">
        ...
        ${d.length?G`
              ...
              <div class="lifetime">
                ...
                <div class="rows">
                  ${d.map((e,t)=>{const a=dt[t%dt.length];return G`
                      <div class="row">
                        <div
                    ...
                    `})}
                  ${u>0?G`<div class="row muted">
                        ${Ae(a,u,"chip.more_activity_one","chip.more_activity_other")}
                      </div>`:K}
                </div>
              </div>
            `:K}
        ${o&&!lt.has(o.state)?G`<div class="footer"><span class="chip">${Se(a,"chip.workouts_30d",{count:o.state})}</span></div>`:K}
      </ha-card>
    `}_stat(e,t,a){return G`
      <div class="stat">
        <div class="stat-value">${e}${t?G`<span class="unit">${t}</span>`:K}</div>
    ...
    `],e([ve()],ut.prototype,"_config",void 0),ut=e([ue("suunto-week-stats-card")],ut);const mt=new Set(["unknown","unavailable",""]);let ht=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-today-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps"),r=i("daily_energy"),n=i("current_hr"),o=i("workout_today"),c=i("is_recovering"),l=i("training_suggestion"),d=i("days_since_last_workout");if(!s&&!r&&!n)return this._message("mdi:pulse",Se(a,"empty.today.title"));const u=n&&!mt.has(n.state)?Math.round(Number(n.state)):void 0,m=l&&!mt.has(l.state)?l.state:void 0,h=m?function(e,t){switch(t){case"hard":return{colorVar:"var(--sc-good)",label:Se(e,"band.suggestion.hard"),icon:"mdi:fire"};case"moderate":return{colorVar:"var(--sc-pulse)",label:Se(e,"band.suggestion.moderate"),icon:"mdi:walk"};case"easy":return{colorVar:"var(--sc-warn)",label:Se(e,"band.suggestion.easy"),icon:"mdi:leaf"};default:return{colorVar:"var(--sc-bad)",label:Se(e,"band.suggestion.rest"),icon:"mdi:bed-clock"}}}(a,m):void 0,p=d&&!mt.has(d.state)?Number(d.state):void 0;return G`
      <ha-card class="static">
        ...
        ${"on"===o?.state||"on"===c?.state||h||void 0!==p&&p>0?G`
              <div class="footer">
                ${"on"===o?.state?G`<span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${Se(a,"chip.workout_today")}</span>`:K}
                ${"on"===c?.state?G`<span class="chip"><ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.recovering")}</span>`:K}
                ${h?G`<span class="chip" style="color:${h.colorVar}"
                      ><ha-icon icon="${h.icon}"></ha-icon>${h.label}</span
                    >`:K}
                ${void 0!==p&&p>0?G`<span class="chip"
                      ><ha-icon icon="mdi:calendar-clock-outline"></ha-icon>${Ae(a,p,"chip.days_since_one","chip.days_since_other")}</span
                    >`:K}
              </div>
            `:K}
      </ha-card>
    ...
    `],e([ve()],vt.prototype,"_config",void 0),vt=e([ue("suunto-lifetime-card")],vt);let gt=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recent-workouts-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[];return s&&0!==r.length?G`
      <ha-card class="static">
        ...
        <div class="scroll-list">
          ${r.map(e=>{const t=null!==e.duration_min?Ke(e.duration_min):void 0;return G`
              <div class="workout-row">
                ...
                <div class="row-stats">
                  ${null!==e.distance_km?G`<span>${e.distance_km} km</span>`:K}
                  ${null!==e.distance_km&&t?G`<span class="sep">·</span>`:K}
                  ${t?G`<span>${t.value} ${t.unit}</span>`:K}
                </div>
              </div>
            `})}
        </div>
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${c?G`${c.state}`:K}
              ${c&&l?G`<span class="sep">·</span>`:K}
              ${l?Qe(new Date(l.state),a.language):K}
            </div>
          </div>
        </div>

        ${this._mapEl&&this._mapKey===`${o}:${u}`?G`<div class="map-wrap">${this._mapEl}</div>`:K}
      ...
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        ...
        ${u.length?G`
              <div class="compact-stats">
                ${u.map((e,t)=>G`${t>0?G`<span class="sep">·</span>`:K}${e}`)}
              </div>
            `:K}
      </ha-card>
    ...
    `],e([ve()],St.prototype,"_config",void 0),e([ve()],St.prototype,"_ctlHistory",void 0),e([ve()],St.prototype,"_atlHistory",void 0),e([ve()],St.prototype,"_tsbHistory",void 0),St=e([ue("suunto-pmc-card")],St);const At=new Set(["unknown","unavailable",""]);let Ct=class extends Te{constructor(){super(...arguments),this._rhrHistory=[],this._hrvHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.resting_hr,i=t.sleep_hrv;if(!a&&!i)return;const s=[a,i].filter(e=>Boolean(e)).join(","),r=Date.now();if(!(s===this._historyKey&&r-this._historyFetchedAt<6e5)){this._historyKey=s,this._historyFetchedAt=r;try{const e=this.hass,[t,s]=await Promise.all([a?Ge(e,a,720,"mean"):Promise.resolve([]),i?Ge(e,i,720,"mean"):Promise.resolve([])]);this._rhrHistory=t,this._hrvHistory=s}catch{this._rhrHistory=[],this._hrvHistory=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("resting_hr"),r=i("sleep_hrv"),n=s&&!At.has(s.state),o=r&&!At.has(r.state);if(!n&&!o)return this._message("mdi:heart-pulse",Se(a,"empty.recovery_trends.title"));const c=i("resting_hr_baseline"),l=i("hrv_baseline"),d=n&&c&&!At.has(c.state)?Number(s.state)-Number(c.state):void 0,u=o&&l&&!At.has(l.state)?Number(r.state)-Number(l.state):void 0,m=[];return this._rhrHistory.length&&m.push({points:this._rhrHistory,colorVar:"var(--sc-pulse)"}),this._hrvHistory.length&&m.push({points:this._hrvHistory,colorVar:"var(--sc-amber)"}),G`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:heart-pulse"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ve()],Ht.prototype,"_config",void 0),Ht=e([ue("suunto-just-finished-card")],Ht);const Pt=new Set(["unknown","unavailable",""]);let Ft=class extends Te{constructor(){super(...arguments),this._stepsHistory=[],this._energyHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-activity-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Ge(this.hass,"suunto_app:steps",336,"sum"),Ge(this.hass,"suunto_app:energy",336,"sum")]);this._stepsHistory=Ie(e),this._energyHistory=Ie(t)}catch{this._stepsHistory=[],this._energyHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps");if(!s||Pt.has(s.state))return this._message("mdi:shoe-print",Se(a,"empty.activity_trends.title"));const r=i("daily_energy"),n=[];return this._stepsHistory.length&&n.push({points:this._stepsHistory,colorVar:"var(--sc-pulse)"}),this._energyHistory.length&&n.push({points:this._energyHistory,colorVar:"var(--sc-amber)"}),G`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ve()],Ft.prototype,"_config",void 0),e([ve()],Ft.prototype,"_stepsHistory",void 0),e([ve()],Ft.prototype,"_energyHistory",void 0),Ft=e([ue("suunto-activity-trends-card")],Ft);const Lt=new Set(["unknown","unavailable",""]);let qt=class extends Te{constructor(){super(...arguments),this._balanceHistory=[],this._stressHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-balance-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Ge(this.hass,"suunto_app:recovery_balance",336,"mean"),Ge(this.hass,"suunto_app:stress",336,"mean")]);this._balanceHistory=We(e),this._stressHistory=We(t)}catch{this._balanceHistory=[],this._stressHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Lt.has(s.state))return this._message("mdi:heart-flash",Se(a,"empty.recovery_balance_trend.title"));const r=i("stress_state"),n=[];return this._balanceHistory.length&&n.push({points:this._balanceHistory,colorVar:"var(--sc-pulse)"}),this._stressHistory.length&&n.push({points:this._stressHistory,colorVar:"var(--sc-amber)"}),G`
      <ha-card class="static">
        <div class="header">
    ...
    `}};function Wt(e){const t=Math.round(60*e);if(0===t)return"±0:00";const a=t>0?"+":"-",i=Math.abs(t);return`${a}${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`}It.styles=[Ee,je,n`
      .cal-grid {
        display: grid;
    ...
    `],e([ve()],It.prototype,"_config",void 0),It=e([ue("suunto-activity-calendar-card")],It);let Kt=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-workout-comparison-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[],n=s?function(e){const t=e[0];if(!t?.activity)return;const a=e.slice(1).find(e=>e.activity===t.activity);return a?{current:t,previous:a}:void 0}(r):void 0;if(!n)return this._message("mdi:compare",Se(a,"empty.workout_comparison.title"),Se(a,"empty.workout_comparison.subtitle"));const{current:o,previous:c}=n,l=null!==o.distance_km&&null!==c.distance_km?o.distance_km-c.distance_km:void 0,d=null!==o.duration_min&&null!==c.duration_min?o.duration_min-c.duration_min:void 0,u=null!==o.avg_hr&&null!==c.avg_hr?o.avg_hr-c.avg_hr:void 0,m=o.distance_km&&o.duration_min?o.duration_min/o.distance_km:void 0,h=c.distance_km&&c.duration_min?c.duration_min/c.distance_km:void 0,p=void 0!==m&&void 0!==h?m-h:void 0;return G`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${void 0!==m?this._stat(`${Math.floor(m)}:${String(Math.round(m%1*60)).padStart(2,"0")}`,"/km",void 0!==p?Se(a,"stat.pace_delta",{delta:Wt(p)}):Se(a,"stat.avg_pace")):K}
        </div>
      </ha-card>
    `}_stat(e,t,a){return G`
      <div class="stat">
    ...
    `],e([ve()],Zt.prototype,"_config",void 0),Zt=e([ue("suunto-milestones-card")],Zt);const Xt=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];let Jt=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-athlete-profile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.lifetime_by_activity,s=i?a.states[i]:void 0,r=s?.attributes.activities??[],n=t.workouts_recent,o=n?a.states[n]:void 0,c=o?.attributes.workouts??[];if(0===r.length||0===c.length)return this._message("mdi:account-star",Se(a,"empty.athlete_profile.title"));const l=[...r].sort((e,t)=>t.workouts-e.workouts)[0].activity,d=function(e){for(const[t,a]of Xt)if(t.test(e))return a;return"personality.activity.other"}(l),u=function(e){const t=e.filter(e=>Boolean(e.start)),a=t.filter(e=>{const t=new Date(e.start).getDay();return 0===t||6===t}).length,i=a/t.length;return i>=.6?"personality.schedule.weekend":i<=.25?"personality.schedule.weekday":"personality.schedule.balanced"}(c),m=function(e){const t={morning:0,afternoon:0,evening:0,night:0};for(const a of e){if(!a.start)continue;const e=new Date(a.start).getHours();e>=5&&e<12?t.morning++:e>=12&&e<18?t.afternoon++:e>=18&&e<23?t.evening++:t.night++}const a=Object.entries(t).sort((e,t)=>t[1]-e[1])[0][0];return{morning:{key:"personality.time.morning",icon:"mdi:weather-sunset-up"},afternoon:{key:"personality.time.afternoon",icon:"mdi:weather-sunny"},evening:{key:"personality.time.evening",icon:"mdi:weather-sunset"},night:{key:"personality.time.night",icon:"mdi:weather-night"}}[a]}(c);return G`
      <ha-card class="static">
        ...
        <div class="traits">
          <span class="chip accent"><ha-icon .icon=${Oe(l)}></ha-icon>${Se(a,d)}</span>
    ...
    `],e([ve()],Qt.prototype,"_config",void 0),Qt=e([ue("suunto-pace-trend-card")],Qt);let Yt=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-lap-splits-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.last_workout_laps,s=i?a.states[i]:void 0,r=s?.attributes.laps??[];if(!s||0===r.length)return this._message("mdi:flag-checkered",Se(a,"empty.lap_splits.title"),Se(a,"empty.lap_splits.subtitle"));const n=function(e){const t=e.map((e,t)=>({i:t,pace:e.pace_min_km})).filter(e=>null!==e.pace&&e.pace>0);return t.length>0?t.reduce((e,t)=>t.pace<e.pace?t:e).i:e.reduce((t,a,i)=>a.duration_minutes<e[t].duration_minutes?i:t,0)}(r),o=null!==r[n].pace_min_km&&r[n].pace_min_km>0?`${Ue(r[n].pace_min_km)}/km`:(()=>{const e=Ke(r[n].duration_minutes);return`${e.value} ${e.unit}`})(),c=r.map((e,t)=>{const i=Ke(e.duration_minutes),s=Se(a,"label.lap",{n:e.lap});return{value:e.duration_minutes,label:e.pace_min_km&&e.pace_min_km>0?`${s} · ${Ue(e.pace_min_km)}/km`:`${s} · ${i.value}${i.unit}`,colorVar:t===n?"var(--sc-good)":void 0}}),l=t.last_workout_start,d=l?a.states[l]:void 0,u=Se(a,"card.hr_zones.last_workout");return G`
      <ha-card class="static">
        ...
        <div class="scroll-list">
          ${r.map((e,t)=>{const a=Ke(e.duration_minutes);return G`
              <div class="lap-row">
                <div class="lap-number ${t===n?"fastest":""}">${e.lap}</div>
                <div class="lap-meta">
                  ${null!==e.distance_km?G`<span>${e.distance_km.toFixed(2)} km</span><span class="sep">·</span>`:K}
                  <span>${a.value} ${a.unit}</span>
                </div>
                <div class="lap-value">
                  ${null!==e.pace_min_km&&e.pace_min_km>0?G`${Ue(e.pace_min_km)}<span class="unit">/km</span>`:G`${a.value}<span class="unit">${a.unit}</span>`}
                </div>
              </div>
            `})}
        </div>
    ...
    `],e([ve()],Yt.prototype,"_config",void 0),Yt=e([ue("suunto-lap-splits-card")],Yt);const ea=new Set(["unknown","unavailable",""]);let ta=class extends Te{constructor(){super(...arguments),this._pteHistory=[],this._epocHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-effect-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Ge(this.hass,"suunto_app:pte",720,"mean"),Ge(this.hass,"suunto_app:epoc",720,"mean")]);this._pteHistory=e,this._epocHistory=t}catch{this._pteHistory=[],this._epocHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_pte");if(!s||ea.has(s.state))return this._message("mdi:lightning-bolt",Se(a,"empty.training_effect_trend.title"));const r=i("last_epoc"),n=[];return this._pteHistory.length&&n.push({points:this._pteHistory,colorVar:"var(--sc-pulse)"}),this._epocHistory.length&&n.push({points:this._epocHistory,colorVar:"var(--sc-amber)"}),G`
      <ha-card class="static">
        <div class="header">
    ...
    `}_stat(e,t,a){return G`
      <div class="stat">
        <div class="stat-value">${e}${a?G`<span class="unit">${a}</span>`:K}</div>
        <div class="stat-label">${t}</div>
      </div>
    `}};ta.styles=[Ee,je,n`
      .chart-legend {
    ...
    `],e([ve()],ta.prototype,"_config",void 0),e([ve()],ta.prototype,"_pteHistory",void 0),e([ve()],ta.prototype,"_epocHistory",void 0),ta=e([ue("suunto-training-effect-trend-card")],ta);const aa=new Set(["unknown","unavailable",""]);let ia=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-status-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("readiness"),r=i("training_suggestion"),n=i("unusual_recovery"),o=s&&!aa.has(s.state)?Number(s.state):void 0,c=r&&!aa.has(r.state)?r.state:void 0;if(void 0===o&&void 0===c)return this._message("mdi:compass-outline",Se(a,"empty.training_status.title"),Se(a,"empty.training_status.subtitle"));const l=void 0!==o?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,o):void 0,d=void 0!==c?function(e,t){switch(t){case"hard":return{colorVar:"var(--sc-good)",label:Se(e,"band.suggestion.hard"),icon:"mdi:fire"};case"moderate":return{colorVar:"var(--sc-pulse)",label:Se(e,"band.suggestion.moderate"),icon:"mdi:walk"};case"easy":return{colorVar:"var(--sc-warn)",label:Se(e,"band.suggestion.easy"),icon:"mdi:leaf"};default:return{colorVar:"var(--sc-bad)",label:Se(e,"band.suggestion.rest"),icon:"mdi:bed-clock"}}}(a,c):void 0,u="on"===n?.state;return G`
      <ha-card class="static">
        ...
        ${u?G`<div class="alert"><ha-icon icon="mdi:shield-alert-outline"></ha-icon>${Se(a,"chip.unusual_recovery")}</div>`:K}
    ...
    `],e([ve()],ia.prototype,"_config",void 0),ia=e([ue("suunto-training-status-card")],ia);const sa=new Set(["unknown","unavailable",""]);function ra(e){return Math.max(0,Math.min(100,e))}function na(e,t,a,i){const s=(i-90)*Math.PI/180;return[e+a*Math.cos(s),t+a*Math.sin(s)]}let oa=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-profile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("lifetime_distance"),n=i("lifetime_days"),o=i("acwr"),c=i("workouts_7d"),l=i("readiness"),d=i("workouts_recent"),u=d?.attributes.workouts??[],m=[s,o,c,l].some(e=>e&&!sa.has(e.state));if(!m&&0===u.length)return this._message("mdi:radar",Se(a,"empty.training_profile.title"),Se(a,"empty.training_profile.subtitle"));const h=e=>e&&!sa.has(e.state)?Number(e.state):0,p=h(r),v=h(n),g=v>0?p/v*7:0,y=g>0?ra(h(s)/(1.4*g)*100):0,_=ra(h(o)/1.5*100),f=ra(h(c)/7*100),b=ra(h(l)),w=new Set(u.map(e=>e.activity).filter(Boolean)).size,k=ra(w/5*100),x=[{label:Se(a,"stat.volume"),value:y},{label:Se(a,"stat.intensity"),value:_},{label:Se(a,"stat.consistency"),value:f},{label:Se(a,"stat.recovery"),value:b},{label:Se(a,"stat.variety"),value:k}],$=[...x].sort((e,t)=>t.value-e.value)[0],z=[...x].sort((e,t)=>e.value-t.value)[0],S=130,A=128,C=360/x.length,T=[.25,.5,.75,1].map(e=>{const t=x.map((t,a)=>na(S,A,84*e,C*a).join(",")).join(" ");return I`<polygon class="radar-grid" points=${t}></polygon>`}),E=x.map((e,t)=>{const[a,i]=na(S,A,84,C*t);return I`<line class="radar-axis" x1=${S} y1=${A} x2=${a} y2=${i}></line>`}),j=x.map((e,t)=>na(S,A,84*e.value/100,C*t)),N=I`<polygon class="radar-fill" points=${j.map(e=>e.join(",")).join(" ")}></polygon>`,R=j.map(([e,t])=>I`<circle class="radar-vertex" cx=${e} cy=${t} r="3.2"></circle>`),M=x.map((e,t)=>{const a=C*t,[i,s]=na(S,A,104.16,a);let r="middle";return a>10&&a<170&&(r="start"),a>190&&a<350&&(r="end"),I`
    ...
    `],e([ve()],ma.prototype,"_config",void 0),ma=e([ue("suunto-heart-rate-card")],ma);const ha=new Set(["unknown","unavailable",""]),pa=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];function va(e){if(e)for(const[t,a]of pa)if(t.test(e))return a;return"personality.activity.other"}function ga(e){return Math.max(0,Math.min(99,Math.round(e)))}let ya=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-player-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl"),r=i("readiness"),n=i("workouts_30d"),o=i("form_tsb"),c=i("estimated_vo2max")??i("vo2max"),l=i("workouts_recent"),d=i("lifetime_by_activity"),u=[s,r,n].some(e=>e&&!ha.has(e.state));if(!u)return this._message("mdi:cards",Se(a,"empty.player.title"),Se(a,"empty.player.subtitle"));const m=e=>e&&!ha.has(e.state)?Number(e.state):0,h=l?.attributes.workouts??[],p=h.map(e=>e.tss).filter(e=>"number"==typeof e),v=p.length?p.reduce((e,t)=>e+t,0)/p.length:0,g=[{code:"STA",value:ga(m(s)/100*99)},{code:"PWR",value:ga(v/150*99)},{code:"REC",value:ga(m(r))},{code:"CON",value:ga(m(n)/20*99)},{code:"END",value:ga((m(c)-20)/40*99)},{code:"FRM",value:ga((m(o)+30)/50*99)}],y=ga(g.reduce((e,t)=>e+t.value,0)/g.length),_=function(e){return e>=85?{key:"player.tier.legendary",colorVar:"var(--player-legendary)"}:e>=70?{key:"player.tier.gold",colorVar:"var(--player-gold)"}:e>=50?{key:"player.tier.silver",colorVar:"var(--player-silver)"}:{key:"player.tier.bronze",colorVar:"var(--player-bronze)"}}(y),f=[...d?.attributes.activities??[]].sort((e,t)=>t.workouts-e.workouts)[0],b=f?.activity??h[0]?.activity;let w="";try{const e=ke(a,this._configuredDeviceId);w=a.devices?.[e]?.name_by_user||a.devices?.[e]?.name||""}catch{}return G`
      <ha-card class="static player-card" style="--tier-color:${_.colorVar}">
        <div class="pc-top">
          ...
          <div class="pc-badge">
            <span class="dot"><ha-icon .icon=${Oe(b)}></ha-icon></span>
            ${b??""}
          </div>
        </div>

        <div class="pc-avatar-wrap">
          <div class="pc-avatar"><ha-icon .icon=${Oe(b)}></ha-icon></div>
        </div>
        ${w?G`<div class="pc-name">${w}</div>`:K}
    ...
    `],e([ve()],ya.prototype,"_config",void 0),ya=e([ue("suunto-player-card")],ya);const _a=new Set(["unknown","unavailable",""]);let fa=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-achievements-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 6}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_workouts"),r=i("lifetime_distance"),n=i("lifetime_time"),o=i("lifetime_days"),c=i("lifetime_energy"),l=i("lifetime_by_activity"),d=i("estimated_vo2max")??i("vo2max"),u=i("training_records");if(!s&&!r)return this._message("mdi:trophy-outline",Se(a,"empty.achievements.title"),Se(a,"empty.achievements.subtitle"));const m=(h=a.language,e=>Math.round(e).toLocaleString(h));var h;const p=function(e){return t=>`${Math.round(t).toLocaleString(e)} km`}(a.language),v=e=>e&&!_a.has(e.state)?Number(e.state):0,g=l?.attributes.activities??[],y=g.filter(e=>e.workouts>0).length,_=[...g].sort((e,t)=>t.workouts-e.workouts)[0],f=u&&!_a.has(u.state)?Number(u.state):0,b=[{headingKey:"achievements.category.workouts",badges:[{icon:"💯",nameKey:"achievements.badge.century_club",unlocked:v(s)>=100,current:v(s),target:100,format:m},{icon:"🎖️",nameKey:"achievements.badge.workouts_250",unlocked:v(s)>=250,current:v(s),target:250,format:m},{icon:"🏅",nameKey:"achievements.badge.workouts_500",unlocked:v(s)>=500,current:v(s),target:500,format:m},{icon:"👑",nameKey:"achievements.badge.workouts_1000",unlocked:v(s)>=1e3,current:v(s),target:1e3,format:m}]},{headingKey:"achievements.category.distance",badges:[{icon:"🚴",nameKey:"achievements.badge.distance_1000",unlocked:v(r)>=1e3,current:v(r),target:1e3,format:p},{icon:"🗺️",nameKey:"achievements.badge.distance_5000",unlocked:v(r)>=5e3,current:v(r),target:5e3,format:p},{icon:"🌍",nameKey:"achievements.badge.around_globe",unlocked:v(r)>=40075,current:v(r),target:40075,format:p}]},{headingKey:"achievements.category.time",badges:[{icon:"⏱️",nameKey:"achievements.badge.hours_100",unlocked:v(n)>=100,current:v(n),target:100,format:m},{icon:"⌛",nameKey:"achievements.badge.hours_500",unlocked:v(n)>=500,current:v(n),target:500,format:m}]},{headingKey:"achievements.category.days",badges:[{icon:"📅",nameKey:"achievements.badge.days_100",unlocked:v(o)>=100,current:v(o),target:100,format:m},{icon:"🗓️",nameKey:"achievements.badge.full_year",unlocked:v(o)>=365,current:v(o),target:365,format:m}]},{headingKey:"achievements.category.energy",badges:[{icon:"🔥",nameKey:"achievements.badge.energy_100k",unlocked:v(c)>=1e5,current:v(c),target:1e5,format:m},{icon:"☄️",nameKey:"achievements.badge.energy_1m",unlocked:v(c)>=1e6,current:v(c),target:1e6,format:m}]},{headingKey:"achievements.category.variety",badges:[{icon:"🎽",nameKey:"achievements.badge.multi_sport",unlocked:y>=3,current:y,target:3,format:m},{icon:"🧭",nameKey:"achievements.badge.jack_of_all_trades",unlocked:y>=5,current:y,target:5,format:m},..._?[{icon:"⭐",nameKey:"achievements.badge.specialist",nameVars:{activity:_.activity},unlocked:_.workouts>=100,current:_.workouts,target:100,format:m}]:[]]},{headingKey:"achievements.category.fitness",badges:[{icon:"💪",nameKey:"achievements.badge.solid_engine",unlocked:v(d)>=40,current:v(d),target:40,format:m},{icon:"⚡",nameKey:"achievements.badge.elite_engine",unlocked:v(d)>=55,current:v(d),target:55,format:m},{icon:"🔥",nameKey:"achievements.badge.consistency_king",unlocked:f>=14,current:f,target:14,format:m}]}],w=b.flatMap(e=>e.badges),k=w.filter(e=>e.unlocked).length,x=u?.attributes??{},$=[{icon:"🔥",labelKey:"records.streak",entry:f>0?{value:f}:void 0,render:e=>Ae(a,e.value,"records.streak_days_one","records.streak_days_other")},{icon:"⚡",labelKey:"records.pace",entry:x.fastest_pace_min_km,render:e=>`${Ue(e.value)} /km`},{icon:"🏔️",labelKey:"records.climb",entry:x.biggest_climb_m,render:e=>`${Math.round(e.value)} m`},{icon:"⏳",labelKey:"records.workout",entry:x.longest_workout_min,render:e=>{const t=Ke(e.value);return`${t.value} ${t.unit}`}},{icon:"📏",labelKey:"records.distance",entry:x.farthest_workout_km,render:e=>`${e.value} km`},{icon:"🥵",labelKey:"records.session",entry:x.hardest_workout_tss,render:e=>`${e.value} TSS`}];return G`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="ach-list">
          ${b.map(e=>e.badges.length?G`
                  ${function(e,t){return G`<div class="cat">${Se(e,t)}</div>`}(a,e.headingKey)}
    ...
    `}_badgeRow(e,t){const a=Math.max(0,Math.min(100,t.current/t.target*100));return G`
      <div class="arow ${t.unlocked?"unlocked":"locked"}">
        ...
        ${t.unlocked?G`<div class="check">✓</div>`:K}
      </div>
    `}_recordRow(e,t,a,i,s){const r=i.start_time?Qe(new Date(i.start_time),e.language):void 0;return G`
      ...
      <ha-card class="static level-card">
        ...
        <div class="xp-bar-wrap">
          ...
          <div class="xp-labels">
            ...
            <span>${Se(a,"level.xp_to_next",{xp:m.toLocaleString(a.language),level:c+1})}</span>
          </div>
        </div>
    ...
    `],e([ve()],ka.prototype,"_config",void 0),ka=e([ue("suunto-level-card")],ka);const xa=[[/cycl|bik/i,"cycling"],[/run/i,"running"],[/trek|hik/i,"trekking"],[/walk/i,"walking"],[/gym|strength|weight/i,"gym"],[/swim/i,"swim"],[/ski/i,"ski"],[/row/i,"row"]];const $a=["var(--sc-pulse)","var(--sc-amber)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let za=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-class-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="lifetime_by_activity"]?a.states[t[s]]:void 0;var s;const r=i?.attributes.activities??[],n=r.reduce((e,t)=>e+t.workouts,0);if(!i||0===n)return this._message("mdi:sword-cross",Se(a,"empty.class.title"),Se(a,"empty.class.subtitle"));const o=[...r].sort((e,t)=>t.workouts-e.workouts).filter(e=>e.workouts>0),c=o[0],l=function(e){if(e)for(const[t,a]of xa)if(t.test(e))return a;return"other"}(c?.activity),d=o.slice(0,5),u=o.slice(5).reduce((e,t)=>e+t.workouts,0);return G`
      <ha-card class="static">
        ...
        <div class="class-build">
          ${d.map((e,t)=>{const a=Math.round(e.workouts/n*100);return G`
              <div class="cb-row">
                <span class="cn">${e.activity}</span>
                <div class="ct"><div class="cf" style="width:${a}%;background:${$a[t%$a.length]}"></div></div>
                <span class="cp">${a}%</span>
              </div>
            `})}
          ${u>0?G`<div class="cb-rest">${Se(a,"class.rest",{pct:Math.round(u/n*100)})}</div>`:K}
        </div>
      </ha-card>
    `}};za.styles=[Ee,je,n`
      ha-card.static {
