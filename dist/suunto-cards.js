 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $=globalThis,x=e=>e,S=$.trustedTypes,z=S?S.createPolicy("lit-html",{createHTML:e=>e}):void 0,A="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,T="?"+E,C=`<${T}>`,N=document,R=()=>N.createComment(""),H=e=>null===e||"object"!=typeof e&&"function"!=typeof e,M=Array.isArray,V="[ \t\n\f\r]",P=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,j=/-->/g,F=/>/g,D=RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),L=/'/g,O=/"/g,B=/^(?:script|style|textarea|title)$/i,q=e=>(t,...a)=>({_$litType$:e,strings:t,values:a}),G=q(1),I=q(2),U=Symbol.for("lit-noChange"),W=Symbol.for("lit-nothing"),Z=new WeakMap,K=N.createTreeWalker(N,129);function Q(e,t){if(!M(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==z?z.createHTML(t):t}const J=(e,t)=>{const a=e.length-1,i=[];let s,r=2===t?"<svg>":3===t?"<math>":"",n=P;for(let t=0;t<a;t++){const a=e[t];let o,c,l=-1,d=0;for(;d<a.length&&(n.lastIndex=d,c=n.exec(a),null!==c);)d=n.lastIndex,n===P?"!--"===c[1]?n=j:void 0!==c[1]?n=F:void 0!==c[2]?(B.test(c[2])&&(s=RegExp("</"+c[2],"g")),n=D):void 0!==c[3]&&(n=D):n===D?">"===c[0]?(n=s??P,l=-1):void 0===c[1]?l=-2:(l=n.lastIndex-c[2].length,o=c[1],n=void 0===c[3]?D:'"'===c[3]?O:L):n===O||n===L?n=D:n===j||n===F?n=P:(n=D,s=void 0);const u=n===D&&e[t+1].startsWith("/>")?" ":"";r+=n===P?a+C:l>=0?(i.push(o),a.slice(0,l)+A+a.slice(l)+E+u):a+E+(-2===l?t:u)}return[Q(e,r+(e[a]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),i]};class Y{constructor({strings:e,_$litType$:t},a){let i;this.parts=[];let s=0,r=0;const n=e.length-1,o=this.parts,[c,l]=J(e,t);if(this.el=Y.createElement(c,a),K.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(i=K.nextNode())&&o.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const e of i.getAttributeNames())if(e.endsWith(A)){const t=l[r++],a=i.getAttribute(e).split(E),n=/([.?@])?(.*)/.exec(t);o.push({type:1,index:s,name:n[2],strings:a,ctor:"."===n[1]?ie:"?"===n[1]?se:"@"===n[1]?re:ae}),i.removeAttribute(e)}else e.startsWith(E)&&(o.push({type:6,index:s}),i.removeAttribute(e));if(B.test(i.tagName)){const e=i.textContent.split(E),t=e.length-1;if(t>0){i.textContent=S?S.emptyScript:"";for(let a=0;a<t;a++)i.append(e[a],R()),K.nextNode(),o.push({type:2,index:++s});i.append(e[t],R())}}}else if(8===i.nodeType)if(i.data===T)o.push({type:2,index:s});else{let e=-1;for(;-1!==(e=i.data.indexOf(E,e+1));)o.push({type:7,index:s}),e+=E.length-1}s++}}static createElement(e,t){const a=N.createElement("template");return a.innerHTML=e,a}}function X(e,t,a=e,i){if(t===U)return t;let s=void 0!==i?a._$Co?.[i]:a._$Cl;const r=H(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(e),s._$AT(e,a,i)),void 0!==i?(a._$Co??=[])[i]=s:a._$Cl=s),void 0!==s&&(t=X(e,s._$AS(e,t.values),s,i)),t}class ee{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:a}=this._$AD,i=(e?.creationScope??N).importNode(t,!0);K.currentNode=i;let s=K.nextNode(),r=0,n=0,o=a[0];for(;void 0!==o;){if(r===o.index){let t;2===o.type?t=new te(s,s.nextSibling,this,e):1===o.type?t=new o.ctor(s,o.name,o.strings,this,e):6===o.type&&(t=new ne(s,this,e)),this._$AV.push(t),o=a[++n]}r!==o?.index&&(s=K.nextNode(),r++)}return K.currentNode=N,i}p(e){let t=0;for(const a of this._$AV)void 0!==a&&(void 0!==a.strings?(a._$AI(e,a,t),t+=a.strings.length-2):a._$AI(e[t])),t++}}class te{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,a,i){this.type=2,this._$AH=W,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=X(this,e,t),H(e)?e===W||null==e||""===e?(this._$AH!==W&&this._$AR(),this._$AH=W):e!==this._$AH&&e!==U&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>M(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==W&&H(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:a}=e,i="number"==typeof a?this._$AC(e):(void 0===a.el&&(a.el=Y.createElement(Q(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(t);else{const e=new ee(i,this),a=e.u(this.options);e.p(t),this.T(a),this._$AH=e}}_$AC(e){let t=Z.get(e.strings);return void 0===t&&Z.set(e.strings,t=new Y(e)),t}k(e){M(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,i=0;for(const s of e)i===t.length?t.push(a=new te(this.O(R()),this.O(R()),this,this.options)):a=t[i],a._$AI(s),i++;i<t.length&&(this._$AR(a&&a._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=x(e).nextSibling;x(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ae{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,a,i,s){this.type=1,this._$AH=W,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=s,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=W}_$AI(e,t=this,a,i){const s=this.strings;let r=!1;if(void 0===s)e=X(this,e,t,0),r=!H(e)||e!==this._$AH&&e!==U,r&&(this._$AH=e);else{const i=e;let n,o;for(e=s[0],n=0;n<s.length-1;n++)o=X(this,i[a+n],t,n),o===U&&(o=this._$AH[n]),r||=!H(o)||o!==this._$AH[n],o===W?e=W:e!==W&&(e+=(o??"")+s[n+1]),this._$AH[n]=o}r&&!i&&this.j(e)}j(e){e===W?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ie extends ae{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===W?void 0:e}}class se extends ae{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==W)}}class re extends ae{constructor(e,t,a,i,s){super(e,t,a,i,s),this.type=5}_$AI(e,t=this){if((e=X(this,e,t,0)??W)===U)return;const a=this._$AH,i=e===W&&a!==W||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==W&&(a===W||i);i&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ne{constructor(e,t,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){X(this,e)}}const oe=$.litHtmlPolyfillSupport;oe?.(Y,te),($.litHtmlVersions??=[]).push("3.3.3");const ce=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class le extends k{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,a)=>{const i=a?.renderBefore??t;let s=i._$litPart$;if(void 0===s){const e=a?.renderBefore??null;i._$litPart$=s=new te(t.insertBefore(R(),e),e,void 0,a??{})}return s._$AI(e),s})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return U}}le._$litElement$=!0,le.finalized=!0,ce.litElementHydrateSupport?.({LitElement:le});const de=ce.litElementPolyfillSupport;de?.({LitElement:le}),(ce.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Ne=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function Re(e){if(e)for(const[t,a]of Ne)if(t.test(e))return a;return"mdi:run-fast"}const He={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};function Me(e){return(e??[]).map(e=>({t:new Date(e.last_updated??e.last_changed??"").getTime(),v:Number(e.state)})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}function Ve(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Pe(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function je(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Fe(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const De=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Le(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of De)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const Oe=new Set(["unknown","unavailable",""]);let Be=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||Oe.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),c=i("last_avg_hr"),l=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),h=i("last_pte"),p=i("last_epoc"),m=i("last_feeling"),v=i("last_tss"),g=i("last_cal_per_km"),_=i("last_workout_weather"),y=i("last_workout_tags"),f=i("last_workout_achievements"),b=o?Ve(Number(o.state)):void 0,w=void 0===d&&void 0!==u,k=m&&!Oe.has(m.state)?Number(m.state):void 0,$=h&&!Oe.has(h.state)?Number(h.state):void 0,x=f?Number(f.state):0;return G`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        <div class="header">
          <div class="icon-badge"><ha-icon .icon=${Re(s.state)}></ha-icon></div>
          <div class="title-block">
            <div class="title activity">${s.state}</div>
            <div class="subtitle">
              ${r?G`${Le(new Date(r.state),a.language)} ·
        ...
        <div class="stats">
          ...
          ${d?this._stat(Pe(Number(d.state)),"/km",Se(a,"stat.avg_pace")):w?this._stat(Number(u.state).toFixed(1),"km/h",Se(a,"stat.avg_speed")):W}
          ...
          ${void 0!==$?G`
                <div class="stat">
                  ...
                  <div class="severity">
                    ${[1,2,3,4,5].map(e=>G`<i class=${e<=Math.round($)?`on s${e}`:""}></i>`)}
                  </div>
                </div>
              `:W}
        </div>
        ...
        ${v||p||void 0!==k||g?G`
              ...
              <div class="secondary">
                ...
                ${void 0!==k?G`
                      <div class="sec-item">
                        <div class="feeling">
                          ${[1,2,3,4,5].map(e=>G`<i class=${e<=k?"on":""}></i>`)}
                        </div>
        ...
        ${_&&!Oe.has(_.state)?G`
              <div class="weather">
                <ha-icon .icon=${function(e){const t=e?.slice(0,2);return t&&He[t]||"mdi:weather-cloudy"}(_.attributes.icon_code)}></ha-icon>
                <strong>${_.state}°C</strong>
                ${_.attributes.condition?G`<span class="sep">·</span><span class="cond">${_.attributes.condition}</span>`:W}
                ${void 0!==_.attributes.wind_speed_kmh?G`
                      <span class="sep">·</span>
            ...
            `:W}
        ${y&&!Oe.has(y.state)||x>0?G`
              <div class="footer">
                ${y&&!Oe.has(y.state)?G`<span class="chip"><ha-icon icon="mdi:tag-outline"></ha-icon>${y.state}</span>`:W}
                ${x>0?G`
                      <span
                        class="chip accent"
    ...
    `}_secondary(e,t,a){return G`
      <div class="sec-item">
        <div class="sec-value">${e}${a?G` <span class="sec-unit">${a}</span>`:W}</div>
        <div class="sec-label">${t}</div>
      </div>
    `}_openMoreInfo(e){e&&ye(this,"hass-more-info",{entityId:e})}};function qe(e){return G`
    <div class="bar">
      ${e.map(e=>G`<div
            class="seg"
  ...
  `}function Ge(e,t,a=64,i=6){const s=Math.max(0,Math.min(100,e)),r=(a-i)/2,n=2*Math.PI*r,o=a/2;return G`
  ...
  `}function Ie(e){const t=e.map(e=>e.v),a=Math.min(...t);return{min:a,span:Math.max(...t)-a||1}}function Ue(e,t=300,a=70,i=!0){const s=e.filter(e=>e.points.length>=2);if(0===s.length)return W;const r=.1*a,n=a-2*r,o=i?Ie(s.flatMap(e=>e.points)):void 0,c=s.map(e=>{const{min:a,span:i}=o??Ie(e.points),s=t/(e.points.length-1),c=e.points.map((e,t)=>[t*s,r+n-(e.v-a)/i*n]),l=c.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),[d,u]=c[c.length-1];return I`
      <path
        d=${l}
        fill="none"
        stroke=${e.colorVar}
  ...
  `}Be.styles=[Te,Ce,n`
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${n?`${o} · ${Le(new Date(n.state),a.language)}`:o}
            </div>
          </div>
        </div>

        ${qe(i.map(e=>({flexGrow:e.minutes,colorVar:We(e.n),title:Se(a,"label.zone",{n:e.n})})))}

        <div class="rows">
          ${i.map(e=>{const t=Ve(e.minutes),i=Math.round(e.minutes/s*100);return G`
              <div class="row">
                <i class="dot" style="background:${We(e.n)}"></i>
    ...
    `],e([ve()],Ze.prototype,"_config",void 0),Ze=e([ue("suunto-hr-zones-card")],Ze);const Ke=new Set(["unknown","unavailable",""]);let Qe=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||Ke.has(s.state))return this._message("mdi:sleep",Se(a,"empty.sleep_readiness.title"),Se(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),c=i("sleep_rem"),l=i("sleep_quality"),d=i("sleep_spo2"),u=i("sleep_hrv"),h=i("hrv_baseline"),p=i("hrv_status"),m=i("resting_hr"),v=i("resting_hr_baseline"),g=i("readiness"),_=i("nap_duration"),y=g&&!Ke.has(g.state)?Number(g.state):void 0,f=void 0!==y?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,y):void 0,b=u&&h&&!Ke.has(h.state)?Number(u.state)-Number(h.state):void 0,w=m&&v&&!Ke.has(v.state)?Number(m.state)-Number(v.state):void 0,k=[n&&!Ke.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:Se(a,"label.deep")}:void 0,o&&!Ke.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:Se(a,"label.light")}:void 0,c&&!Ke.has(c.state)?{flexGrow:Number(c.state),colorVar:"var(--sc-sleep-rem)",title:Se(a,"label.rem")}:void 0].filter(e=>void 0!==e),$=Ve(60*Number(s.state)),x=_&&!Ke.has(_.state)?Number(_.state):void 0,S=!!_?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(_.attributes.date)),z={duration:`${$.value} ${$.unit}`};return G`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${r?Se(a,"card.sleep_readiness.subtitle_with_wake",{...z,time:je(new Date(r.state),a.language)}):Se(a,"card.sleep_readiness.subtitle_no_wake",z)}
            </div>
          </div>
        </div>
        ...
        <div class="stats">
          ...
          ${u?this._stat(String(Math.round(Number(u.state))),"ms",void 0!==b?Se(a,"stat.hrv_delta",{delta:Fe(b)}):Se(a,"stat.hrv"),void 0!==b?b>=0?"good":"bad":void 0):W}
          ${m?this._stat(String(Math.round(Number(m.state))),"bpm",void 0!==w?Se(a,"stat.resting_hr_delta",{delta:Fe(w)}):Se(a,"stat.resting_hr"),void 0!==w?w<=0?"good":"bad":void 0):W}
        ...
        ${k.length?G`
              <div class="stages">
                ...
                <div class="stage-legend">
                  ${k.map(e=>{const t=Ve(e.flexGrow);return G`
        ...
        ${p&&!Ke.has(p.state)||x?G`
              <div class="footer">
                ${p&&!Ke.has(p.state)?(()=>{const e=function(e,t){return"low"===t?{colorVar:"var(--sc-warn)",label:Se(e,"band.hrv.low")}:"high"===t?{colorVar:"var(--sc-pulse)",label:Se(e,"band.hrv.high")}:{colorVar:"var(--sc-good)",label:Se(e,"band.hrv.balanced")}}(a,p.state);return G`<span class="chip" style="color:${e.colorVar}"
                        ><ha-icon icon="mdi:heart-flash"></ha-icon>${e.label}</span
                      >`})():W}
                ${x?G`<span class="chip accent">
    ...
    `],e([ve()],Qe.prototype,"_config",void 0),Qe=e([ue("suunto-sleep-readiness-card")],Qe);const Je=new Set(["unknown","unavailable",""]);let Ye=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Je.has(s.state))return this._message("mdi:battery-heart-variant",Se(a,"empty.recovery.title"));const r=i("is_recovering"),n=i("recovery_until"),o=i("recovery_time"),c=i("stress_state"),l=i("workout_today"),d=Number(s.state),u=function(e,t){return t>=60?{colorVar:"var(--sc-good)",label:Se(e,"band.recovery.well")}:t>=30?{colorVar:"var(--sc-warn)",label:Se(e,"band.recovery.partial")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.recovery.low")}}(a,d),h="on"===r?.state;let p=Se(a,"band.recovery.fully");if(h&&n&&!Je.has(n.state)){const e=new Date(n.state).getTime()-Date.now();if(e>0){const t=Ve(e/6e4);p=Se(a,"band.recovery.recovering",{time:`${t.value} ${t.unit}`})}}return G`
      <ha-card class="static">
        <div class="header">
        ...
        ${c||o?G`
              <div class="stats two">
                ${c&&!Je.has(c.state)?this._stat(c.state,"",Se(a,"stat.stress_level")):W}
                ${o&&!Je.has(o.state)?this._stat(Number(o.state).toFixed(1),"h",Se(a,"stat.recovery_window")):W}
              </div>
            `:W}
        ${"on"===l?.state?G`<div class="footer"><span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${Se(a,"chip.workout_logged_today")}</span></div>`:W}
      </ha-card>
    `}_stat(e,t,a){return G`
      <div class="stat">
        <div class="stat-value">${e}${t?G`<span class="unit">${t}</span>`:W}</div>
        <div class="stat-label">${a}</div>
      </div>
    `}};Ye.styles=[Te,Ce,n`
      .readiness-row {
    ...
    `],e([ve()],Ye.prototype,"_config",void 0),Ye=e([ue("suunto-recovery-card")],Ye);const Xe=new Set(["unknown","unavailable",""]);let et=class extends Ee{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-load-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.fitness_ctl;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{const e=new Date(a-2592e6).toISOString(),i=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${t}&no_attributes`),s=(i?.[0]??[]).map(e=>({t:new Date(e.last_updated??e.last_changed??"").getTime(),v:Number(e.state)})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v));this._history=s}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||Xe.has(s.state))return this._message("mdi:arm-flex",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=i("acwr"),c=n&&!Xe.has(n.state)?Number(n.state):void 0,l=void 0!==c?function(e,t){return t>5?{colorVar:"var(--sc-good)",label:Se(e,"band.form.fresh")}:t<-20?{colorVar:"var(--sc-bad)",label:Se(e,"band.form.very_fatigued")}:t<-5?{colorVar:"var(--sc-warn)",label:Se(e,"band.form.fatigued")}:{colorVar:"var(--sc-pulse)",label:Se(e,"band.form.neutral")}}(a,c):void 0,d=o&&!Xe.has(o.state)?Number(o.state):void 0,u=void 0!==d?function(e,t){return t>1.3?{colorVar:"var(--sc-bad)",label:Se(e,"band.acwr.high")}:t<.8?{colorVar:"var(--sc-warn)",label:Se(e,"band.acwr.low")}:{colorVar:"var(--sc-good)",label:Se(e,"band.acwr.safe")}}(a,d):void 0;return G`
      <ha-card class="static">
        <div class="header">
        ...
        ${function(e,t,a=300,i=56){if(e.length<2)return W;const s=e.map(e=>e.v),r=Math.min(...s),n=Math.max(...s)-r||1,o=.12*i,c=i-2*o,l=a/(e.length-1),d=e.map((e,t)=>[t*l,o+c-(e.v-r)/n*c]),u=d.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),h=`${u} L${a},${i} L0,${i} Z`,[p,m]=d[d.length-1];return G`
  ...
  `}(this._history,"var(--sc-amber)")}
        ...
        <div class="stats three">
          ...
          ${void 0!==c?this._stat(Fe(c,1),Se(a,"stat.tsb"),l?.colorVar):W}
        </div>
    ...
    `],e([ve()],et.prototype,"_config",void 0),e([ve()],et.prototype,"_history",void 0),et=e([ue("suunto-training-load-card")],et);const tt=new Set(["unknown","unavailable",""]),at=["var(--sc-amber)","var(--sc-pulse)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let it=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-week-stats-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("weekly_time"),n=i("workouts_7d"),o=i("workouts_30d"),c=i("lifetime_by_activity");if(!s&&!c)return this._message("mdi:calendar-week",Se(a,"empty.week_stats.title"));const l=(c?.attributes.activities??[]).slice().sort((e,t)=>t.distance_km-e.distance_km),d=l.slice(0,5),u=l.length-d.length;return G`
      <ha-card class="static">
        <div class="header">
        ...
        ${s||r||n?G`
              <div class="stats three">
                ${s&&!tt.has(s.state)?this._stat(Number(s.state).toFixed(1),"km",Se(a,"stat.distance")):W}
                ${r&&!tt.has(r.state)?this._stat(Number(r.state).toFixed(1),"h",Se(a,"stat.time")):W}
                ${n&&!tt.has(n.state)?this._stat(n.state,"",Se(a,"stat.workouts")):W}
              </div>
            `:W}
        ...
        ${d.length?G`
              ...
              <div class="lifetime">
                ...
                ${qe(d.map((e,t)=>({flexGrow:e.distance_km,colorVar:at[t%at.length],title:e.activity})))}
                <div class="rows">
                  ${d.map((e,t)=>{const a=at[t%at.length];return G`
                      <div class="row">
                        <div
                          class="icon-badge tiny"
                          style="background:color-mix(in srgb, ${a} 18%, transparent);color:${a}"
                        >
                          <ha-icon .icon=${Re(e.activity)}></ha-icon>
                        </div>
            ...
            `:W}
        ${o&&!tt.has(o.state)?G`<div class="footer"><span class="chip">${Se(a,"chip.workouts_30d",{count:o.state})}</span></div>`:W}
      </ha-card>
    `}_stat(e,t,a){return G`
      <div class="stat">
        <div class="stat-value">${e}${t?G`<span class="unit">${t}</span>`:W}</div>
    ...
    `],e([ve()],it.prototype,"_config",void 0),it=e([ue("suunto-week-stats-card")],it);const st=new Set(["unknown","unavailable",""]);let rt=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-today-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps"),r=i("daily_energy"),n=i("current_hr"),o=i("workout_today"),c=i("is_recovering");if(!s&&!r&&!n)return this._message("mdi:pulse",Se(a,"empty.today.title"));const l=n&&!st.has(n.state)?Math.round(Number(n.state)):void 0;return G`
      <ha-card class="static">
        ...
        <div class="stats three">
          ${s&&!st.has(s.state)?this._stat(Number(s.state).toLocaleString(a.language),"",Se(a,"stat.steps")):W}
          ${r&&!st.has(r.state)?this._stat(Math.round(Number(r.state)).toLocaleString(a.language),"kcal",Se(a,"stat.energy")):W}
          ${void 0!==l?G`
                <div class="stat hr">
        ...
        ${"on"===o?.state||"on"===c?.state?G`
              <div class="footer">
                ${"on"===o?.state?G`<span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${Se(a,"chip.workout_today")}</span>`:W}
                ${"on"===c?.state?G`<span class="chip"><ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.recovering")}</span>`:W}
              </div>
            `:W}
      </ha-card>
    `}_stat(e,t,a){return G`
    ...
    `],e([ve()],ot.prototype,"_config",void 0),ot=e([ue("suunto-lifetime-card")],ot);let ct=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recent-workouts-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[];return s&&0!==r.length?G`
      <ha-card class="static">
        ...
        <div class="scroll-list">
          ${r.map(e=>{const t=null!==e.duration_min?Ve(e.duration_min):void 0;return G`
              <div class="workout-row">
                <div class="icon-badge tiny"><ha-icon .icon=${Re(e.activity)}></ha-icon></div>
                <div class="name-block">
                  <div class="name">${e.activity??"-"}</div>
                  <div class="date">
                    ${e.start?Le(new Date(e.start),a.language):""}
                  </div>
                </div>
                <div class="row-stats">
                  ${null!==e.distance_km?G`<span>${e.distance_km} km</span>`:W}
                  ${null!==e.distance_km&&t?G`<span class="sep">·</span>`:W}
                  ${t?G`<span>${t.value} ${t.unit}</span>`:W}
                </div>
              </div>
            `})}
        </div>
      </ha-card>
    `:this._message("mdi:format-list-bulleted",Se(a,"empty.recent_workouts.title"))}};ct.styles=[Te,Ce,n`
      .workout-row {
        display: grid;
    ...
    `],e([ve()],ct.prototype,"_config",void 0),ct=e([ue("suunto-recent-workouts-card")],ct);const lt=new Set(["unknown","unavailable",""]);let dt=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-elevation-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_ascent"),r=i("last_descent");if((!s||lt.has(s.state))&&(!r||lt.has(r.state)))return this._message("mdi:image-filter-hdr",Se(a,"empty.elevation.title"),Se(a,"empty.elevation.subtitle"));const n=i("last_ascent_time"),o=i("last_descent_time"),c=i("last_min_altitude"),l=i("last_max_altitude"),d=i("last_ascent_rate"),u=i("last_workout_start");return G`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${u?`${Se(a,"card.hr_zones.last_workout")} · ${Le(new Date(u.state),a.language)}`:Se(a,"card.hr_zones.last_workout")}
            </div>
          </div>
        </div>

        <div class="stats three">
          ${s&&!lt.has(s.state)?this._stat(Math.round(Number(s.state)).toString(),"m",Se(a,"stat.ascent")):W}
          ${r&&!lt.has(r.state)?this._stat(Math.round(Number(r.state)).toString(),"m",Se(a,"stat.descent")):W}
          ${n&&!lt.has(n.state)?(()=>{const e=Ve(Number(n.state));return this._stat(e.value,e.unit,Se(a,"stat.ascent_time"))})():W}
          ${o&&!lt.has(o.state)?(()=>{const e=Ve(Number(o.state));return this._stat(e.value,e.unit,Se(a,"stat.descent_time"))})():W}
          ${c&&!lt.has(c.state)?this._stat(Math.round(Number(c.state)).toString(),"m",Se(a,"stat.min_altitude")):W}
          ${l&&!lt.has(l.state)?this._stat(Math.round(Number(l.state)).toString(),"m",Se(a,"stat.max_altitude")):W}
        </div>
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${c?G`${c.state}`:W}
              ${c&&l?G`<span class="sep">·</span>`:W}
              ${l?Le(new Date(l.state),a.language):W}
            </div>
          </div>
        </div>

        ${this._mapEl&&this._mapKey===`${o}:${u}`?G`<div class="map-wrap">${this._mapEl}</div>`:W}
    ...
    `],e([ve()],ht.prototype,"_config",void 0),e([ve()],ht.prototype,"_mapEl",void 0),ht=e([ue("suunto-location-card")],ht);const pt=new Set(["unknown","unavailable",""]);let mt=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-fitness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("vo2max");if(!s||pt.has(s.state))return this._message("mdi:lungs",Se(a,"empty.fitness.title"),Se(a,"empty.fitness.subtitle"));const r=i("estimated_vo2max"),n=i("fitness_age"),o=s.attributes.measured_at,c=s.attributes.measured_from;return G`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${o?Se(a,"fitness.measured",{time:Le(new Date(o),a.language),activity:c??""}):W}
            </div>
          </div>
        </div>
        ...
        <div class="stats three">
          ...
          ${r&&!pt.has(r.state)?this._stat(Number(r.state).toFixed(1),"ml/kg/min",Se(a,"stat.estimated_vo2max")):W}
          ${n&&!pt.has(n.state)?this._stat(String(Math.round(Number(n.state))),"",Se(a,"stat.fitness_age")):W}
        </div>
      </ha-card>
    `}_stat(e,t,a){return G`
      <div class="stat">
    ...
    `],e([ve()],mt.prototype,"_config",void 0),mt=e([ue("suunto-fitness-card")],mt);const vt=new Set(["unknown","unavailable",""]);let gt=class extends Ee{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-tile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 1}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||vt.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),c=i("last_avg_hr"),l=i("last_avg_pace"),d=i("last_avg_speed"),u=[];if(n&&u.push(G`${(Number(n.state)/1e3).toFixed(1)} km`),o){const e=Ve(Number(o.state));u.push(G`${e.value} ${e.unit}`)}return l?u.push(G`${Pe(Number(l.state))}/km`):d&&u.push(G`${Number(d.state).toFixed(1)} km/h`),c&&u.push(G`${Math.round(Number(c.state))} bpm`),G`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        <div class="header">
          <div class="icon-badge"><ha-icon .icon=${Re(s.state)}></ha-icon></div>
          <div class="title-block">
            <div class="title activity">${s.state}</div>
            <div class="subtitle">${r?Le(new Date(r.state),a.language):""}</div>
          </div>
          <ha-icon class="chevron" icon="mdi:chevron-right"></ha-icon>
        </div>
        ${u.length?G`
              <div class="compact-stats">
                ${u.map((e,t)=>G`${t>0?G`<span class="sep">·</span>`:W}${e}`)}
              </div>
            `:W}
      </ha-card>
    `}_openMoreInfo(e){e&&ye(this,"hass-more-info",{entityId:e})}};gt.styles=[Te,Ce,n`
      ha-card {
        gap: 8px;
      }
      .activity {
    ...
    `],e([ve()],gt.prototype,"_config",void 0),gt=e([ue("suunto-last-workout-tile-card")],gt);const _t=new Set(["unknown","unavailable",""]);let yt=class extends Ee{constructor(){super(...arguments),this._ctlHistory=[],this._atlHistory=[],this._tsbHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-pmc-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.fitness_ctl;if(!a)return;const i=t.fatigue_atl,s=t.form_tsb,r=[a,i,s].filter(e=>Boolean(e)),n=r.join(","),o=Date.now();if(!(n===this._historyKey&&o-this._historyFetchedAt<6e5)){this._historyKey=n,this._historyFetchedAt=o;try{const e=new Date(o-7776e6).toISOString(),t=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${r.join(",")}&no_attributes`);let a=0;this._ctlHistory=Me(t?.[a++]),this._atlHistory=i?Me(t?.[a++]):[],this._tsbHistory=s?Me(t?.[a++]):[]}catch{this._ctlHistory=[],this._atlHistory=[],this._tsbHistory=[]}}}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||_t.has(s.state))return this._message("mdi:chart-timeline-variant",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=[{points:this._ctlHistory,colorVar:"var(--sc-pulse)"}];return this._atlHistory.length&&o.push({points:this._atlHistory,colorVar:"var(--sc-bad)"}),this._tsbHistory.length&&o.push({points:this._tsbHistory,colorVar:"var(--sc-amber)"}),G`
      <ha-card class="static">
        ...
        <div class="stats three">
          ${this._stat(Number(s.state).toFixed(0),Se(a,"stat.ctl"))}
          ${r&&!_t.has(r.state)?this._stat(Number(r.state).toFixed(0),Se(a,"stat.atl")):W}
          ${n&&!_t.has(n.state)?this._stat(Fe(Number(n.state),1),Se(a,"stat.tsb")):W}
        </div>
      </ha-card>
    `}_stat(e,t){return G`
      <div class="stat">
    ...
    `],e([ve()],yt.prototype,"_config",void 0),e([ve()],yt.prototype,"_ctlHistory",void 0),e([ve()],yt.prototype,"_atlHistory",void 0),e([ve()],yt.prototype,"_tsbHistory",void 0),yt=e([ue("suunto-pmc-card")],yt);const ft=new Set(["unknown","unavailable",""]);let bt=class extends Ee{constructor(){super(...arguments),this._rhrHistory=[],this._hrvHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.resting_hr,i=t.sleep_hrv;if(!a&&!i)return;const s=[a,i].filter(e=>Boolean(e)),r=s.join(","),n=Date.now();if(!(r===this._historyKey&&n-this._historyFetchedAt<6e5)){this._historyKey=r,this._historyFetchedAt=n;try{const e=new Date(n-2592e6).toISOString(),t=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${s.join(",")}&no_attributes`);let r=0;this._rhrHistory=a?Me(t?.[r++]):[],this._hrvHistory=i?Me(t?.[r++]):[]}catch{this._rhrHistory=[],this._hrvHistory=[]}}}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("resting_hr"),r=i("sleep_hrv"),n=s&&!ft.has(s.state),o=r&&!ft.has(r.state);if(!n&&!o)return this._message("mdi:heart-pulse",Se(a,"empty.recovery_trends.title"));const c=i("resting_hr_baseline"),l=i("hrv_baseline"),d=n&&c&&!ft.has(c.state)?Number(s.state)-Number(c.state):void 0,u=o&&l&&!ft.has(l.state)?Number(r.state)-Number(l.state):void 0,h=[];return this._rhrHistory.length&&h.push({points:this._rhrHistory,colorVar:"var(--sc-pulse)"}),this._hrvHistory.length&&h.push({points:this._hrvHistory,colorVar:"var(--sc-amber)"}),G`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:heart-pulse"></ha-icon></div>
          <div class="title-block">
        ...
        <div class="stats two">
          ${n?this._stat(String(Math.round(Number(s.state))),"bpm",void 0!==d?Se(a,"stat.resting_hr_delta",{delta:Fe(d)}):Se(a,"stat.resting_hr"),void 0!==d?d<=0?"good":"bad":void 0):W}
          ${o?this._stat(String(Math.round(Number(r.state))),"ms",void 0!==u?Se(a,"stat.hrv_delta",{delta:Fe(u)}):Se(a,"stat.hrv"),void 0!==u?u>=0?"good":"bad":void 0):W}
        </div>
      </ha-card>
    `}_stat(e,t,a,i){return G`
      <div class="stat ${i??""}">
    ...
    `],e([ve()],bt.prototype,"_config",void 0),e([ve()],bt.prototype,"_rhrHistory",void 0),e([ve()],bt.prototype,"_hrvHistory",void 0),bt=e([ue("suunto-recovery-trends-card")],bt);const wt=new Set(["unknown","unavailable",""]);let kt=class extends Ee{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-volume-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.weekly_distance;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{const e=new Date(a-72576e5).toISOString(),i=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${t}&no_attributes`);this._history=Me(i?.[0])}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return W;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||wt.has(i.state))return this._message("mdi:chart-bar",Se(a,"empty.weekly_volume.title"));const r=function(e,t){const a=[...e].sort((e,t)=>e.t-t.t),i=Date.now(),s=[];for(let e=t-1;e>=0;e--){const t=i-7*e*864e5,r=t-6048e5,n=a.filter(e=>e.t>r&&e.t<=t),o=n[n.length-1];s.push({value:o?o.v:0,weekEndMs:t})}return s}(this._history,12),n=r.map(e=>({value:e.value,label:`${new Date(e.weekEndMs).toLocaleDateString(a.language,{month:"short",day:"numeric"})} · ${e.value.toFixed(1)} km`})),o=r.reduce((e,t)=>e+t.value,0),c=o/12;return G`
      <ha-card class="static">
        ...
        ${function(e,t,a=300,i=70){if(0===e.length)return W;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return I`
