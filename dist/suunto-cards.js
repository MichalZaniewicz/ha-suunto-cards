...
`;function Ne(e){return I`
  ...
  `}function De(e,t,a=300,i=56){if(e.length<2)return U;const s=e.map(e=>e.v),r=Math.min(...s),n=Math.max(...s)-r||1,o=.12*i,c=i-2*o,d=a/(e.length-1),l=e.map((e,t)=>[t*d,o+c-(e.v-r)/n*c]),u=l.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),h=`${u} L${a},${i} L0,${i} Z`,[p,m]=l[l.length-1];return I`
  ...
  `}function He(e){const t=e.map(e=>e.v),a=Math.min(...t);return{min:a,span:Math.max(...t)-a||1}}function Me(e,t=300,a=70,i=!0){const s=e.filter(e=>e.points.length>=2);if(0===s.length)return U;const r=.1*a,n=a-2*r,o=i?He(s.flatMap(e=>e.points)):void 0,c=s.map(e=>{const{min:a,span:i}=o??He(e.points),s=t/(e.points.length-1),c=e.points.map((e,t)=>[t*s,r+n-(e.v-a)/i*n]),d=c.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),[l,u]=c[c.length-1];return G`
      <path
        d=${d}
        fill="none"
        stroke=${e.colorVar}
      ...
      ></path>
      <circle cx=${l} cy=${u} r="3" fill=${e.colorVar}></circle>
    `});return I`
    <svg viewBox="0 0 ${t} ${a}" preserveAspectRatio="none" class="sparkline">
      ${c}
    </svg>
  `}const Fe=new Set(["unknown","unavailable",""]);let Re=class extends Ce{static getConfigElement(){return document.createElement("suunto-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-goal-card",goal_km:50}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||Fe.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_goal.title"));const r=this._config.goal_km??50,n=Number(i.state),o=r>0?n/r*100:0,c=o>=100?"var(--sc-good)":"var(--sc-amber)";return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ve()],Re.prototype,"_config",void 0),Re=e([ue("suunto-weekly-goal-card")],Re);let Pe=class extends de{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return U;const e=we(this.hass);return I`
      ${e.length>1?I`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
    ...
    `}_deviceChanged(e){if(!this._config)return;const t=e.detail.value;this._emit({...this._config,device_id:t||void 0})}_goalChanged(e){if(!this._config)return;const t=Number(e.target.value),a=Number.isFinite(t)&&t>0?t:void 0;this._emit({...this._config,goal_km:a})}_emit(e){this._config=e,ge(this,"config-changed",{config:e})}};Pe.styles=n`
    .hint {
      font-size: 0.85rem;
      color: var(--secondary-text-color);
      padding: 8px 2px 2px;
  ...
  `,e([me({attribute:!1})],Pe.prototype,"hass",void 0),e([ve()],Pe.prototype,"_config",void 0),Pe=e([ue("suunto-goal-editor")],Pe);const Ve=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function Le(e){if(e)for(const[t,a]of Ve)if(t.test(e))return a;return"mdi:run-fast"}const Oe={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};function qe(e){return(e??[]).map(e=>({t:new Date(e.last_updated??e.last_changed??"").getTime(),v:Number(e.state)})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}async function Be(e,t,a,i="mean"){const s=new Date,r=new Date(s.getTime()-36e5*a),n=await e.callWS({type:"recorder/statistics_during_period",start_time:r.toISOString(),end_time:s.toISOString(),statistic_ids:[t],period:"hour",types:["mean","min","max","sum"]});return(n?.[t]??[]).map(e=>({t:e.start,v:Number(e[i])})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}function Ie(e){const t=[...e].sort((e,t)=>e.t-t.t),a=new Map;for(let e=1;e<t.length;e++){const i=t[e].v-t[e-1].v;if(!Number.isFinite(i)||i<0)continue;const s=new Date(t[e].t).toDateString();a.set(s,(a.get(s)??0)+i)}return[...a.entries()].map(([e,t])=>({t:new Date(e).getTime(),v:t})).sort((e,t)=>e.t-t.t)}function Ge(e){const t=new Map;for(const a of e){const e=new Date(a.t).toDateString(),i=t.get(e)??{sum:0,count:0};i.sum+=a.v,i.count+=1,t.set(e,i)}return[...t.entries()].map(([e,{sum:t,count:a}])=>({t:new Date(e).getTime(),v:t/a})).sort((e,t)=>e.t-t.t)}function We(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Ue(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function Ke(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Ze(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const Qe=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Je(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of Qe)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const Ye=new Set(["unknown","unavailable",""]);let Xe=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||Ye.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),c=i("last_avg_hr"),d=i("last_max_hr"),l=i("last_avg_pace"),u=i("last_avg_speed"),h=i("last_pte"),p=i("last_epoc"),m=i("last_feeling"),v=i("last_tss"),_=i("last_cal_per_km"),y=i("last_cadence"),g=i("last_pct_hrmax"),f=i("last_workout_weather"),b=i("last_workout_tags"),w=i("last_workout_achievements"),k=o?We(Number(o.state)):void 0,$=void 0===l&&void 0!==u,x=m&&!Ye.has(m.state)?Number(m.state):void 0,S=h&&!Ye.has(h.state)?Number(h.state):void 0,z=w?Number(w.state):0;return I`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        ...
        <div class="stats">
          ${n?this._stat((Number(n.state)/1e3).toFixed(1),"km",Se(a,"stat.distance")):U}
          ${k?this._stat(k.value,k.unit,Se(a,"stat.duration")):U}
          ${l?this._stat(Ue(Number(l.state)),"/km",Se(a,"stat.avg_pace")):$?this._stat(Number(u.state).toFixed(1),"km/h",Se(a,"stat.avg_speed")):U}
          ${c?this._stat(String(Math.round(Number(c.state))),"bpm",Se(a,"stat.avg_hr"),!0):U}
          ${d?this._stat(String(Math.round(Number(d.state))),"bpm",Se(a,"stat.max_hr"),!0):U}
          ${void 0!==S?I`
                <div class="stat">
        ...
        ${v||p||void 0!==x||_||y||g?I`
              <hr />
              <div class="secondary">
                ${v?this._secondary(String(Math.round(Number(v.state))),Se(a,"stat.tss")):U}
                ${p?this._secondary(Number(p.state).toFixed(1),Se(a,"stat.epoc")):U}
                ${void 0!==x?I`
                      <div class="sec-item">
                        <div class="feeling">
                    ...
                    `:U}
                ${_?this._secondary(`${Math.round(Number(_.state))}`,Se(a,"stat.energy"),"kcal/km"):U}
                ${y?this._secondary(String(Math.round(Number(y.state))),Se(a,"stat.cadence"),"rpm"):U}
                ${g?this._secondary(String(Math.round(Number(g.state))),Se(a,"stat.pct_hrmax"),"%"):U}
              </div>
            `:U}
        ${f&&!Ye.has(f.state)?I`
              <div class="weather">
                <ha-icon .icon=${function(e){const t=e?.slice(0,2);return t&&Oe[t]||"mdi:weather-cloudy"}(f.attributes.icon_code)}></ha-icon>
            ...
            `:U}
        ${b&&!Ye.has(b.state)||z>0?I`
              <div class="footer">
                ${b&&!Ye.has(b.state)?I`<span class="chip"><ha-icon icon="mdi:tag-outline"></ha-icon>${b.state}</span>`:U}
                ${z>0?I`
                      <span
                        class="chip accent"
                      ...
                      >
                        ...
                        ${function(e,t,a){if(Array.isArray(t)&&t.length){const e=t[0];if("string"==typeof e)return e;if(e&&"object"==typeof e){const t=e,a=t.name??t.title??t.type;if("string"==typeof a)return a}}return ze(e,a,"achievement.count_one","achievement.count_other")}(a,w?.attributes.achievements,z)}
                      </span>
                    `:U}
              </div>
            `:U}
    ...
    `}_openMoreInfo(e){e&&ge(this,"hass-more-info",{entityId:e})}};Xe.styles=[Te,Ee,n`
      .activity {
    ...
    `],e([ve()],Xe.prototype,"_config",void 0),Xe=e([ue("suunto-last-workout-card")],Xe);const et=e=>`var(--sc-zone-${e})`;let tt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-zones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=[];for(let e=1;e<=5;e++){const s=t[`last_zone${e}`],r=s?a.states[s]:void 0;r&&!Number.isNaN(Number(r.state))&&i.push({n:e,minutes:Number(r.state),lower:r.attributes.lower_limit_bpm,upper:r.attributes.upper_limit_bpm})}const s=i.reduce((e,t)=>e+t.minutes,0);if(0===i.length||s<=0)return this._message("mdi:heart-pulse",Se(a,"empty.hr_zones.title"),Se(a,"empty.hr_zones.subtitle"));const r=t.last_workout_start,n=r?a.states[r]:void 0,o=Se(a,"card.hr_zones.last_workout");return I`
      <ha-card class="static">
        <div class="header">
        ...
        ${Ne(i.map(e=>({flexGrow:e.minutes,colorVar:et(e.n),title:Se(a,"label.zone",{n:e.n})})))}
    ...
    `],e([ve()],tt.prototype,"_config",void 0),tt=e([ue("suunto-hr-zones-card")],tt);const at=new Set(["unknown","unavailable",""]);let it=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||at.has(s.state))return this._message("mdi:sleep",Se(a,"empty.sleep_readiness.title"),Se(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),c=i("sleep_rem"),d=i("sleep_quality"),l=i("sleep_spo2"),u=i("sleep_hrv"),h=i("hrv_baseline"),p=i("hrv_status"),m=i("resting_hr"),v=i("resting_hr_baseline"),_=i("readiness"),y=i("nap_duration"),g=i("sleep_avg_hr"),f=i("sleep_min_hr"),b=i("sleep_time"),w=_&&!at.has(_.state)?Number(_.state):void 0,k=void 0!==w?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,w):void 0,$=u&&h&&!at.has(h.state)?Number(u.state)-Number(h.state):void 0,x=m&&v&&!at.has(v.state)?Number(m.state)-Number(v.state):void 0,S=[n&&!at.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:Se(a,"label.deep")}:void 0,o&&!at.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:Se(a,"label.light")}:void 0,c&&!at.has(c.state)?{flexGrow:Number(c.state),colorVar:"var(--sc-sleep-rem)",title:Se(a,"label.rem")}:void 0].filter(e=>void 0!==e),z=We(60*Number(s.state)),A=y&&!at.has(y.state)?Number(y.state):void 0,C=!!y?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(y.attributes.date)),T={duration:`${z.value} ${z.unit}`};return I`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${r?Se(a,"card.sleep_readiness.subtitle_with_wake",{...T,time:Ke(new Date(r.state),a.language)}):Se(a,"card.sleep_readiness.subtitle_no_wake",T)}
            </div>
          </div>
        </div>
        ...
        ${void 0!==w&&k?I`
              <div class="readiness-row">
                <div class="ring-wrap">
                  ${je(w,k.colorVar,60,6)}
                  <div class="ring-value" style="color:${k.colorVar}">${Math.round(w)}</div>
                </div>
                <div class="readiness-text">
                  <div class="readiness-label">${Se(a,"stat.readiness")}</div>
                  <div class="readiness-band" style="color:${k.colorVar}">${k.label}</div>
                </div>
              </div>
            `:U}

        <div class="stats">
          ${d?this._stat(String(Math.round(Number(d.state))),"%",Se(a,"stat.quality")):U}
          ${u?this._stat(String(Math.round(Number(u.state))),"ms",void 0!==$?Se(a,"stat.hrv_delta",{delta:Ze($)}):Se(a,"stat.hrv"),void 0!==$?$>=0?"good":"bad":void 0):U}
          ${m?this._stat(String(Math.round(Number(m.state))),"bpm",void 0!==x?Se(a,"stat.resting_hr_delta",{delta:Ze(x)}):Se(a,"stat.resting_hr"),void 0!==x?x<=0?"good":"bad":void 0):U}
          ${l?this._stat(String(Math.round(Number(l.state))),"%",Se(a,"stat.spo2")):U}
          ${g?this._stat(String(Math.round(Number(g.state))),"bpm",Se(a,"stat.sleep_avg_hr")):U}
          ${f?this._stat(String(Math.round(Number(f.state))),"bpm",Se(a,"stat.sleep_min_hr")):U}
        </div>
        ...
        ${p&&!at.has(p.state)||A||b&&!at.has(b.state)?I`
              <div class="footer">
                ${p&&!at.has(p.state)?(()=>{const e=function(e,t){return"low"===t?{colorVar:"var(--sc-warn)",label:Se(e,"band.hrv.low")}:"high"===t?{colorVar:"var(--sc-pulse)",label:Se(e,"band.hrv.high")}:{colorVar:"var(--sc-good)",label:Se(e,"band.hrv.balanced")}}(a,p.state);return I`<span class="chip" style="color:${e.colorVar}"
                ...
                ${b&&!at.has(b.state)?I`<span class="chip">
                      <ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.bedtime",{time:Ke(new Date(b.state),a.language)})}
                    </span>`:U}
              </div>
            `:U}
      </ha-card>
    ...
    `],e([ve()],it.prototype,"_config",void 0),it=e([ue("suunto-sleep-readiness-card")],it);const st=new Set(["unknown","unavailable",""]);let rt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||st.has(s.state))return this._message("mdi:battery-heart-variant",Se(a,"empty.recovery.title"));const r=i("is_recovering"),n=i("recovery_until"),o=i("recovery_time"),c=i("stress_state"),d=i("workout_today"),l=Number(s.state),u=function(e,t){return t>=60?{colorVar:"var(--sc-good)",label:Se(e,"band.recovery.well")}:t>=30?{colorVar:"var(--sc-warn)",label:Se(e,"band.recovery.partial")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.recovery.low")}}(a,l),h="on"===r?.state;let p=Se(a,"band.recovery.fully");if(h&&n&&!st.has(n.state)){const e=new Date(n.state).getTime()-Date.now();if(e>0){const t=We(e/6e4);p=Se(a,"band.recovery.recovering",{time:`${t.value} ${t.unit}`})}}return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="readiness-row">
          <div class="ring-wrap">
            ${je(l,u.colorVar,60,6)}
            <div class="ring-value" style="color:${u.colorVar}">${Math.round(l)}</div>
          </div>
          <div class="readiness-text">
        ...
        ${c||o?I`
              <div class="stats">
                ${c&&!st.has(c.state)?this._stat(c.state,"",Se(a,"stat.stress_level")):U}
                ${o&&!st.has(o.state)?this._stat(Number(o.state).toFixed(1),"h",Se(a,"stat.recovery_window")):U}
              </div>
            `:U}
        ${"on"===d?.state?I`<div class="footer"><span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${Se(a,"chip.workout_logged_today")}</span></div>`:U}
      </ha-card>
    ...
    `],e([ve()],rt.prototype,"_config",void 0),rt=e([ue("suunto-recovery-card")],rt);const nt=new Set(["unknown","unavailable",""]);let ot=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-load-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.fitness_ctl;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{const e=new Date(a-2592e6).toISOString(),i=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${t}&no_attributes`),s=(i?.[0]??[]).map(e=>({t:new Date(e.last_updated??e.last_changed??"").getTime(),v:Number(e.state)})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v));this._history=s}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||nt.has(s.state))return this._message("mdi:arm-flex",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=i("acwr"),c=n&&!nt.has(n.state)?Number(n.state):void 0,d=void 0!==c?function(e,t){return t>5?{colorVar:"var(--sc-good)",label:Se(e,"band.form.fresh")}:t<-20?{colorVar:"var(--sc-bad)",label:Se(e,"band.form.very_fatigued")}:t<-5?{colorVar:"var(--sc-warn)",label:Se(e,"band.form.fatigued")}:{colorVar:"var(--sc-pulse)",label:Se(e,"band.form.neutral")}}(a,c):void 0,l=o&&!nt.has(o.state)?Number(o.state):void 0,u=void 0!==l?function(e,t){return t>1.3?{colorVar:"var(--sc-bad)",label:Se(e,"band.acwr.high")}:t<.8?{colorVar:"var(--sc-warn)",label:Se(e,"band.acwr.low")}:{colorVar:"var(--sc-good)",label:Se(e,"band.acwr.safe")}}(a,l):void 0;return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:arm-flex"></ha-icon></div>
          <div class="title-block">
            <div class="title">${Se(a,"card.training_load.title")}</div>
            <div class="subtitle">${d?d.label:Se(a,"card.training_load.subtitle_fallback")}</div>
          </div>
        </div>

        ${De(this._history,"var(--sc-amber)")}

        <div class="stats">
          ${this._stat(Number(s.state).toFixed(0),Se(a,"stat.ctl"))}
          ${r?this._stat(Number(r.state).toFixed(0),Se(a,"stat.atl")):U}
          ${void 0!==c?this._stat(Ze(c,1),Se(a,"stat.tsb"),d?.colorVar):U}
        </div>
        ...
        ${void 0!==l&&u?I`
              <div class="footer">
                <span class="chip" style="color:${u.colorVar}">
                  ...
                  ${Se(a,"chip.acwr",{value:l.toFixed(2),label:u.label})}
                </span>
              </div>
            `:U}
      </ha-card>
    ...
    `],e([ve()],ot.prototype,"_config",void 0),e([ve()],ot.prototype,"_history",void 0),ot=e([ue("suunto-training-load-card")],ot);const ct=new Set(["unknown","unavailable",""]),dt=["var(--sc-amber)","var(--sc-pulse)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let lt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-week-stats-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("weekly_time"),n=i("workouts_7d"),o=i("workouts_30d"),c=i("lifetime_by_activity");if(!s&&!c)return this._message("mdi:calendar-week",Se(a,"empty.week_stats.title"));const d=(c?.attributes.activities??[]).slice().sort((e,t)=>t.distance_km-e.distance_km),l=d.slice(0,5),u=d.length-l.length;return I`
      <ha-card class="static">
        <div class="header">
        ...
        ${s||r||n?I`
              <div class="stats">
                ${s&&!ct.has(s.state)?this._stat(Number(s.state).toFixed(1),"km",Se(a,"stat.distance")):U}
                ${r&&!ct.has(r.state)?this._stat(Number(r.state).toFixed(1),"h",Se(a,"stat.time")):U}
                ${n&&!ct.has(n.state)?this._stat(n.state,"",Se(a,"stat.workouts")):U}
              </div>
            `:U}
        ...
        ${l.length?I`
              ...
              <div class="lifetime">
                ...
                ${Ne(l.map((e,t)=>({flexGrow:e.distance_km,colorVar:dt[t%dt.length],title:e.activity})))}
                <div class="rows">
                  ${l.map((e,t)=>{const a=dt[t%dt.length];return I`
                      <div class="row">
                        <div
                          class="icon-badge tiny"
                          style="background:color-mix(in srgb, ${a} 18%, transparent);color:${a}"
                        >
                          <ha-icon .icon=${Le(e.activity)}></ha-icon>
                        </div>
            ...
            `:U}
        ${o&&!ct.has(o.state)?I`<div class="footer"><span class="chip">${Se(a,"chip.workouts_30d",{count:o.state})}</span></div>`:U}
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
        <div class="stat-value">${e}${t?I`<span class="unit">${t}</span>`:U}</div>
    ...
    `],e([ve()],lt.prototype,"_config",void 0),lt=e([ue("suunto-week-stats-card")],lt);const ut=new Set(["unknown","unavailable",""]);let ht=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-today-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps"),r=i("daily_energy"),n=i("current_hr"),o=i("workout_today"),c=i("is_recovering");if(!s&&!r&&!n)return this._message("mdi:pulse",Se(a,"empty.today.title"));const d=n&&!ut.has(n.state)?Math.round(Number(n.state)):void 0;return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${s&&!ut.has(s.state)?this._stat(Number(s.state).toLocaleString(a.language),"",Se(a,"stat.steps")):U}
          ${r&&!ut.has(r.state)?this._stat(Math.round(Number(r.state)).toLocaleString(a.language),"kcal",Se(a,"stat.energy")):U}
          ${void 0!==d?I`
                <div class="stat hr">
                  <div class="stat-value">
                    <span class="live-dot"></span>${d}<span class="unit">bpm</span>
                  </div>
        ...
        ${"on"===o?.state||"on"===c?.state?I`
              <div class="footer">
                ${"on"===o?.state?I`<span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${Se(a,"chip.workout_today")}</span>`:U}
                ${"on"===c?.state?I`<span class="chip"><ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.recovering")}</span>`:U}
              </div>
            `:U}
      </ha-card>
    `}_stat(e,t,a){return I`
    ...
    `],e([ve()],ht.prototype,"_config",void 0),ht=e([ue("suunto-today-card")],ht);const pt=new Set(["unknown","unavailable",""]);let mt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-lifetime-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance"),r=i("lifetime_time"),n=i("lifetime_energy"),o=i("lifetime_workouts"),c=i("lifetime_days");return!s||pt.has(s.state)?this._message("mdi:trophy-variant",Se(a,"empty.lifetime.title")):I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${r?this._stat(Number(r.state).toFixed(0),"h",Se(a,"stat.time")):U}
          ${n?this._stat(Math.round(Number(n.state)).toLocaleString(a.language),"kcal",Se(a,"stat.energy")):U}
          ${o?this._stat(o.state,"",Se(a,"stat.workouts")):U}
          ${c?this._stat(c.state,"",Se(a,"stat.active_days")):U}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
        ...
        <div class="scroll-list">
          ${r.map(e=>{const t=null!==e.duration_min?We(e.duration_min):void 0;return I`
              <div class="workout-row">
                <div class="icon-badge tiny"><ha-icon .icon=${Le(e.activity)}></ha-icon></div>
    ...
    `:this._message("mdi:format-list-bulleted",Se(a,"empty.recent_workouts.title"))}};vt.styles=[Te,Ee,n`
      .workout-row {
        display: grid;
    ...
    `],e([ve()],vt.prototype,"_config",void 0),vt=e([ue("suunto-recent-workouts-card")],vt);const _t=new Set(["unknown","unavailable",""]);let yt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-elevation-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_ascent"),r=i("last_descent");if((!s||_t.has(s.state))&&(!r||_t.has(r.state)))return this._message("mdi:image-filter-hdr",Se(a,"empty.elevation.title"),Se(a,"empty.elevation.subtitle"));const n=i("last_ascent_time"),o=i("last_descent_time"),c=i("last_min_altitude"),d=i("last_max_altitude"),l=i("last_ascent_rate"),u=i("last_workout_start");return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ${s&&!_t.has(s.state)?this._stat(Math.round(Number(s.state)).toString(),"m",Se(a,"stat.ascent")):U}
          ${r&&!_t.has(r.state)?this._stat(Math.round(Number(r.state)).toString(),"m",Se(a,"stat.descent")):U}
          ${n&&!_t.has(n.state)?(()=>{const e=We(Number(n.state));return this._stat(e.value,e.unit,Se(a,"stat.ascent_time"))})():U}
          ${o&&!_t.has(o.state)?(()=>{const e=We(Number(o.state));return this._stat(e.value,e.unit,Se(a,"stat.descent_time"))})():U}
          ${c&&!_t.has(c.state)?this._stat(Math.round(Number(c.state)).toString(),"m",Se(a,"stat.min_altitude")):U}
          ${d&&!_t.has(d.state)?this._stat(Math.round(Number(d.state)).toString(),"m",Se(a,"stat.max_altitude")):U}
        </div>
        ...
        ${l&&!_t.has(l.state)?I`
              <div class="footer">
                <span class="chip">
                  ...
                  ${Se(a,"stat.ascent_rate")}: ${Math.round(Number(l.state))} m/h
                </span>
              </div>
            `:U}
      </ha-card>
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${c?I`${c.state}`:U}
              ${c&&d?I`<span class="sep">·</span>`:U}
              ${d?Je(new Date(d.state),a.language):U}
            </div>
          </div>
        </div>
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${o?Se(a,"fitness.measured",{time:Je(new Date(o),a.language),activity:c??""}):U}
            </div>
          </div>
        </div>
        ...
        <div class="stats">
          ...
          ${r&&!bt.has(r.state)?this._stat(Number(r.state).toFixed(1),"ml/kg/min",Se(a,"stat.estimated_vo2max")):U}
          ${n&&!bt.has(n.state)?this._stat(String(Math.round(Number(n.state))),"",Se(a,"stat.fitness_age")):U}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
    ...
    `}_openMoreInfo(e){e&&ge(this,"hass-more-info",{entityId:e})}};$t.styles=[Te,Ee,n`
      ha-card {
        gap: 8px;
      }
      .activity {
    ...
    `],e([ve()],$t.prototype,"_config",void 0),$t=e([ue("suunto-last-workout-tile-card")],$t);const xt=new Set(["unknown","unavailable",""]);let St=class extends Ce{constructor(){super(...arguments),this._ctlHistory=[],this._atlHistory=[],this._tsbHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-pmc-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.fitness_ctl;if(!a)return;const i=t.fatigue_atl,s=t.form_tsb,r=[a,i,s].filter(e=>Boolean(e)),n=r.join(","),o=Date.now();if(!(n===this._historyKey&&o-this._historyFetchedAt<6e5)){this._historyKey=n,this._historyFetchedAt=o;try{const e=new Date(o-7776e6).toISOString(),t=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${r.join(",")}&no_attributes`);let a=0;this._ctlHistory=qe(t?.[a++]),this._atlHistory=i?qe(t?.[a++]):[],this._tsbHistory=s?qe(t?.[a++]):[]}catch{this._ctlHistory=[],this._atlHistory=[],this._tsbHistory=[]}}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||xt.has(s.state))return this._message("mdi:chart-timeline-variant",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=[{points:this._ctlHistory,colorVar:"var(--sc-pulse)"}];return this._atlHistory.length&&o.push({points:this._atlHistory,colorVar:"var(--sc-bad)"}),this._tsbHistory.length&&o.push({points:this._tsbHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${this._stat(Number(s.state).toFixed(0),Se(a,"stat.ctl"))}
          ${r&&!xt.has(r.state)?this._stat(Number(r.state).toFixed(0),Se(a,"stat.atl")):U}
          ${n&&!xt.has(n.state)?this._stat(Ze(Number(n.state),1),Se(a,"stat.tsb")):U}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ve()],St.prototype,"_config",void 0),e([ve()],St.prototype,"_ctlHistory",void 0),e([ve()],St.prototype,"_atlHistory",void 0),e([ve()],St.prototype,"_tsbHistory",void 0),St=e([ue("suunto-pmc-card")],St);const zt=new Set(["unknown","unavailable",""]);let At=class extends Ce{constructor(){super(...arguments),this._rhrHistory=[],this._hrvHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.resting_hr,i=t.sleep_hrv;if(!a&&!i)return;const s=[a,i].filter(e=>Boolean(e)),r=s.join(","),n=Date.now();if(!(r===this._historyKey&&n-this._historyFetchedAt<6e5)){this._historyKey=r,this._historyFetchedAt=n;try{const e=new Date(n-2592e6).toISOString(),t=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${s.join(",")}&no_attributes`);let r=0;this._rhrHistory=a?qe(t?.[r++]):[],this._hrvHistory=i?qe(t?.[r++]):[]}catch{this._rhrHistory=[],this._hrvHistory=[]}}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("resting_hr"),r=i("sleep_hrv"),n=s&&!zt.has(s.state),o=r&&!zt.has(r.state);if(!n&&!o)return this._message("mdi:heart-pulse",Se(a,"empty.recovery_trends.title"));const c=i("resting_hr_baseline"),d=i("hrv_baseline"),l=n&&c&&!zt.has(c.state)?Number(s.state)-Number(c.state):void 0,u=o&&d&&!zt.has(d.state)?Number(r.state)-Number(d.state):void 0,h=[];return this._rhrHistory.length&&h.push({points:this._rhrHistory,colorVar:"var(--sc-pulse)"}),this._hrvHistory.length&&h.push({points:this._hrvHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:heart-pulse"></ha-icon></div>
          <div class="title-block">
        ...
        <div class="stats">
          ${n?this._stat(String(Math.round(Number(s.state))),"bpm",void 0!==l?Se(a,"stat.resting_hr_delta",{delta:Ze(l)}):Se(a,"stat.resting_hr"),void 0!==l?l<=0?"good":"bad":void 0):U}
          ${o?this._stat(String(Math.round(Number(r.state))),"ms",void 0!==u?Se(a,"stat.hrv_delta",{delta:Ze(u)}):Se(a,"stat.hrv"),void 0!==u?u>=0?"good":"bad":void 0):U}
        </div>
      </ha-card>
    `}_stat(e,t,a,i){return I`
      <div class="stat ${i??""}">
    ...
    `],e([ve()],At.prototype,"_config",void 0),e([ve()],At.prototype,"_rhrHistory",void 0),e([ve()],At.prototype,"_hrvHistory",void 0),At=e([ue("suunto-recovery-trends-card")],At);const Ct=new Set(["unknown","unavailable",""]);let Tt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-volume-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.weekly_distance;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{const e=new Date(a-72576e5).toISOString(),i=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${t}&no_attributes`);this._history=qe(i?.[0])}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||Ct.has(i.state))return this._message("mdi:chart-bar",Se(a,"empty.weekly_volume.title"));const r=function(e,t){const a=[...e].sort((e,t)=>e.t-t.t),i=Date.now(),s=[];for(let e=t-1;e>=0;e--){const t=i-7*e*864e5,r=t-6048e5,n=a.filter(e=>e.t>r&&e.t<=t),o=n[n.length-1];s.push({value:o?o.v:0,weekEndMs:t})}return s}(this._history,12),n=r.map(e=>({value:e.value,label:`${new Date(e.weekEndMs).toLocaleDateString(a.language,{month:"short",day:"numeric"})} · ${e.value.toFixed(1)} km`})),o=r.reduce((e,t)=>e+t.value,0),c=o/12;return I`
      <ha-card class="static">
        ...
        ${function(e,t,a=300,i=70){if(0===e.length)return U;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return G`
  ...
  `}(n,"var(--sc-amber)",300,80)}
    ...
    `],e([ve()],Tt.prototype,"_config",void 0),e([ve()],Tt.prototype,"_history",void 0),Tt=e([ue("suunto-weekly-volume-card")],Tt);const Et=new Set(["unknown","unavailable",""]);let Nt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-curve-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{this._history=await Be(this.hass,"suunto_app:hr",26,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="current_hr"]?a.states[t[s]]:void 0;var s;if(!i||Et.has(i.state))return this._message("mdi:chart-bell-curve",Se(a,"empty.hr_curve.title"),Se(a,"empty.hr_curve.subtitle"));const r=this._history.map(e=>e.v),n=r.length?Math.min(...r):void 0,o=r.length?Math.max(...r):void 0;return I`
      <ha-card class="static">
        ...
        ${De(this._history,"var(--sc-pulse)")}

        <div class="stats">
          ${this._stat(String(Math.round(Number(i.state))),"bpm",Se(a,"stat.hr_now"))}
          ${void 0!==n?this._stat(String(Math.round(n)),"bpm",Se(a,"stat.hr_min")):U}
          ${void 0!==o?this._stat(String(Math.round(o)),"bpm",Se(a,"stat.hr_max")):U}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat hr">
    ...
    `],e([ve()],Nt.prototype,"_config",void 0),e([ve()],Nt.prototype,"_history",void 0),Nt=e([ue("suunto-hr-curve-card")],Nt);const jt=new Set(["unknown","unavailable",""]);let Dt=class extends Ce{constructor(){super(...arguments),this._durationHistory=[],this._qualityHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Be(this.hass,"suunto_app:sleep_duration",720,"mean"),Be(this.hass,"suunto_app:sleep_quality",720,"mean")]);this._durationHistory=e,this._qualityHistory=t}catch{this._durationHistory=[],this._qualityHistory=[]}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||jt.has(s.state))return this._message("mdi:power-sleep",Se(a,"empty.sleep_trends.title"));const r=i("sleep_quality"),n=[];this._durationHistory.length&&n.push({points:this._durationHistory,colorVar:"var(--sc-pulse)"}),this._qualityHistory.length&&n.push({points:this._qualityHistory,colorVar:"var(--sc-amber)"});const o=We(60*Number(s.state));return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${r&&!jt.has(r.state)?this._stat(`${Math.round(Number(r.state))}%`,Se(a,"stat.quality")):U}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
      ...
      <ha-card class="static">
        ...
        <div class="footer">
          <span class="chip">
            ...
            ${ze(a,d,"streak.window_count_one","streak.window_count_other")}
          </span>
        </div>
      </ha-card>
    `}};Ht.styles=[Te,Ee,n`
    ...
    `],e([ve()],Ht.prototype,"_config",void 0),Ht=e([ue("suunto-streak-card")],Ht);const Mt=new Set(["unknown","unavailable",""]);let Ft=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-just-finished-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity"),r=i("last_workout_start");if(!s||Mt.has(s.state)||!r)return this._message("mdi:party-popper",Se(a,"empty.just_finished.title"));const n=new Date(r.last_changed),o=Date.now()-n.getTime();if(!(Number.isFinite(o)&&o>=0&&o<216e5))return this._message("mdi:party-popper",Se(a,"just_finished.idle.title"),Se(a,"just_finished.idle.subtitle"));const c=i("last_distance"),d=i("last_duration"),l=i("last_avg_hr"),u=i("last_tss");return I`
      <ha-card class="static celebrate">
        ...
        <div class="stats">
          ${c?this._stat((Number(c.state)/1e3).toFixed(1),"km",Se(a,"stat.distance")):U}
          ${d?(()=>{const e=We(Number(d.state));return this._stat(e.value,e.unit,Se(a,"stat.duration"))})():U}
          ${l?this._stat(String(Math.round(Number(l.state))),"bpm",Se(a,"stat.avg_hr")):U}
          ${u?this._stat(Number(u.state).toFixed(0),"",Se(a,"stat.tss")):U}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
    ...
    `],e([ve()],Ft.prototype,"_config",void 0),Ft=e([ue("suunto-just-finished-card")],Ft);const Rt=new Set(["unknown","unavailable",""]);let Pt=class extends Ce{constructor(){super(...arguments),this._stepsHistory=[],this._energyHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-activity-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Be(this.hass,"suunto_app:steps",336,"sum"),Be(this.hass,"suunto_app:energy",336,"sum")]);this._stepsHistory=Ie(e),this._energyHistory=Ie(t)}catch{this._stepsHistory=[],this._energyHistory=[]}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps");if(!s||Rt.has(s.state))return this._message("mdi:shoe-print",Se(a,"empty.activity_trends.title"));const r=i("daily_energy"),n=[];return this._stepsHistory.length&&n.push({points:this._stepsHistory,colorVar:"var(--sc-pulse)"}),this._energyHistory.length&&n.push({points:this._energyHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${r&&!Rt.has(r.state)?this._stat(`${Math.round(Number(r.state))} kcal`,Se(a,"stat.energy")):U}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ve()],Pt.prototype,"_config",void 0),e([ve()],Pt.prototype,"_stepsHistory",void 0),e([ve()],Pt.prototype,"_energyHistory",void 0),Pt=e([ue("suunto-activity-trends-card")],Pt);const Vt=new Set(["unknown","unavailable",""]);let Lt=class extends Ce{constructor(){super(...arguments),this._balanceHistory=[],this._stressHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-balance-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Be(this.hass,"suunto_app:recovery_balance",336,"mean"),Be(this.hass,"suunto_app:stress",336,"mean")]);this._balanceHistory=Ge(e),this._stressHistory=Ge(t)}catch{this._balanceHistory=[],this._stressHistory=[]}}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Vt.has(s.state))return this._message("mdi:heart-flash",Se(a,"empty.recovery_balance_trend.title"));const r=i("stress_state"),n=[];return this._balanceHistory.length&&n.push({points:this._balanceHistory,colorVar:"var(--sc-pulse)"}),this._stressHistory.length&&n.push({points:this._stressHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${r&&!Vt.has(r.state)?this._stat(r.state,Se(a,"stat.stress_level")):U}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ve()],qt.prototype,"_config",void 0),e([ve()],qt.prototype,"_history",void 0),qt=e([ue("suunto-readiness-trend-card")],qt);function Bt(e){return e<=0?0:1===e?1:2===e?2:3}let It=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-activity-calendar-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[];if(!s||0===r.length)return this._message("mdi:calendar-month",Se(a,"empty.activity_calendar.title"));const n=function(e){const t=new Map;for(const a of e){if(!a.start)continue;const e=new Date(a.start).toDateString();t.set(e,(t.get(e)??0)+1)}return t}(r),o=new Date,c=(o.getDay()+6)%7,d=new Date(o);d.setDate(o.getDate()-c-35);let l=0;const u=[],h=new Date(d);for(let e=0;e<42;e++){const e=n.get(h.toDateString())??0;e>0&&l++;const t=Bt(e);u.push(I`<span
      ...
      <ha-card class="static">
        ...
        <div class="footer">
          <span class="chip">
            <ha-icon icon="mdi:calendar-check"></ha-icon>
            ${ze(a,l,"activity_calendar.active_days_one","activity_calendar.active_days_other")}
          </span>
        </div>
      </ha-card>
    ...
    `],e([ve()],Wt.prototype,"_config",void 0),Wt=e([ue("suunto-workout-comparison-card")],Wt);const Ut=new Set(["unknown","unavailable",""]);let Kt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-milestones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance");if(!s||Ut.has(s.state))return this._message("mdi:earth",Se(a,"empty.milestones.title"));const r=i("lifetime_energy"),n=Number(s.state),o=n/40075,c=n/42.195,d=n/384400*100,l=r&&!Ut.has(r.state)?Number(r.state)/550:void 0;return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${this._stat(`${d.toFixed(1)}%`,Se(a,"stat.moon_pct"))}
          ${void 0!==l?this._stat(l.toFixed(0),Se(a,"stat.burgers")):U}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${Se(a,l)} · ${Se(a,u)} · ${Se(a,h.key)}
            </div>
          </div>
        </div>

        <div class="traits">
          <span class="chip accent"><ha-icon .icon=${Le(d)}></ha-icon>${Se(a,l)}</span>
          <span class="chip accent"><ha-icon icon="mdi:calendar-weekend"></ha-icon>${Se(a,u)}</span>
          <span class="chip accent"><ha-icon .icon=${h.icon}></ha-icon>${Se(a,h.key)}</span>
        </div>
      </ha-card>
    `}};Qt.styles=[Te,Ee,n`
      .traits {
    ...
    `],e([ve()],Qt.prototype,"_config",void 0),Qt=e([ue("suunto-athlete-profile-card")],Qt);let Jt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-pace-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return U;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[],n=s?function(e){const t=e[0]?.activity;if(!t)return;const a=e.filter(e=>e.activity===t&&e.start&&e.distance_km&&e.duration_min).map(e=>({t:new Date(e.start).getTime(),v:e.duration_min/e.distance_km})).sort((e,t)=>e.t-t.t);if(a.length<2)return;const i=Math.ceil(a.length/2),s=a.slice(0,i),r=a.slice(i).length?a.slice(i):a.slice(-1),n=e=>e.reduce((e,t)=>e+t.v,0)/e.length,o=n(s),c=(n(r)-o)/o,d=c<-.03?"faster":c>.03?"slower":"steady";return{activity:t,points:a,latestPace:a[a.length-1].v,direction:d}}(r):void 0;if(!n)return this._message("mdi:speedometer",Se(a,"empty.pace_trend.title"),Se(a,"empty.pace_trend.subtitle"));const o="faster"===n.direction?{colorVar:"var(--sc-good)",label:Se(a,"pace_trend.faster")}:"slower"===n.direction?{colorVar:"var(--sc-warn)",label:Se(a,"pace_trend.slower")}:{colorVar:"var(--sc-pulse)",label:Se(a,"pace_trend.steady")};return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon .icon=${Le(n.activity)}></ha-icon></div>
          <div class="title-block">
