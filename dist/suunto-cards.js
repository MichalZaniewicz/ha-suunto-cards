 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x=globalThis,$=e=>e,z=x.trustedTypes,S=z?z.createPolicy("lit-html",{createHTML:e=>e}):void 0,A="$lit$",T=`lit$${Math.random().toFixed(9).slice(2)}$`,C="?"+T,E=`<${C}>`,N=document,j=()=>N.createComment(""),R=e=>null===e||"object"!=typeof e&&"function"!=typeof e,M=Array.isArray,D="[ \t\n\f\r]",V=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,F=/-->/g,P=/>/g,H=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),L=/'/g,q=/"/g,O=/^(?:script|style|textarea|title)$/i,B=e=>(t,...a)=>({_$litType$:e,strings:t,values:a}),I=B(1),W=B(2),G=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),U=new WeakMap,Z=N.createTreeWalker(N,129);function X(e,t){if(!M(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==S?S.createHTML(t):t}const Y=(e,t)=>{const a=e.length-1,i=[];let s,r=2===t?"<svg>":3===t?"<math>":"",n=V;for(let t=0;t<a;t++){const a=e[t];let o,l,c=-1,d=0;for(;d<a.length&&(n.lastIndex=d,l=n.exec(a),null!==l);)d=n.lastIndex,n===V?"!--"===l[1]?n=F:void 0!==l[1]?n=P:void 0!==l[2]?(O.test(l[2])&&(s=RegExp("</"+l[2],"g")),n=H):void 0!==l[3]&&(n=H):n===H?">"===l[0]?(n=s??V,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,o=l[1],n=void 0===l[3]?H:'"'===l[3]?q:L):n===q||n===L?n=H:n===F||n===P?n=V:(n=H,s=void 0);const u=n===H&&e[t+1].startsWith("/>")?" ":"";r+=n===V?a+E:c>=0?(i.push(o),a.slice(0,c)+A+a.slice(c)+T+u):a+T+(-2===c?t:u)}return[X(e,r+(e[a]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),i]};class J{constructor({strings:e,_$litType$:t},a){let i;this.parts=[];let s=0,r=0;const n=e.length-1,o=this.parts,[l,c]=Y(e,t);if(this.el=J.createElement(l,a),Z.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(i=Z.nextNode())&&o.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const e of i.getAttributeNames())if(e.endsWith(A)){const t=c[r++],a=i.getAttribute(e).split(T),n=/([.?@])?(.*)/.exec(t);o.push({type:1,index:s,name:n[2],strings:a,ctor:"."===n[1]?ie:"?"===n[1]?se:"@"===n[1]?re:ae}),i.removeAttribute(e)}else e.startsWith(T)&&(o.push({type:6,index:s}),i.removeAttribute(e));if(O.test(i.tagName)){const e=i.textContent.split(T),t=e.length-1;if(t>0){i.textContent=z?z.emptyScript:"";for(let a=0;a<t;a++)i.append(e[a],j()),Z.nextNode(),o.push({type:2,index:++s});i.append(e[t],j())}}}else if(8===i.nodeType)if(i.data===C)o.push({type:2,index:s});else{let e=-1;for(;-1!==(e=i.data.indexOf(T,e+1));)o.push({type:7,index:s}),e+=T.length-1}s++}}static createElement(e,t){const a=N.createElement("template");return a.innerHTML=e,a}}function Q(e,t,a=e,i){if(t===G)return t;let s=void 0!==i?a._$Co?.[i]:a._$Cl;const r=R(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(e),s._$AT(e,a,i)),void 0!==i?(a._$Co??=[])[i]=s:a._$Cl=s),void 0!==s&&(t=Q(e,s._$AS(e,t.values),s,i)),t}class ee{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:a}=this._$AD,i=(e?.creationScope??N).importNode(t,!0);Z.currentNode=i;let s=Z.nextNode(),r=0,n=0,o=a[0];for(;void 0!==o;){if(r===o.index){let t;2===o.type?t=new te(s,s.nextSibling,this,e):1===o.type?t=new o.ctor(s,o.name,o.strings,this,e):6===o.type&&(t=new ne(s,this,e)),this._$AV.push(t),o=a[++n]}r!==o?.index&&(s=Z.nextNode(),r++)}return Z.currentNode=N,i}p(e){let t=0;for(const a of this._$AV)void 0!==a&&(void 0!==a.strings?(a._$AI(e,a,t),t+=a.strings.length-2):a._$AI(e[t])),t++}}class te{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,a,i){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Q(this,e,t),R(e)?e===K||null==e||""===e?(this._$AH!==K&&this._$AR(),this._$AH=K):e!==this._$AH&&e!==G&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>M(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==K&&R(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:a}=e,i="number"==typeof a?this._$AC(e):(void 0===a.el&&(a.el=J.createElement(X(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(t);else{const e=new ee(i,this),a=e.u(this.options);e.p(t),this.T(a),this._$AH=e}}_$AC(e){let t=U.get(e.strings);return void 0===t&&U.set(e.strings,t=new J(e)),t}k(e){M(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,i=0;for(const s of e)i===t.length?t.push(a=new te(this.O(j()),this.O(j()),this,this.options)):a=t[i],a._$AI(s),i++;i<t.length&&(this._$AR(a&&a._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=$(e).nextSibling;$(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ae{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,a,i,s){this.type=1,this._$AH=K,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=s,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=K}_$AI(e,t=this,a,i){const s=this.strings;let r=!1;if(void 0===s)e=Q(this,e,t,0),r=!R(e)||e!==this._$AH&&e!==G,r&&(this._$AH=e);else{const i=e;let n,o;for(e=s[0],n=0;n<s.length-1;n++)o=Q(this,i[a+n],t,n),o===G&&(o=this._$AH[n]),r||=!R(o)||o!==this._$AH[n],o===K?e=K:e!==K&&(e+=(o??"")+s[n+1]),this._$AH[n]=o}r&&!i&&this.j(e)}j(e){e===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ie extends ae{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===K?void 0:e}}class se extends ae{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==K)}}class re extends ae{constructor(e,t,a,i,s){super(e,t,a,i,s),this.type=5}_$AI(e,t=this){if((e=Q(this,e,t,0)??K)===G)return;const a=this._$AH,i=e===K&&a!==K||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==K&&(a===K||i);i&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ne{constructor(e,t,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){Q(this,e)}}const oe=x.litHtmlPolyfillSupport;oe?.(J,te),(x.litHtmlVersions??=[]).push("3.3.3");const le=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function je(e){return I`
  ...
  `}function De(e){const t=e.map(e=>e.v),a=Math.min(...t);return{min:a,span:Math.max(...t)-a||1}}function Ve(e,t=300,a=70,i=!0){const s=e.filter(e=>e.points.length>=2);if(0===s.length)return K;const r=.1*a,n=a-2*r,o=i?De(s.flatMap(e=>e.points)):void 0,l=s.map(e=>{const{min:a,span:i}=o??De(e.points),s=t/(e.points.length-1),l=e.points.map((e,t)=>[t*s,r+n-(e.v-a)/i*n]),c=l.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),[d,u]=l[l.length-1];return W`
      <path
        d=${c}
        fill="none"
        stroke=${e.colorVar}
  ...
  `}function Fe(e,t,a=300,i=70){if(0===e.length)return K;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return W`
  ...
  `}const Pe=new Set(["unknown","unavailable",""]);let He=class extends Ce{static getConfigElement(){return document.createElement("suunto-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-goal-card",goal_km:50}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||Pe.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_goal.title"));const r=this._config.goal_km??50,n=Number(i.state),o=r>0?n/r*100:0,l=o>=100?"var(--sc-good)":"var(--sc-amber)";return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],He.prototype,"_config",void 0),He=e([ue("suunto-weekly-goal-card")],He);let Le=class extends ce{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return K;const e=we(this.hass);return I`
      ${e.length>1?I`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
  ...
  `,e([he({attribute:!1})],Le.prototype,"hass",void 0),e([ge()],Le.prototype,"_config",void 0),Le=e([ue("suunto-goal-editor")],Le);const qe=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function Oe(e){if(e)for(const[t,a]of qe)if(t.test(e))return a;return"mdi:run-fast"}const Be={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};async function Ie(e,t,a,i="mean"){const s=new Date,r=new Date(s.getTime()-36e5*a),n=await e.callWS({type:"recorder/statistics_during_period",start_time:r.toISOString(),end_time:s.toISOString(),statistic_ids:[t],period:"hour",types:["mean","min","max","sum"]});return(n?.[t]??[]).map(e=>({t:e.start,v:Number(e[i])})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}function We(e){const t=[...e].sort((e,t)=>e.t-t.t),a=new Map;for(let e=1;e<t.length;e++){const i=t[e].v-t[e-1].v;if(!Number.isFinite(i)||i<0)continue;const s=new Date(t[e].t).toDateString();a.set(s,(a.get(s)??0)+i)}return[...a.entries()].map(([e,t])=>({t:new Date(e).getTime(),v:t})).sort((e,t)=>e.t-t.t)}function Ge(e){const t=new Map;for(const a of e){const e=new Date(a.t).toDateString(),i=t.get(e)??{sum:0,count:0};i.sum+=a.v,i.count+=1,t.set(e,i)}return[...t.entries()].map(([e,{sum:t,count:a}])=>({t:new Date(e).getTime(),v:t/a})).sort((e,t)=>e.t-t.t)}function Ke(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Ue(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function Ze(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Xe(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const Ye=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Je(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of Ye)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const Qe=new Set(["unknown","unavailable",""]);let et=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||Qe.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),l=i("last_avg_hr"),c=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),m=i("last_pte"),p=i("last_epoc"),h=i("last_feeling"),g=i("last_tss"),v=i("last_cal_per_km"),y=i("last_cadence"),_=i("last_pct_hrmax"),b=i("last_workout_weather"),f=i("last_workout_tags"),w=i("last_workout_achievements"),k=o?Ke(Number(o.state)):void 0,x=void 0===d&&void 0!==u,$=h&&!Qe.has(h.state)?Number(h.state):void 0,z=m&&!Qe.has(m.state)?Number(m.state):void 0,S=w?Number(w.state):0;return I`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        ...
        ${b&&!Qe.has(b.state)?I`
              <div class="weather">
                <ha-icon .icon=${function(e){const t=e?.slice(0,2);return t&&Be[t]||"mdi:weather-cloudy"}(b.attributes.icon_code)}></ha-icon>
            ...
            `:K}
        ${f&&!Qe.has(f.state)||S>0?I`
              <div class="footer">
                ${f&&!Qe.has(f.state)?I`<span class="chip"><ha-icon icon="mdi:tag-outline"></ha-icon>${f.state}</span>`:K}
                ${S>0?I`
                      <span
                        class="chip accent"
    ...
    `}_openMoreInfo(e){e&&_e(this,"hass-more-info",{entityId:e})}};et.styles=[Ee,Ne,n`
      .activity {
    ...
    `],e([ge()],et.prototype,"_config",void 0),et=e([ue("suunto-last-workout-card")],et);const tt=e=>`var(--sc-zone-${e})`;let at=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-zones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=[];for(let e=0;e<=5;e++){const s=t[`last_zone${e}`],r=s?a.states[s]:void 0;r&&!Number.isNaN(Number(r.state))&&i.push({n:e,minutes:Number(r.state),lower:r.attributes.lower_limit_bpm,upper:r.attributes.upper_limit_bpm})}const s=i.reduce((e,t)=>e+t.minutes,0);if(0===i.length||s<=0)return this._message("mdi:heart-pulse",Se(a,"empty.hr_zones.title"),Se(a,"empty.hr_zones.subtitle"));const r=t.last_workout_start,n=r?a.states[r]:void 0,o=Se(a,"card.hr_zones.last_workout");return I`
      <ha-card class="static">
        ...
        ${je(i.map(e=>({flexGrow:e.minutes,colorVar:tt(e.n),title:Se(a,"label.zone",{n:e.n})})))}
    ...
    `],e([ge()],at.prototype,"_config",void 0),at=e([ue("suunto-hr-zones-card")],at);const it=new Set(["unknown","unavailable",""]);let st=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||it.has(s.state))return this._message("mdi:sleep",Se(a,"empty.sleep_readiness.title"),Se(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),l=i("sleep_rem"),c=i("sleep_quality"),d=i("sleep_spo2"),u=i("sleep_hrv"),m=i("hrv_baseline"),p=i("hrv_status"),h=i("resting_hr"),g=i("resting_hr_baseline"),v=i("readiness"),y=i("nap_duration"),_=i("sleep_avg_hr"),b=i("sleep_min_hr"),f=i("sleep_time"),w=i("unusual_recovery"),k=v&&!it.has(v.state)?Number(v.state):void 0,x=void 0!==k?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,k):void 0,$=u&&m&&!it.has(m.state)?Number(u.state)-Number(m.state):void 0,z=h&&g&&!it.has(g.state)?Number(h.state)-Number(g.state):void 0,S=[n&&!it.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:Se(a,"label.deep")}:void 0,o&&!it.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:Se(a,"label.light")}:void 0,l&&!it.has(l.state)?{flexGrow:Number(l.state),colorVar:"var(--sc-sleep-rem)",title:Se(a,"label.rem")}:void 0].filter(e=>void 0!==e),A=Ke(60*Number(s.state)),T=y&&!it.has(y.state)?Number(y.state):void 0,C=!!y?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(y.attributes.date)),E={duration:`${A.value} ${A.unit}`};return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ...
          ${h?this._stat(String(Math.round(Number(h.state))),"bpm",void 0!==z?Se(a,"stat.resting_hr_delta",{delta:Xe(z)}):Se(a,"stat.resting_hr"),void 0!==z?z<=0?"good":"bad":void 0):K}
        ...
        ${p&&!it.has(p.state)||T||f&&!it.has(f.state)||"on"===w?.state?I`
              <div class="footer">
                ${"on"===w?.state?I`<span class="chip bad"><ha-icon icon="mdi:shield-alert-outline"></ha-icon>${Se(a,"chip.unusual_recovery")}</span>`:K}
                ${p&&!it.has(p.state)?(()=>{const e=function(e,t){return"low"===t?{colorVar:"var(--sc-warn)",label:Se(e,"band.hrv.low")}:"high"===t?{colorVar:"var(--sc-pulse)",label:Se(e,"band.hrv.high")}:{colorVar:"var(--sc-good)",label:Se(e,"band.hrv.balanced")}}(a,p.state);return I`<span class="chip" style="color:${e.colorVar}"
                ...
                ${f&&!it.has(f.state)?I`<span class="chip">
                      <ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.bedtime",{time:Ze(new Date(f.state),a.language)})}
                    </span>`:K}
              </div>
            `:K}
      </ha-card>
    ...
    `],e([ge()],st.prototype,"_config",void 0),st=e([ue("suunto-sleep-readiness-card")],st);const rt=new Set(["unknown","unavailable",""]);let nt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||rt.has(s.state))return this._message("mdi:battery-heart-variant",Se(a,"empty.recovery.title"));const r=i("is_recovering"),n=i("recovery_until"),o=i("recovery_time"),l=i("stress_state"),c=i("workout_today"),d=i("unusual_recovery"),u=Number(s.state),m=function(e,t){return t>=60?{colorVar:"var(--sc-good)",label:Se(e,"band.recovery.well")}:t>=30?{colorVar:"var(--sc-warn)",label:Se(e,"band.recovery.partial")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.recovery.low")}}(a,u),p="on"===r?.state;let h=Se(a,"band.recovery.fully");if(p&&n&&!rt.has(n.state)){const e=new Date(n.state).getTime()-Date.now();if(e>0){const t=Ke(e/6e4);h=Se(a,"band.recovery.recovering",{time:`${t.value} ${t.unit}`})}}return I`
      <ha-card class="static">
        <div class="header">
        ...
        ${l||o?I`
              <div class="stats">
                ${l&&!rt.has(l.state)?this._stat(l.state,"",Se(a,"stat.stress_level")):K}
    ...
    `],e([ge()],nt.prototype,"_config",void 0),nt=e([ue("suunto-recovery-card")],nt);const ot=new Set(["unknown","unavailable",""]);let lt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-load-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.fitness_ctl;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{this._history=await Ie(this.hass,t,720,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||ot.has(s.state))return this._message("mdi:arm-flex",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=i("acwr"),l=n&&!ot.has(n.state)?Number(n.state):void 0,c=void 0!==l?function(e,t){return t>5?{colorVar:"var(--sc-good)",label:Se(e,"band.form.fresh")}:t<-20?{colorVar:"var(--sc-bad)",label:Se(e,"band.form.very_fatigued")}:t<-5?{colorVar:"var(--sc-warn)",label:Se(e,"band.form.fatigued")}:{colorVar:"var(--sc-pulse)",label:Se(e,"band.form.neutral")}}(a,l):void 0,d=o&&!ot.has(o.state)?Number(o.state):void 0,u=void 0!==d?function(e,t){return t>1.3?{colorVar:"var(--sc-bad)",label:Se(e,"band.acwr.high")}:t<.8?{colorVar:"var(--sc-warn)",label:Se(e,"band.acwr.low")}:{colorVar:"var(--sc-good)",label:Se(e,"band.acwr.safe")}}(a,d):void 0;return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ...
          ${void 0!==l?this._stat(Xe(l,1),Se(a,"stat.tsb"),c?.colorVar):K}
        </div>
    ...
    `],e([ge()],lt.prototype,"_config",void 0),e([ge()],lt.prototype,"_history",void 0),lt=e([ue("suunto-training-load-card")],lt);const ct=new Set(["unknown","unavailable",""]),dt=["var(--sc-amber)","var(--sc-pulse)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let ut=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-week-stats-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("weekly_time"),n=i("workouts_7d"),o=i("workouts_30d"),l=i("lifetime_by_activity");if(!s&&!l)return this._message("mdi:calendar-week",Se(a,"empty.week_stats.title"));const c=(l?.attributes.activities??[]).slice().sort((e,t)=>t.distance_km-e.distance_km),d=c.slice(0,5),u=c.length-d.length;return I`
      <ha-card class="static">
        ...
        ${s||r||n?I`
              <div class="stats">
                ${s&&!ct.has(s.state)?this._stat(Number(s.state).toFixed(1),"km",Se(a,"stat.distance")):K}
                ${r&&!ct.has(r.state)?this._stat(Number(r.state).toFixed(1),"h",Se(a,"stat.time")):K}
                ${n&&!ct.has(n.state)?this._stat(n.state,"",Se(a,"stat.workouts")):K}
              </div>
            `:K}
        ...
        ${d.length?I`
              ...
              <div class="lifetime">
                ...
                ${je(d.map((e,t)=>({flexGrow:e.distance_km,colorVar:dt[t%dt.length],title:e.activity})))}
                <div class="rows">
                  ${d.map((e,t)=>{const a=dt[t%dt.length];return I`
                      <div class="row">
                        <div
            ...
            `:K}
        ${o&&!ct.has(o.state)?I`<div class="footer"><span class="chip">${Se(a,"chip.workouts_30d",{count:o.state})}</span></div>`:K}
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
        <div class="stat-value">${e}${t?I`<span class="unit">${t}</span>`:K}</div>
    ...
    `:this._message("mdi:format-list-bulleted",Se(a,"empty.recent_workouts.title"))}};vt.styles=[Ee,Ne,n`
      .workout-row {
        display: grid;
    ...
    `],e([ge()],vt.prototype,"_config",void 0),vt=e([ue("suunto-recent-workouts-card")],vt);const yt=new Set(["unknown","unavailable",""]);let _t=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-elevation-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_ascent"),r=i("last_descent");if((!s||yt.has(s.state))&&(!r||yt.has(r.state)))return this._message("mdi:image-filter-hdr",Se(a,"empty.elevation.title"),Se(a,"empty.elevation.subtitle"));const n=i("last_ascent_time"),o=i("last_descent_time"),l=i("last_min_altitude"),c=i("last_max_altitude"),d=i("last_ascent_rate"),u=i("last_workout_start");return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${l&&!yt.has(l.state)?this._stat(Math.round(Number(l.state)).toString(),"m",Se(a,"stat.min_altitude")):K}
          ${c&&!yt.has(c.state)?this._stat(Math.round(Number(c.state)).toString(),"m",Se(a,"stat.max_altitude")):K}
        </div>
        ...
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ...
              ${c?Je(new Date(c.state),a.language):K}
            </div>
          </div>
        </div>
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${o?Se(a,"fitness.measured",{time:Je(new Date(o),a.language),activity:l??""}):K}
            </div>
          </div>
        </div>
    ...
    `}_openMoreInfo(e){e&&_e(this,"hass-more-info",{entityId:e})}};$t.styles=[Ee,Ne,n`
      ha-card {
        gap: 8px;
      }
      .activity {
    ...
    `],e([ge()],St.prototype,"_config",void 0),e([ge()],St.prototype,"_ctlHistory",void 0),e([ge()],St.prototype,"_atlHistory",void 0),e([ge()],St.prototype,"_tsbHistory",void 0),St=e([ue("suunto-pmc-card")],St);const At=new Set(["unknown","unavailable",""]);let Tt=class extends Ce{constructor(){super(...arguments),this._rhrHistory=[],this._hrvHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.resting_hr,i=t.sleep_hrv;if(!a&&!i)return;const s=[a,i].filter(e=>Boolean(e)).join(","),r=Date.now();if(!(s===this._historyKey&&r-this._historyFetchedAt<6e5)){this._historyKey=s,this._historyFetchedAt=r;try{const e=this.hass,[t,s]=await Promise.all([a?Ie(e,a,720,"mean"):Promise.resolve([]),i?Ie(e,i,720,"mean"):Promise.resolve([])]);this._rhrHistory=t,this._hrvHistory=s}catch{this._rhrHistory=[],this._hrvHistory=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("resting_hr"),r=i("sleep_hrv"),n=s&&!At.has(s.state),o=r&&!At.has(r.state);if(!n&&!o)return this._message("mdi:heart-pulse",Se(a,"empty.recovery_trends.title"));const l=i("resting_hr_baseline"),c=i("hrv_baseline"),d=n&&l&&!At.has(l.state)?Number(s.state)-Number(l.state):void 0,u=o&&c&&!At.has(c.state)?Number(r.state)-Number(c.state):void 0,m=[];return this._rhrHistory.length&&m.push({points:this._rhrHistory,colorVar:"var(--sc-pulse)"}),this._hrvHistory.length&&m.push({points:this._hrvHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:heart-pulse"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ge()],Tt.prototype,"_config",void 0),e([ge()],Tt.prototype,"_rhrHistory",void 0),e([ge()],Tt.prototype,"_hrvHistory",void 0),Tt=e([ue("suunto-recovery-trends-card")],Tt);const Ct=new Set(["unknown","unavailable",""]);let Et=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-volume-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.weekly_distance;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{this._history=await Ie(this.hass,t,2016,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||Ct.has(i.state))return this._message("mdi:chart-bar",Se(a,"empty.weekly_volume.title"));const r=function(e,t){const a=[...e].sort((e,t)=>e.t-t.t),i=Date.now(),s=[];for(let e=t-1;e>=0;e--){const t=i-7*e*864e5,r=t-6048e5,n=a.filter(e=>e.t>r&&e.t<=t),o=n[n.length-1];s.push({value:o?o.v:0,weekEndMs:t})}return s}(this._history,12),n=r.map(e=>({value:e.value,label:`${new Date(e.weekEndMs).toLocaleDateString(a.language,{month:"short",day:"numeric"})} · ${e.value.toFixed(1)} km`})),o=r.reduce((e,t)=>e+t.value,0),l=o/12;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `}};Et.styles=[Ee,Ne,n`
    `],e([ge()],Et.prototype,"_config",void 0),e([ge()],Et.prototype,"_history",void 0),Et=e([ue("suunto-weekly-volume-card")],Et);const Nt=new Set(["unknown","unavailable",""]);let jt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-curve-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{this._history=await Ie(this.hass,"suunto_app:hr",26,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="current_hr"]?a.states[t[s]]:void 0;var s;if(!i||Nt.has(i.state))return this._message("mdi:chart-bell-curve",Se(a,"empty.hr_curve.title"),Se(a,"empty.hr_curve.subtitle"));const r=this._history.map(e=>e.v),n=r.length?Math.min(...r):void 0,o=r.length?Math.max(...r):void 0;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],Dt.prototype,"_config",void 0),Dt=e([ue("suunto-streak-card")],Dt);const Vt=new Set(["unknown","unavailable",""]);let Ft=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-just-finished-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity"),r=i("last_workout_start");if(!s||Vt.has(s.state)||!r)return this._message("mdi:party-popper",Se(a,"empty.just_finished.title"));const n=new Date(r.last_changed),o=Date.now()-n.getTime();if(!(Number.isFinite(o)&&o>=0&&o<216e5))return this._message("mdi:party-popper",Se(a,"just_finished.idle.title"),Se(a,"just_finished.idle.subtitle"));const l=i("last_distance"),c=i("last_duration"),d=i("last_avg_hr"),u=i("last_tss");return I`
      <ha-card class="static celebrate">
        ...
        <div class="stats">
          ...
          ${c?(()=>{const e=Ke(Number(c.state));return this._stat(e.value,e.unit,Se(a,"stat.duration"))})():K}
    ...
    `],e([ge()],Ht.prototype,"_config",void 0),e([ge()],Ht.prototype,"_stepsHistory",void 0),e([ge()],Ht.prototype,"_energyHistory",void 0),Ht=e([ue("suunto-activity-trends-card")],Ht);const Lt=new Set(["unknown","unavailable",""]);let qt=class extends Ce{constructor(){super(...arguments),this._balanceHistory=[],this._stressHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-balance-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Ie(this.hass,"suunto_app:recovery_balance",336,"mean"),Ie(this.hass,"suunto_app:stress",336,"mean")]);this._balanceHistory=Ge(e),this._stressHistory=Ge(t)}catch{this._balanceHistory=[],this._stressHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Lt.has(s.state))return this._message("mdi:heart-flash",Se(a,"empty.recovery_balance_trend.title"));const r=i("stress_state"),n=[];return this._balanceHistory.length&&n.push({points:this._balanceHistory,colorVar:"var(--sc-pulse)"}),this._stressHistory.length&&n.push({points:this._stressHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],qt.prototype,"_config",void 0),e([ge()],qt.prototype,"_balanceHistory",void 0),e([ge()],qt.prototype,"_stressHistory",void 0),qt=e([ue("suunto-recovery-balance-trend-card")],qt);const Ot=new Set(["unknown","unavailable",""]);let Bt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-readiness-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{this._history=await Ie(this.hass,"suunto_app:readiness",720,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="readiness"]?a.states[t[s]]:void 0;var s;if(!i||Ot.has(i.state))return this._message("mdi:gauge",Se(a,"empty.readiness_trend.title"));const r=Number(i.state),n=function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,r);return I`
      <ha-card class="static">
        <div class="header">
    ...
    `}};function Gt(e){const t=Math.round(60*e);if(0===t)return"±0:00";const a=t>0?"+":"-",i=Math.abs(t);return`${a}${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`}Wt.styles=[Ee,Ne,n`
      .cal-grid {
        display: grid;
    ...
    `],e([ge()],Wt.prototype,"_config",void 0),Wt=e([ue("suunto-activity-calendar-card")],Wt);let Kt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-workout-comparison-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[],n=s?function(e){const t=e[0];if(!t?.activity)return;const a=e.slice(1).find(e=>e.activity===t.activity);return a?{current:t,previous:a}:void 0}(r):void 0;if(!n)return this._message("mdi:compare",Se(a,"empty.workout_comparison.title"),Se(a,"empty.workout_comparison.subtitle"));const{current:o,previous:l}=n,c=null!==o.distance_km&&null!==l.distance_km?o.distance_km-l.distance_km:void 0,d=null!==o.duration_min&&null!==l.duration_min?o.duration_min-l.duration_min:void 0,u=null!==o.avg_hr&&null!==l.avg_hr?o.avg_hr-l.avg_hr:void 0,m=o.distance_km&&o.duration_min?o.duration_min/o.distance_km:void 0,p=l.distance_km&&l.duration_min?l.duration_min/l.distance_km:void 0,h=void 0!==m&&void 0!==p?m-p:void 0;return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${null!==o.distance_km?this._stat(o.distance_km.toFixed(1),"km",void 0!==c?Se(a,"stat.distance_delta",{delta:Xe(c,1)}):Se(a,"stat.distance")):K}
          ...
          ${void 0!==m?this._stat(`${Math.floor(m)}:${String(Math.round(m%1*60)).padStart(2,"0")}`,"/km",void 0!==h?Se(a,"stat.pace_delta",{delta:Gt(h)}):Se(a,"stat.avg_pace")):K}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
    ...
    `],e([ge()],Kt.prototype,"_config",void 0),Kt=e([ue("suunto-workout-comparison-card")],Kt);const Ut=new Set(["unknown","unavailable",""]);let Zt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-milestones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance");if(!s||Ut.has(s.state))return this._message("mdi:earth",Se(a,"empty.milestones.title"));const r=i("lifetime_energy"),n=Number(s.state),o=n/40075,l=n/42.195,c=n/384400*100,d=r&&!Ut.has(r.state)?Number(r.state)/550:void 0;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],Zt.prototype,"_config",void 0),Zt=e([ue("suunto-milestones-card")],Zt);const Xt=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];let Yt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-athlete-profile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.lifetime_by_activity,s=i?a.states[i]:void 0,r=s?.attributes.activities??[],n=t.workouts_recent,o=n?a.states[n]:void 0,l=o?.attributes.workouts??[];if(0===r.length||0===l.length)return this._message("mdi:account-star",Se(a,"empty.athlete_profile.title"));const c=[...r].sort((e,t)=>t.workouts-e.workouts)[0].activity,d=function(e){for(const[t,a]of Xt)if(t.test(e))return a;return"personality.activity.other"}(c),u=function(e){const t=e.filter(e=>Boolean(e.start)),a=t.filter(e=>{const t=new Date(e.start).getDay();return 0===t||6===t}).length,i=a/t.length;return i>=.6?"personality.schedule.weekend":i<=.25?"personality.schedule.weekday":"personality.schedule.balanced"}(l),m=function(e){const t={morning:0,afternoon:0,evening:0,night:0};for(const a of e){if(!a.start)continue;const e=new Date(a.start).getHours();e>=5&&e<12?t.morning++:e>=12&&e<18?t.afternoon++:e>=18&&e<23?t.evening++:t.night++}const a=Object.entries(t).sort((e,t)=>t[1]-e[1])[0][0];return{morning:{key:"personality.time.morning",icon:"mdi:weather-sunset-up"},afternoon:{key:"personality.time.afternoon",icon:"mdi:weather-sunny"},evening:{key:"personality.time.evening",icon:"mdi:weather-sunset"},night:{key:"personality.time.night",icon:"mdi:weather-night"}}[a]}(l);return I`
      <ha-card class="static">
        ...
        <div class="traits">
          <span class="chip accent"><ha-icon .icon=${Oe(c)}></ha-icon>${Se(a,d)}</span>
    ...
    `],e([ge()],Qt.prototype,"_config",void 0),Qt=e([ue("suunto-lap-splits-card")],Qt);const ea=new Set(["unknown","unavailable",""]);let ta=class extends Ce{constructor(){super(...arguments),this._pteHistory=[],this._epocHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-effect-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Ie(this.hass,"suunto_app:pte",720,"mean"),Ie(this.hass,"suunto_app:epoc",720,"mean")]);this._pteHistory=e,this._epocHistory=t}catch{this._pteHistory=[],this._epocHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_pte");if(!s||ea.has(s.state))return this._message("mdi:lightning-bolt",Se(a,"empty.training_effect_trend.title"));const r=i("last_epoc"),n=[];return this._pteHistory.length&&n.push({points:this._pteHistory,colorVar:"var(--sc-pulse)"}),this._epocHistory.length&&n.push({points:this._epocHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],ta.prototype,"_config",void 0),e([ge()],ta.prototype,"_pteHistory",void 0),e([ge()],ta.prototype,"_epocHistory",void 0),ta=e([ue("suunto-training-effect-trend-card")],ta);const aa=new Set(["unknown","unavailable",""]);let ia=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-status-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("readiness"),r=i("training_suggestion"),n=i("unusual_recovery"),o=s&&!aa.has(s.state)?Number(s.state):void 0,l=r&&!aa.has(r.state)?r.state:void 0;if(void 0===o&&void 0===l)return this._message("mdi:compass-outline",Se(a,"empty.training_status.title"),Se(a,"empty.training_status.subtitle"));const c=void 0!==o?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,o):void 0,d=void 0!==l?function(e,t){switch(t){case"hard":return{colorVar:"var(--sc-good)",label:Se(e,"band.suggestion.hard"),icon:"mdi:fire"};case"moderate":return{colorVar:"var(--sc-pulse)",label:Se(e,"band.suggestion.moderate"),icon:"mdi:walk"};case"easy":return{colorVar:"var(--sc-warn)",label:Se(e,"band.suggestion.easy"),icon:"mdi:leaf"};default:return{colorVar:"var(--sc-bad)",label:Se(e,"band.suggestion.rest"),icon:"mdi:bed-clock"}}}(a,l):void 0,u="on"===n?.state;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],ia.prototype,"_config",void 0),ia=e([ue("suunto-training-status-card")],ia);const sa=new Set(["unknown","unavailable",""]);function ra(e){return Math.max(0,Math.min(100,e))}function na(e,t,a,i){const s=(i-90)*Math.PI/180;return[e+a*Math.cos(s),t+a*Math.sin(s)]}let oa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-profile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("lifetime_distance"),n=i("lifetime_days"),o=i("acwr"),l=i("workouts_7d"),c=i("readiness"),d=i("workouts_recent"),u=d?.attributes.workouts??[],m=[s,o,l,c].some(e=>e&&!sa.has(e.state));if(!m&&0===u.length)return this._message("mdi:radar",Se(a,"empty.training_profile.title"),Se(a,"empty.training_profile.subtitle"));const p=e=>e&&!sa.has(e.state)?Number(e.state):0,h=p(r),g=p(n),v=g>0?h/g*7:0,y=v>0?ra(p(s)/(1.4*v)*100):0,_=ra(p(o)/1.5*100),b=ra(p(l)/7*100),f=ra(p(c)),w=new Set(u.map(e=>e.activity).filter(Boolean)).size,k=ra(w/5*100),x=[{label:Se(a,"stat.volume"),value:y},{label:Se(a,"stat.intensity"),value:_},{label:Se(a,"stat.consistency"),value:b},{label:Se(a,"stat.recovery"),value:f},{label:Se(a,"stat.variety"),value:k}],$=[...x].sort((e,t)=>t.value-e.value)[0],z=[...x].sort((e,t)=>e.value-t.value)[0],S=130,A=128,T=360/x.length,C=[.25,.5,.75,1].map(e=>{const t=x.map((t,a)=>na(S,A,84*e,T*a).join(",")).join(" ");return W`<polygon class="radar-grid" points=${t}></polygon>`}),E=x.map((e,t)=>{const[a,i]=na(S,A,84,T*t);return W`<line class="radar-axis" x1=${S} y1=${A} x2=${a} y2=${i}></line>`}),N=x.map((e,t)=>na(S,A,84*e.value/100,T*t)),j=W`<polygon class="radar-fill" points=${N.map(e=>e.join(",")).join(" ")}></polygon>`,R=N.map(([e,t])=>W`<circle class="radar-vertex" cx=${e} cy=${t} r="3.2"></circle>`),M=x.map((e,t)=>{const a=T*t,[i,s]=na(S,A,104.16,a);let r="middle";return a>10&&a<170&&(r="start"),a>190&&a<350&&(r="end"),W`
    ...
    `],e([ge()],oa.prototype,"_config",void 0),oa=e([ue("suunto-training-profile-card")],oa);const la=new Set(["unknown","unavailable",""]),ca=100,da=[[0,0],[26,0],[32,-3],[38,0],[44,0],[47,5],[50,-22],[53,8],[56,-2],[60,0],[66,0],[70,-5],[74,0],[100,0]],ua=300;let ma=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-heart-rate-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.current_hr?a.states[t.current_hr]:void 0;if(!i||la.has(i.state))return this._message("mdi:heart-pulse",Se(a,"empty.heart_rate.title"));const s=Math.round(Number(i.state)),r=60/s,n=[];for(let e=0;e<=ua;e+=10)n.push(W`<line class="hr-grid-line ${e%50==0?"major":""}" x1=${e} y1="0" x2=${e} y2=${64}></line>`);for(let e=0;e<=64;e+=10)n.push(W`<line class="hr-grid-line ${e%50==0?"major":""}" x1="0" y1=${e} x2=${ua} y2=${e}></line>`);return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="hr-strip-wrap">
          <svg class="hr-strip" viewBox="0 0 ${ua} ${64}" preserveAspectRatio="none">
            ...
            <path
              ...
              d=${function(){const e=[];for(let t=Math.floor(-1)*ca;t<=400;t+=ca)for(const[a,i]of da)e.push(`${t+a},${32+i}`);return"M"+e.join(" L")}()}
    ...
    `],e([ge()],ma.prototype,"_config",void 0),ma=e([ue("suunto-heart-rate-card")],ma);const pa=new Set(["unknown","unavailable",""]),ha=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];function ga(e){if(e)for(const[t,a]of ha)if(t.test(e))return a;return"personality.activity.other"}function va(e){return Math.max(0,Math.min(99,Math.round(e)))}let ya=class extends Ce{constructor(){super(...arguments),this._showHelp=!1}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-player-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl"),r=i("readiness"),n=i("workouts_30d"),o=i("form_tsb"),l=i("estimated_vo2max")??i("vo2max"),c=i("workouts_recent"),d=i("lifetime_by_activity"),u=[s,r,n].some(e=>e&&!pa.has(e.state));if(!u)return this._message("mdi:cards",Se(a,"empty.player.title"),Se(a,"empty.player.subtitle"));const m=e=>e&&!pa.has(e.state)?Number(e.state):0,p=c?.attributes.workouts??[],h=p.map(e=>e.tss).filter(e=>"number"==typeof e),g=h.length?h.reduce((e,t)=>e+t,0)/h.length:0,v=[{code:"STA",value:va(m(s)/100*99),helpKey:"player.help.sta"},{code:"PWR",value:va(g/150*99),helpKey:"player.help.pwr"},{code:"REC",value:va(m(r)),helpKey:"player.help.rec"},{code:"CON",value:va(m(n)/20*99),helpKey:"player.help.con"},{code:"END",value:va((m(l)-20)/40*99),helpKey:"player.help.end"},{code:"FRM",value:va((m(o)+30)/50*99),helpKey:"player.help.frm"}],y=va(v.reduce((e,t)=>e+t.value,0)/v.length),_=function(e){return e>=85?{key:"player.tier.legendary",colorVar:"var(--player-legendary)"}:e>=70?{key:"player.tier.gold",colorVar:"var(--player-gold)"}:e>=50?{key:"player.tier.silver",colorVar:"var(--player-silver)"}:{key:"player.tier.bronze",colorVar:"var(--player-bronze)"}}(y),b=[...d?.attributes.activities??[]].sort((e,t)=>t.workouts-e.workouts)[0],f=b?.activity??p[0]?.activity;let w="";try{const e=ke(a,this._configuredDeviceId);w=a.devices?.[e]?.name_by_user||a.devices?.[e]?.name||""}catch{}return I`
      <ha-card class="static player-card" style="--tier-color:${_.colorVar}">
        <div class="pc-top">
          ...
          <div class="pc-top-right">
            ...
            <div class="pc-badge">
              <span class="dot"><ha-icon .icon=${Oe(f)}></ha-icon></span>
              ${f??""}
            </div>
          </div>
        </div>
        ...
        <div class="pc-avatar-wrap">
          <div class="pc-avatar"><ha-icon .icon=${Oe(f)}></ha-icon></div>
        </div>
    ...
    `],e([ge()],ya.prototype,"_config",void 0),e([ge()],ya.prototype,"_showHelp",void 0),ya=e([ue("suunto-player-card")],ya);const _a=new Set(["unknown","unavailable",""]);function ba(e,t){const a=a=>t[a]?e.states[t[a]]:void 0,i=a("lifetime_workouts"),s=a("lifetime_distance");if(!i&&!s)return null;const r=a("lifetime_time"),n=a("lifetime_days"),o=a("lifetime_energy"),l=a("lifetime_by_activity"),c=a("estimated_vo2max")??a("vo2max"),d=a("training_records"),u=(m=e.language,e=>Math.round(e).toLocaleString(m));var m;const p=function(e){return t=>`${Math.round(t).toLocaleString(e)} km`}(e.language),h=e=>e&&!_a.has(e.state)?Number(e.state):0,g=l?.attributes.activities??[],v=g.filter(e=>e.workouts>0).length,y=[...g].sort((e,t)=>t.workouts-e.workouts)[0],_=d&&!_a.has(d.state)?Number(d.state):0,b=h(i),f=h(s),w=h(r),k=h(n),x=h(o),$=h(c),z=[{headingKey:"achievements.category.workouts",badges:[{icon:"💯",nameKey:"achievements.badge.century_club",unlocked:b>=100,current:b,target:100,format:u},{icon:"🎖️",nameKey:"achievements.badge.workouts_250",unlocked:b>=250,current:b,target:250,format:u},{icon:"🏅",nameKey:"achievements.badge.workouts_500",unlocked:b>=500,current:b,target:500,format:u},{icon:"👑",nameKey:"achievements.badge.workouts_1000",unlocked:b>=1e3,current:b,target:1e3,format:u}]},{headingKey:"achievements.category.distance",badges:[{icon:"🚴",nameKey:"achievements.badge.distance_1000",unlocked:f>=1e3,current:f,target:1e3,format:p},{icon:"🗺️",nameKey:"achievements.badge.distance_5000",unlocked:f>=5e3,current:f,target:5e3,format:p},{icon:"🌍",nameKey:"achievements.badge.around_globe",unlocked:f>=40075,current:f,target:40075,format:p}]},{headingKey:"achievements.category.time",badges:[{icon:"⏱️",nameKey:"achievements.badge.hours_100",unlocked:w>=100,current:w,target:100,format:u},{icon:"⌛",nameKey:"achievements.badge.hours_500",unlocked:w>=500,current:w,target:500,format:u}]},{headingKey:"achievements.category.days",badges:[{icon:"📅",nameKey:"achievements.badge.days_100",unlocked:k>=100,current:k,target:100,format:u},{icon:"🗓️",nameKey:"achievements.badge.full_year",unlocked:k>=365,current:k,target:365,format:u}]},{headingKey:"achievements.category.energy",badges:[{icon:"🔥",nameKey:"achievements.badge.energy_100k",unlocked:x>=1e5,current:x,target:1e5,format:u},{icon:"☄️",nameKey:"achievements.badge.energy_1m",unlocked:x>=1e6,current:x,target:1e6,format:u}]},{headingKey:"achievements.category.variety",badges:[{icon:"🎽",nameKey:"achievements.badge.multi_sport",unlocked:v>=3,current:v,target:3,format:u},{icon:"🧭",nameKey:"achievements.badge.jack_of_all_trades",unlocked:v>=5,current:v,target:5,format:u},...y?[{icon:"⭐",nameKey:"achievements.badge.specialist",nameVars:{activity:y.activity},unlocked:y.workouts>=100,current:y.workouts,target:100,format:u}]:[]]},{headingKey:"achievements.category.fitness",badges:[{icon:"💪",nameKey:"achievements.badge.solid_engine",unlocked:$>=40,current:$,target:40,format:u},{icon:"⚡",nameKey:"achievements.badge.elite_engine",unlocked:$>=55,current:$,target:55,format:u},{icon:"🔥",nameKey:"achievements.badge.consistency_king",unlocked:_>=14,current:_,target:14,format:u},{icon:"🛡️",nameKey:"achievements.badge.iron_will",unlocked:_>=30,current:_,target:30,format:u}]}],S=z.flatMap(e=>e.badges);return{groups:z,allBadges:S,unlockedCount:S.filter(e=>e.unlocked).length}}let fa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-achievements-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 6}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=ba(a,t);if(!i)return this._message("mdi:trophy-outline",Se(a,"empty.achievements.title"),Se(a,"empty.achievements.subtitle"));const{groups:s,allBadges:r,unlockedCount:n}=i,o=function(e,t){const a=t.training_records?e.states[t.training_records]:void 0,i=a&&!_a.has(a.state)?Number(a.state):0,s=a?.attributes??{};return[{icon:"🔥",labelKey:"records.streak",entry:i>0?{value:i}:void 0,render:t=>Ae(e,t.value,"records.streak_days_one","records.streak_days_other")},{icon:"⚡",labelKey:"records.pace",entry:s.fastest_pace_min_km,render:e=>`${Ue(e.value)} /km`},{icon:"🏔️",labelKey:"records.climb",entry:s.biggest_climb_m,render:e=>`${Math.round(e.value)} m`},{icon:"⏳",labelKey:"records.workout",entry:s.longest_workout_min,render:e=>{const t=Ke(e.value);return`${t.value} ${t.unit}`}},{icon:"📏",labelKey:"records.distance",entry:s.farthest_workout_km,render:e=>`${e.value} km`},{icon:"🥵",labelKey:"records.session",entry:s.hardest_workout_tss,render:e=>`${e.value} TSS`}]}(a,t);return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],ka.prototype,"_config",void 0),ka=e([ue("suunto-achievements-compact-card")],ka);const xa=new Set(["unknown","unavailable",""]);function $a(e){return 500*e*e}let za=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-level-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_energy"),r=i("lifetime_workouts");if(!s||xa.has(s.state))return this._message("mdi:trophy-award",Se(a,"empty.level.title"),Se(a,"empty.level.subtitle"));const n=r&&!xa.has(r.state)?Number(r.state):0,o=Math.round(Number(s.state)/10),l=function(e){return Math.floor(Math.sqrt(e/500))}(o),c=$a(l),d=$a(l+1),u=Math.max(0,Math.min(1,(o-c)/(d-c))),m=d-o,p=2*Math.PI*56;return I`
      <ha-card class="static level-card">
        <div class="lvl-ring-wrap">
          <svg width="128" height="128" viewBox="0 0 128 128">
            ${W`<circle cx="64" cy="64" r=${56} class="ring-track"></circle>`}
            ${W`<circle cx="64" cy="64" r=${56} class="ring-fill" stroke-dasharray=${p} stroke-dashoffset=${p*(1-u)}></circle>`}
          </svg>
    ...
    `],e([ge()],za.prototype,"_config",void 0),za=e([ue("suunto-level-card")],za);const Sa=[[/cycl|bik/i,"cycling"],[/run/i,"running"],[/trek|hik/i,"trekking"],[/walk/i,"walking"],[/gym|strength|weight/i,"gym"],[/swim/i,"swim"],[/ski/i,"ski"],[/row/i,"row"]];const Aa={cycling:"var(--sc-pulse)",running:"var(--sc-bad)",trekking:"var(--sc-good)",walking:"var(--sc-zone-1)",gym:"var(--sc-zone-4)",swim:"var(--sc-sleep-light)",ski:"var(--sc-sleep-deep)",row:"var(--sc-sleep-rem)",other:"var(--sc-amber)"},Ta=["var(--sc-pulse)","var(--sc-amber)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let Ca=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-class-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="lifetime_by_activity"]?a.states[t[s]]:void 0;var s;const r=i?.attributes.activities??[],n=r.reduce((e,t)=>e+t.workouts,0);if(!i||0===n)return this._message("mdi:sword-cross",Se(a,"empty.class.title"),Se(a,"empty.class.subtitle"));const o=[...r].sort((e,t)=>t.workouts-e.workouts).filter(e=>e.workouts>0),l=o[0],c=function(e){if(e)for(const[t,a]of Sa)if(t.test(e))return a;return"other"}(l?.activity),d=Aa[c],u=o.slice(0,5),m=o.slice(5).reduce((e,t)=>e+t.workouts,0);return I`
      <ha-card class="static" style="--class-accent:${d}">
        <div class="class-emblem"><ha-icon .icon=${Oe(l?.activity)}></ha-icon></div>
        ...
        <div class="class-build">
          ${u.map((e,t)=>{const a=Math.round(e.workouts/n*100);return I`
              <div class="cb-row">
                ...
                <div class="ct"><div class="cf" style="width:${a}%;background:${0===t?d:Ta[t%Ta.length]}"></div></div>
    ...
    `],e([ge()],Ca.prototype,"_config",void 0),Ca=e([ue("suunto-class-card")],Ca);const Ea=new Set(["unknown","unavailable",""]);let Na=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-next-milestone-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance");if(!s||Ea.has(s.state))return this._message("mdi:flag-checkered",Se(a,"empty.next_milestone.title"));const r=Number(s.state),n=function(e){const t=e<1e4?1e3:5e3;return(Math.floor(e/t)+1)*t}(r),o=n-r,l=r/n*100,c=i("lifetime_workouts"),d=c&&!Ea.has(c.state)?Number(c.state):void 0,u=void 0!==d?function(e){const t=e<500?50:100;return(Math.floor(e/t)+1)*t}(d):void 0,m=void 0!==d&&void 0!==u?u-d:void 0,p=i("weekly_distance"),h=p&&!Ea.has(p.state)?Number(p.state):void 0,g=h&&h>0?Math.max(1,Math.ceil(o/h)):void 0;return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:flag-checkered"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ge()],Ra.prototype,"_config",void 0),Ra=e([ue("suunto-story-card")],Ra);const Ma=new Set(["unknown","unavailable",""]),Da=208,Va=104,Fa=78;function Pa(e,t){const a=e*Math.PI/180;return[Va+t*Math.sin(a),Va-t*Math.cos(a)]}let Ha=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-clock-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("wake_time"),r=i("sleep_duration");if(!s||Ma.has(s.state)||!r||Ma.has(r.state))return this._message("mdi:sleep",Se(a,"empty.sleep_clock.title"),Se(a,"empty.sleep_clock.subtitle"));const n=new Date(s.state),o=Number(r.state);if(Number.isNaN(n.getTime())||!Number.isFinite(o)||o<=0)return this._message("mdi:sleep",Se(a,"empty.sleep_clock.title"),Se(a,"empty.sleep_clock.subtitle"));const l=new Date(n.getTime()-36e5*o),c=i("sleep_deep"),d=i("sleep_light"),u=i("sleep_rem"),m=c&&!Ma.has(c.state)?Number(c.state):0,p=d&&!Ma.has(d.state)?Number(d.state):0,h=u&&!Ma.has(u.state)?Number(u.state):0,g=m+p+h>0?[{colorVar:"var(--sc-sleep-deep)",minutes:m},{colorVar:"var(--sc-sleep-light)",minutes:p},{colorVar:"var(--sc-sleep-rem)",minutes:h}].filter(e=>e.minutes>0):[{colorVar:"var(--sc-sleep-light)",minutes:60*o}],v=(60*l.getHours()+l.getMinutes())/1440*360,y=60*o/1440*360,_=g.reduce((e,t)=>e+t.minutes,0);let b=v;const f=g.map(e=>{const t=e.minutes/_*y,a=function(e,t){const[a,i]=Pa(e,Fa),[s,r]=Pa(t,Fa),n=t-e>180?1:0;return`M ${a.toFixed(2)} ${i.toFixed(2)} A 78 78 0 ${n} 1 ${s.toFixed(2)} ${r.toFixed(2)}`}(b,b+t);return b+=t,{d:a,colorVar:e.colorVar}}),w=i("sleep_quality"),k=w&&!Ma.has(w.state)?Math.round(Number(w.state)):void 0,x=Ke(60*o),$=Pa(v,96),z=Pa(v+y,96);return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:sleep"></ha-icon></div>
          <div class="title-block">
        ...
        <div class="clock-wrap">
          <svg viewBox="0 0 ${Da} ${Da}">
            <circle cx=${Va} cy=${Va} r=${Fa} fill="none" stroke="var(--divider-color)" stroke-width=${15} />
            ${f.map(e=>W`<path d=${e.d} fill="none" stroke=${e.colorVar} stroke-width=${15} />`)}
            ${[0,90,180,270].map(e=>{const[t,a]=Pa(e,80),[i,s]=Pa(e,86);return W`<line x1=${t.toFixed(1)} y1=${a.toFixed(1)} x2=${i.toFixed(1)} y2=${s.toFixed(1)} stroke="var(--secondary-text-color)" stroke-width="1.5" />`})}
            ${[{angle:0,label:"0"},{angle:90,label:"6"},{angle:180,label:"12"},{angle:270,label:"18"}].map(({angle:e,label:t})=>{const[a,i]=Pa(e,100);return W`<text x=${a.toFixed(1)} y=${i.toFixed(1)} text-anchor="middle" dominant-baseline="middle" font-size="10" fill="var(--secondary-text-color)">${t}</text>`})}
          </svg>
        ...
        <div class="legend">
          ${m>0?I`<span class="legend-item"><i class="dot" style="background:var(--sc-sleep-deep)"></i>${Se(a,"label.deep")} &middot; ${Ke(m).value}${Ke(m).unit}</span>`:K}
          ${p>0?I`<span class="legend-item"><i class="dot" style="background:var(--sc-sleep-light)"></i>${Se(a,"label.light")} &middot; ${Ke(p).value}${Ke(p).unit}</span>`:K}
          ${h>0?I`<span class="legend-item"><i class="dot" style="background:var(--sc-sleep-rem)"></i>${Se(a,"label.rem")} &middot; ${Ke(h).value}${Ke(h).unit}</span>`:K}
        </div>
      </ha-card>
    `}};Ha.styles=[Ee,Ne,n`
      .clock-wrap {
    ...
    `],e([ge()],Ha.prototype,"_config",void 0),Ha=e([ue("suunto-sleep-clock-card")],Ha);const La=new Set(["unknown","unavailable",""]),qa=960;function Oa(e){return`${e.getFullYear()}-${e.getMonth()}-${e.getDate()}`}function Ba(e){const t=new Map;for(const a of e){if(La.has(a.state))continue;const e=Oa(new Date(a.lastChanged)),i=t.get(e);(!i||a.lastChanged>i.lastChanged)&&t.set(e,a)}return t}function Ia(e){const t=60*(e.getHours()-20)+e.getMinutes();return t<0?t+1440:t}let Wa=class extends Ce{constructor(){super(...arguments),this._nights=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-rhythm-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.wake_time,i=t.sleep_duration;if(!a||!i)return;const s=`${a},${i}`,r=Date.now();if(!(s===this._historyKey&&r-this._historyFetchedAt<18e5)){this._historyKey=s,this._historyFetchedAt=r;try{const e=this.hass,t=await async function(e,t,a){if(0===t.length)return{};const i=new Date,s=new Date(i.getTime()-864e5*a),r=await e.callApi("GET",`history/period/${s.toISOString()}?filter_entity_id=${t.join(",")}&end_time=${i.toISOString()}`),n={};return t.forEach((e,t)=>{n[e]=(r[t]??[]).map(e=>({state:e.state,lastChanged:new Date(e.last_updated??e.last_changed).getTime()}))}),n}(e,[a,i],9);this._nights=this._buildNights(t[a]??[],t[i]??[])}catch{this._nights=[]}}}_buildNights(e,t){const a=Ba(e),i=Ba(t),s=[];for(const[e,t]of a){const a=i.get(e);if(!a)continue;const r=new Date(t.state),n=Number(a.state);Number.isNaN(r.getTime())||!Number.isFinite(n)||n<=0||s.push({wake:r,bedtime:new Date(r.getTime()-36e5*n)})}return s.sort((e,t)=>e.bedtime.getTime()-t.bedtime.getTime()),s.slice(-7)}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const t=this.hass;if(this._nights.length<2)return this._message("mdi:chart-timeline-variant",Se(t,"empty.sleep_rhythm.title"),Se(t,"empty.sleep_rhythm.subtitle"));const a=this._nights.map(e=>Ia(e.bedtime)),i=a.reduce((e,t)=>e+t,0)/a.length,s=a.reduce((e,t)=>e+(t-i)**2,0)/a.length,r=Math.round(Math.sqrt(s)),n=this._nights.reduce((e,t)=>e+(60*t.wake.getHours()+t.wake.getMinutes()),0)/this._nights.length,o=(1200+i)%1440,l=e=>{const t=new Date;return t.setHours(0,0,0,0),t.setMinutes(Math.round(e)),t};return I`
      <ha-card class="static">
        ...
        <div class="rhythm-chart">
          ${this._nights.map(e=>{const a=Ia(e.bedtime),s=Ia(e.wake)-a,r=a/qa*100,n=(s<0?s+1440:s)/qa*100,o=Math.abs(a-i)>30;return I`
              <div class="rhythm-row">
                <div class="rhythm-day">${(e=>new Intl.DateTimeFormat(t.language,{weekday:"short"}).format(e))(e.bedtime)}</div>
                <div class="rhythm-track">
                  <div class="rhythm-avgline" style="left:${i/qa*100}%"></div>
                  <div class="rhythm-bar ${o?"late":""}" style="left:${r}%;width:${n}%"></div>
                </div>
              </div>
            `})}
          <div class="rhythm-axis">
            ${Array.from({length:9},(e,t)=>2*t).map(e=>I`<span style="left:${60*e/qa*100}%">${(20+e)%24}</span>`)}
          </div>
        </div>

        <div class="rhythm-stats">
          <span class="chip">${Se(t,"sleep_rhythm.avg_bedtime",{time:Ze(l(o),t.language)})}</span>
          <span class="chip">${Se(t,"sleep_rhythm.avg_wake",{time:Ze(l(n),t.language)})}</span>
