...
`;function je(e){return I`
  ...
  `}function Re(e,t,a=300,i=56){if(e.length<2)return G;const s=e.map(e=>e.v),r=Math.min(...s),n=Math.max(...s)-r||1,o=.12*i,l=i-2*o,c=a/(e.length-1),d=e.map((e,t)=>[t*c,o+l-(e.v-r)/n*l]),u=d.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),p=`${u} L${a},${i} L0,${i} Z`,[m,h]=d[d.length-1];return I`
  ...
  `}function De(e){const t=e.map(e=>e.v),a=Math.min(...t);return{min:a,span:Math.max(...t)-a||1}}function Pe(e,t=300,a=70,i=!0){const s=e.filter(e=>e.points.length>=2);if(0===s.length)return G;const r=.1*a,n=a-2*r,o=i?De(s.flatMap(e=>e.points)):void 0,l=s.map(e=>{const{min:a,span:i}=o??De(e.points),s=t/(e.points.length-1),l=e.points.map((e,t)=>[t*s,r+n-(e.v-a)/i*n]),c=l.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),[d,u]=l[l.length-1];return K`
      <path
        d=${c}
        fill="none"
        stroke=${e.colorVar}
  ...
  `}function Fe(e,t=300,a=160){if(e.length<2)return G;const i=e.reduce((e,t)=>e+t.lat,0)/e.length*(Math.PI/180),s=Math.cos(i)||1,r=e.map(e=>e.lon*s),n=e.map(e=>-e.lat),o=Math.min(...r),l=Math.min(...n),c=Math.max(...r)-o||1e-6,d=Math.max(...n)-l||1e-6,u=t-28,p=a-28,m=Math.min(u/c,p/d),h=14+(u-c*m)/2,g=14+(p-d*m)/2,v=e=>[h+(e.lon*s-o)*m,g+(-e.lat-l)*m],y=e.map(e=>e.speedKmh),_=Math.min(...y),b=Math.max(...y),f=e.slice(1).map((t,a)=>{const[i,s]=v(e[a]),[r,n]=v(t),o=function(e,t,a){const i=a-t;if(i<.5)return"var(--sc-amber)";const s=(e-t)/i;return`var(--sc-sev-${Math.min(5,Math.max(1,Math.ceil(5*s)||1))})`}(t.speedKmh,_,b);return K`<line x1=${i.toFixed(1)} y1=${s.toFixed(1)} x2=${r.toFixed(1)} y2=${n.toFixed(1)} stroke=${o} stroke-width="4" stroke-linecap="round"></line>`}),[w,k]=v(e[0]),[x,$]=v(e[e.length-1]);return I`
  ...
  `}function Ve(e,t,a=300,i=70){if(0===e.length)return G;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return K`
  ...
  `}const He=new Set(["unknown","unavailable",""]);let Le=class extends Ce{static getConfigElement(){return document.createElement("suunto-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-goal-card",goal_km:50}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||He.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_goal.title"));const r=this._config.goal_km??50,n=Number(i.state),o=r>0?n/r*100:0,l=o>=100?"var(--sc-good)":"var(--sc-amber)";return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],Le.prototype,"_config",void 0),Le=e([ue("suunto-weekly-goal-card")],Le);let qe=class extends ce{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return G;const e=we(this.hass);return I`
      ${e.length>1?I`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
  ...
  `,e([he({attribute:!1})],qe.prototype,"hass",void 0),e([ge()],qe.prototype,"_config",void 0),qe=e([ue("suunto-goal-editor")],qe);const Ze=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Je(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of Ze)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const Ye=new Set(["unknown","unavailable",""]),Xe=1e4;let Qe=class extends Ce{constructor(){super(...arguments),this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-steps-goal-editor")}static getStubConfig(){return{type:"custom:suunto-steps-today-card",goal_steps:Xe}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{const e=Be(await Oe(this.hass,"suunto_app:steps",192,"sum")),t=(new Date).toDateString(),a=e.filter(e=>new Date(e.t).toDateString()!==t),i=a.slice(-7);this._weekAverage=i.length?i.reduce((e,t)=>e+t.v,0)/i.length:void 0}catch{this._weekAverage=void 0}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="daily_steps"]?a.states[t[s]]:void 0;var s;if(!i||Ye.has(i.state))return this._message("mdi:shoe-print",Se(a,"empty.steps_today.title"));const r=this._config.goal_steps??Xe,n=Number(i.state),o=r>0?n/r*100:0,l=o>=100?"var(--sc-good)":"var(--sc-amber)",c=this._weekAverage&&this._weekAverage>0?(n-this._weekAverage)/this._weekAverage*100:void 0;return I`
    ...
    `],e([ge()],Qe.prototype,"_config",void 0),e([ge()],Qe.prototype,"_weekAverage",void 0),Qe=e([ue("suunto-steps-today-card")],Qe);let et=class extends ce{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return G;const e=we(this.hass);return I`
      ${e.length>1?I`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
  ...
  `,e([he({attribute:!1})],et.prototype,"hass",void 0),e([ge()],et.prototype,"_config",void 0),et=e([ue("suunto-steps-goal-editor")],et);const tt=new Set(["unknown","unavailable",""]),at=7e4;let it=class extends Ce{constructor(){super(...arguments),this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-weekly-steps-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-steps-goal-card",goal_steps:at}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{const e=Be(await Oe(this.hass,"suunto_app:steps",192,"sum")),t=(new Date).toDateString(),a=e.filter(e=>new Date(e.t).toDateString()!==t).slice(-6);this._priorDaysTotal=a.reduce((e,t)=>e+t.v,0)}catch{this._priorDaysTotal=void 0}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="daily_steps"]?a.states[t[s]]:void 0;var s;if(!i||tt.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_steps_goal.title"));const r=this._config.goal_steps??at,n=(this._priorDaysTotal??0)+Number(i.state),o=r>0?n/r*100:0,l=o>=100?"var(--sc-good)":"var(--sc-amber)";return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:target"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ge()],it.prototype,"_config",void 0),e([ge()],it.prototype,"_priorDaysTotal",void 0),it=e([ue("suunto-weekly-steps-goal-card")],it);let st=class extends ce{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return G;const e=we(this.hass);return I`
      ${e.length>1?I`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
      ...
      <label class="goal-field">
        ...
        <input
          ...
          min="1"
          step="1000"
          .value=${String(this._config.goal_steps??at)}
          @change=${this._goalChanged}
        />
      </label>
    `}_deviceChanged(e){if(!this._config)return;const t=e.detail.value;this._emit({...this._config,device_id:t||void 0})}_goalChanged(e){if(!this._config)return;const t=Number(e.target.value),a=Number.isFinite(t)&&t>0?t:void 0;this._emit({...this._config,goal_steps:a})}_emit(e){this._config=e,_e(this,"config-changed",{config:e})}};st.styles=n`
    .hint {
      font-size: 0.85rem;
      color: var(--secondary-text-color);
      padding: 8px 2px 2px;
  ...
  `,e([he({attribute:!1})],st.prototype,"hass",void 0),e([ge()],st.prototype,"_config",void 0),st=e([ue("suunto-weekly-steps-goal-editor")],st);const rt=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function nt(e){if(e)for(const[t,a]of rt)if(t.test(e))return a;return"mdi:run-fast"}const ot={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};const lt=new Set(["unknown","unavailable",""]);let ct=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||lt.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),l=i("last_avg_hr"),c=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),p=i("last_pte"),m=i("last_epoc"),h=i("last_feeling"),g=i("last_tss"),v=i("last_cal_per_km"),y=i("last_cadence"),_=i("last_pct_hrmax"),b=i("last_stride"),f=i("last_workout_weather"),w=i("last_workout_tags"),k=i("last_workout_achievements"),x=o?Ke(Number(o.state)):void 0,$=void 0===d&&void 0!==u,z=h&&!lt.has(h.state)?Number(h.state):void 0,S=p&&!lt.has(p.state)?Number(p.state):void 0,A=k?Number(k.state):0;return I`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${r?I`${Je(new Date(r.state),a.language)} ·
                  ${Ge(new Date(r.state),a.language)}`:""}
            </div>
          </div>
        ...
        ${f&&!lt.has(f.state)?I`
              <div class="weather">
                <ha-icon .icon=${function(e){const t=e?.slice(0,2);return t&&ot[t]||"mdi:weather-cloudy"}(f.attributes.icon_code)}></ha-icon>
                <strong>${f.state}°C</strong>
                ${f.attributes.condition?I`<span class="sep">·</span><span class="cond">${f.attributes.condition}</span>`:G}
    ...
    `],e([ge()],ct.prototype,"_config",void 0),ct=e([ue("suunto-last-workout-card")],ct);const dt=e=>`var(--sc-zone-${e})`;let ut=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-zones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=[];for(let e=0;e<=5;e++){const s=t[`last_zone${e}`],r=s?a.states[s]:void 0;r&&!Number.isNaN(Number(r.state))&&i.push({n:e,minutes:Number(r.state),lower:r.attributes.lower_limit_bpm,upper:r.attributes.upper_limit_bpm})}const s=i.reduce((e,t)=>e+t.minutes,0);if(0===i.length||s<=0)return this._message("mdi:heart-pulse",Se(a,"empty.hr_zones.title"),Se(a,"empty.hr_zones.subtitle"));const r=t.last_workout_start,n=r?a.states[r]:void 0,o=Se(a,"card.hr_zones.last_workout");return I`
      <ha-card class="static">
        ...
        ${je(i.map(e=>({flexGrow:e.minutes,colorVar:dt(e.n),title:Se(a,"label.zone",{n:e.n})})))}

        <div class="rows">
          ${i.map(e=>{const t=Ke(e.minutes),i=Math.round(e.minutes/s*100);return I`
              <div class="row">
                <i class="dot" style="background:${dt(e.n)}"></i>
    ...
    `],e([ge()],ut.prototype,"_config",void 0),ut=e([ue("suunto-hr-zones-card")],ut);const pt=new Set(["unknown","unavailable",""]);let mt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||pt.has(s.state))return this._message("mdi:sleep",Se(a,"empty.sleep_readiness.title"),Se(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),l=i("sleep_rem"),c=i("sleep_quality"),d=i("sleep_spo2"),u=i("sleep_hrv"),p=i("hrv_baseline"),m=i("hrv_status"),h=i("resting_hr"),g=i("resting_hr_baseline"),v=i("readiness"),y=i("nap_duration"),_=i("sleep_avg_hr"),b=i("sleep_min_hr"),f=i("sleep_time"),w=i("unusual_recovery"),k=v&&!pt.has(v.state)?Number(v.state):void 0,x=void 0!==k?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,k):void 0,$=u&&p&&!pt.has(p.state)?Number(u.state)-Number(p.state):void 0,z=h&&g&&!pt.has(g.state)?Number(h.state)-Number(g.state):void 0,S=[n&&!pt.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:Se(a,"label.deep")}:void 0,o&&!pt.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:Se(a,"label.light")}:void 0,l&&!pt.has(l.state)?{flexGrow:Number(l.state),colorVar:"var(--sc-sleep-rem)",title:Se(a,"label.rem")}:void 0].filter(e=>void 0!==e),A=Ke(60*Number(s.state)),T=y&&!pt.has(y.state)?Number(y.state):void 0,C=!!y?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(y.attributes.date)),E={duration:`${A.value} ${A.unit}`};return I`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${r?Se(a,"card.sleep_readiness.subtitle_with_wake",{...E,time:Ge(new Date(r.state),a.language)}):Se(a,"card.sleep_readiness.subtitle_no_wake",E)}
            </div>
          </div>
        </div>
        ...
        <div class="stats">
          ${c?this._stat(String(Math.round(Number(c.state))),"%",Se(a,"stat.quality")):G}
          ${u?this._stat(String(Math.round(Number(u.state))),"ms",void 0!==$?Se(a,"stat.hrv_delta",{delta:Ue($)}):Se(a,"stat.hrv"),void 0!==$?$>=0?"good":"bad":void 0):G}
          ${h?this._stat(String(Math.round(Number(h.state))),"bpm",void 0!==z?Se(a,"stat.resting_hr_delta",{delta:Ue(z)}):Se(a,"stat.resting_hr"),void 0!==z?z<=0?"good":"bad":void 0):G}
          ${d?this._stat(String(Math.round(Number(d.state))),"%",Se(a,"stat.spo2")):G}
          ${_?this._stat(String(Math.round(Number(_.state))),"bpm",Se(a,"stat.sleep_avg_hr")):G}
          ${b?this._stat(String(Math.round(Number(b.state))),"bpm",Se(a,"stat.sleep_min_hr")):G}
        </div>
        ...
        ${S.length?I`
              <div class="stages">
                ...
                <div class="stage-legend">
                  ${S.map(e=>{const t=Ke(e.flexGrow);return I`
        ...
        ${m&&!pt.has(m.state)||T||f&&!pt.has(f.state)||"on"===w?.state?I`
              <div class="footer">
                ${"on"===w?.state?I`<span class="chip bad"><ha-icon icon="mdi:shield-alert-outline"></ha-icon>${Se(a,"chip.unusual_recovery")}</span>`:G}
                ${m&&!pt.has(m.state)?(()=>{const e=function(e,t){return"low"===t?{colorVar:"var(--sc-warn)",label:Se(e,"band.hrv.low")}:"high"===t?{colorVar:"var(--sc-pulse)",label:Se(e,"band.hrv.high")}:{colorVar:"var(--sc-good)",label:Se(e,"band.hrv.balanced")}}(a,m.state);return I`<span class="chip" style="color:${e.colorVar}"
                ...
                ${f&&!pt.has(f.state)?I`<span class="chip">
                      <ha-icon icon="mdi:bed-clock"></ha-icon>${Se(a,"chip.bedtime",{time:Ge(new Date(f.state),a.language)})}
                    </span>`:G}
              </div>
            `:G}
      </ha-card>
    ...
    `],e([ge()],mt.prototype,"_config",void 0),mt=e([ue("suunto-sleep-readiness-card")],mt);const ht=new Set(["unknown","unavailable",""]);let gt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||ht.has(s.state))return this._message("mdi:battery-heart-variant",Se(a,"empty.recovery.title"));const r=i("is_recovering"),n=i("recovery_until"),o=i("recovery_time"),l=i("stress_state"),c=i("workout_today"),d=i("unusual_recovery"),u=Number(s.state),p=function(e,t){return t>=60?{colorVar:"var(--sc-good)",label:Se(e,"band.recovery.well")}:t>=30?{colorVar:"var(--sc-warn)",label:Se(e,"band.recovery.partial")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.recovery.low")}}(a,u),m="on"===r?.state;let h=Se(a,"band.recovery.fully");if(m&&n&&!ht.has(n.state)){const e=new Date(n.state).getTime()-Date.now();if(e>0){const t=Ke(e/6e4);h=Se(a,"band.recovery.recovering",{time:`${t.value} ${t.unit}`})}}return I`
      <ha-card class="static">
        <div class="header">
        ...
        ${l||o?I`
              <div class="stats">
                ${l&&!ht.has(l.state)?this._stat(l.state,"",Se(a,"stat.stress_level")):G}
                ${o&&!ht.has(o.state)?this._stat(Number(o.state).toFixed(1),"h",Se(a,"stat.recovery_window")):G}
              </div>
            `:G}
    ...
    `],e([ge()],gt.prototype,"_config",void 0),gt=e([ue("suunto-recovery-card")],gt);const vt=new Set(["unknown","unavailable",""]);let yt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-load-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.fitness_ctl;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{this._history=await Oe(this.hass,t,720,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||vt.has(s.state))return this._message("mdi:arm-flex",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=i("acwr"),l=n&&!vt.has(n.state)?Number(n.state):void 0,c=void 0!==l?function(e,t){return t>5?{colorVar:"var(--sc-good)",label:Se(e,"band.form.fresh")}:t<-20?{colorVar:"var(--sc-bad)",label:Se(e,"band.form.very_fatigued")}:t<-5?{colorVar:"var(--sc-warn)",label:Se(e,"band.form.fatigued")}:{colorVar:"var(--sc-pulse)",label:Se(e,"band.form.neutral")}}(a,l):void 0,d=o&&!vt.has(o.state)?Number(o.state):void 0,u=void 0!==d?function(e,t){return t>1.3?{colorVar:"var(--sc-bad)",label:Se(e,"band.acwr.high")}:t<.8?{colorVar:"var(--sc-warn)",label:Se(e,"band.acwr.low")}:{colorVar:"var(--sc-good)",label:Se(e,"band.acwr.safe")}}(a,d):void 0;return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ...
          ${void 0!==l?this._stat(Ue(l,1),Se(a,"stat.tsb"),c?.colorVar):G}
        </div>
    ...
    `],e([ge()],yt.prototype,"_config",void 0),e([ge()],yt.prototype,"_history",void 0),yt=e([ue("suunto-training-load-card")],yt);const _t=new Set(["unknown","unavailable",""]),bt=["var(--sc-amber)","var(--sc-pulse)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let ft=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-week-stats-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("weekly_time"),n=i("workouts_7d"),o=i("workouts_30d"),l=i("lifetime_by_activity");if(!s&&!l)return this._message("mdi:calendar-week",Se(a,"empty.week_stats.title"));const c=(l?.attributes.activities??[]).slice().sort((e,t)=>t.distance_km-e.distance_km),d=c.slice(0,5),u=c.length-d.length;return I`
      <ha-card class="static">
        <div class="header">
        ...
        ${s||r||n?I`
              <div class="stats">
                ${s&&!_t.has(s.state)?this._stat(Number(s.state).toFixed(1),"km",Se(a,"stat.distance")):G}
                ${r&&!_t.has(r.state)?this._stat(Number(r.state).toFixed(1),"h",Se(a,"stat.time")):G}
                ${n&&!_t.has(n.state)?this._stat(n.state,"",Se(a,"stat.workouts")):G}
              </div>
            `:G}
        ...
        ${d.length?I`
              ...
              <div class="lifetime">
                ...
                ${je(d.map((e,t)=>({flexGrow:e.distance_km,colorVar:bt[t%bt.length],title:e.activity})))}
                <div class="rows">
                  ${d.map((e,t)=>{const a=bt[t%bt.length];return I`
                      <div class="row">
                        <div
                          class="icon-badge tiny"
                          style="background:color-mix(in srgb, ${a} 18%, transparent);color:${a}"
                        >
                          <ha-icon .icon=${nt(e.activity)}></ha-icon>
                        </div>
            ...
            `:G}
        ${o&&!_t.has(o.state)?I`<div class="footer"><span class="chip">${Se(a,"chip.workouts_30d",{count:o.state})}</span></div>`:G}
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
        <div class="stat-value">${e}${t?I`<span class="unit">${t}</span>`:G}</div>
    ...
    `],e([ge()],ft.prototype,"_config",void 0),ft=e([ue("suunto-week-stats-card")],ft);const wt=new Set(["unknown","unavailable",""]);let kt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-today-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps"),r=i("daily_energy"),n=i("current_hr"),o=i("workout_today"),l=i("is_recovering"),c=i("training_suggestion"),d=i("days_since_last_workout");if(!s&&!r&&!n)return this._message("mdi:pulse",Se(a,"empty.today.title"));const u=n&&!wt.has(n.state)?Math.round(Number(n.state)):void 0,p=c&&!wt.has(c.state)?c.state:void 0,m=p?function(e,t){switch(t){case"hard":return{colorVar:"var(--sc-good)",label:Se(e,"band.suggestion.hard"),icon:"mdi:fire"};case"moderate":return{colorVar:"var(--sc-pulse)",label:Se(e,"band.suggestion.moderate"),icon:"mdi:walk"};case"easy":return{colorVar:"var(--sc-warn)",label:Se(e,"band.suggestion.easy"),icon:"mdi:leaf"};default:return{colorVar:"var(--sc-bad)",label:Se(e,"band.suggestion.rest"),icon:"mdi:bed-clock"}}}(a,p):void 0,h=d&&!wt.has(d.state)?Number(d.state):void 0;return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${s&&!wt.has(s.state)?this._stat(Number(s.state).toLocaleString(a.language),"",Se(a,"stat.steps")):G}
          ${r&&!wt.has(r.state)?this._stat(Math.round(Number(r.state)).toLocaleString(a.language),"kcal",Se(a,"stat.energy")):G}
          ${void 0!==u?I`
                <div class="stat hr">
    ...
    `],e([ge()],$t.prototype,"_config",void 0),$t=e([ue("suunto-lifetime-card")],$t);let zt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recent-workouts-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[];return s&&0!==r.length?I`
      <ha-card class="static">
        ...
        <div class="scroll-list">
          ${r.map(e=>{const t=null!==e.duration_min?Ke(e.duration_min):void 0;return I`
              <div class="workout-row">
                <div class="icon-badge tiny"><ha-icon .icon=${nt(e.activity)}></ha-icon></div>
    ...
    `:this._message("mdi:format-list-bulleted",Se(a,"empty.recent_workouts.title"))}};zt.styles=[Ee,Ne,n`
      .workout-row {
        display: grid;
    ...
    `],e([ge()],zt.prototype,"_config",void 0),zt=e([ue("suunto-recent-workouts-card")],zt);const St=new Set(["unknown","unavailable",""]);let At=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-elevation-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_ascent"),r=i("last_descent");if((!s||St.has(s.state))&&(!r||St.has(r.state)))return this._message("mdi:image-filter-hdr",Se(a,"empty.elevation.title"),Se(a,"empty.elevation.subtitle"));const n=i("last_ascent_time"),o=i("last_descent_time"),l=i("last_min_altitude"),c=i("last_max_altitude"),d=i("last_ascent_rate"),u=i("last_workout_start");return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${s&&!St.has(s.state)?this._stat(Math.round(Number(s.state)).toString(),"m",Se(a,"stat.ascent")):G}
          ${r&&!St.has(r.state)?this._stat(Math.round(Number(r.state)).toString(),"m",Se(a,"stat.descent")):G}
          ${n&&!St.has(n.state)?(()=>{const e=Ke(Number(n.state));return this._stat(e.value,e.unit,Se(a,"stat.ascent_time"))})():G}
          ${o&&!St.has(o.state)?(()=>{const e=Ke(Number(o.state));return this._stat(e.value,e.unit,Se(a,"stat.descent_time"))})():G}
          ${l&&!St.has(l.state)?this._stat(Math.round(Number(l.state)).toString(),"m",Se(a,"stat.min_altitude")):G}
          ${c&&!St.has(c.state)?this._stat(Math.round(Number(c.state)).toString(),"m",Se(a,"stat.max_altitude")):G}
        </div>
        ...
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ...
              ${c?Je(new Date(c.state),a.language):G}
            </div>
          </div>
        </div>
    ...
    `],e([ge()],Ct.prototype,"_config",void 0),e([ge()],Ct.prototype,"_mapEl",void 0),Ct=e([ue("suunto-location-card")],Ct);const Et=new Set(["unknown","unavailable",""]);let Nt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-fitness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("vo2max");if(!s||Et.has(s.state))return this._message("mdi:lungs",Se(a,"empty.fitness.title"),Se(a,"empty.fitness.subtitle"));const r=i("estimated_vo2max"),n=i("fitness_age"),o=s.attributes.measured_at,l=s.attributes.measured_from;return I`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${o?Se(a,"fitness.measured",{time:Je(new Date(o),a.language),activity:l??""}):G}
            </div>
          </div>
        </div>
        ...
        <div class="stats">
          ...
          ${r&&!Et.has(r.state)?this._stat(Number(r.state).toFixed(1),"ml/kg/min",Se(a,"stat.estimated_vo2max")):G}
          ${n&&!Et.has(n.state)?this._stat(String(Math.round(Number(n.state))),"",Se(a,"stat.fitness_age")):G}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
      ...
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        ...
        ${u.length?I`
              <div class="compact-stats">
                ${u.map((e,t)=>I`${t>0?I`<span class="sep">·</span>`:G}${e}`)}
              </div>
            `:G}
      </ha-card>
    `}_openMoreInfo(e){e&&_e(this,"hass-more-info",{entityId:e})}};Mt.styles=[Ee,Ne,n`
      ha-card {
        gap: 8px;
      }
      .activity {
    ...
    `],e([ge()],Mt.prototype,"_config",void 0),Mt=e([ue("suunto-last-workout-tile-card")],Mt);const Rt=new Set(["unknown","unavailable",""]);let Dt=class extends Ce{constructor(){super(...arguments),this._ctlHistory=[],this._atlHistory=[],this._tsbHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-pmc-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.fitness_ctl;if(!a)return;const i=t.fatigue_atl,s=t.form_tsb,r=[a,i,s].filter(e=>Boolean(e)).join(","),n=Date.now();if(!(r===this._historyKey&&n-this._historyFetchedAt<6e5)){this._historyKey=r,this._historyFetchedAt=n;try{const e=this.hass,[t,r,n]=await Promise.all([Oe(e,a,2160,"mean"),i?Oe(e,i,2160,"mean"):Promise.resolve([]),s?Oe(e,s,2160,"mean"):Promise.resolve([])]);this._ctlHistory=t,this._atlHistory=r,this._tsbHistory=n}catch{this._ctlHistory=[],this._atlHistory=[],this._tsbHistory=[]}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||Rt.has(s.state))return this._message("mdi:chart-timeline-variant",Se(a,"empty.training_load.title"),Se(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=[{points:this._ctlHistory,colorVar:"var(--sc-pulse)"}];return this._atlHistory.length&&o.push({points:this._atlHistory,colorVar:"var(--sc-bad)"}),this._tsbHistory.length&&o.push({points:this._tsbHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${this._stat(Number(s.state).toFixed(0),Se(a,"stat.ctl"))}
          ${r&&!Rt.has(r.state)?this._stat(Number(r.state).toFixed(0),Se(a,"stat.atl")):G}
          ${n&&!Rt.has(n.state)?this._stat(Ue(Number(n.state),1),Se(a,"stat.tsb")):G}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ge()],Dt.prototype,"_config",void 0),e([ge()],Dt.prototype,"_ctlHistory",void 0),e([ge()],Dt.prototype,"_atlHistory",void 0),e([ge()],Dt.prototype,"_tsbHistory",void 0),Dt=e([ue("suunto-pmc-card")],Dt);const Pt=new Set(["unknown","unavailable",""]);let Ft=class extends Ce{constructor(){super(...arguments),this._rhrHistory=[],this._hrvHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.resting_hr,i=t.sleep_hrv;if(!a&&!i)return;const s=[a,i].filter(e=>Boolean(e)).join(","),r=Date.now();if(!(s===this._historyKey&&r-this._historyFetchedAt<6e5)){this._historyKey=s,this._historyFetchedAt=r;try{const e=this.hass,[t,s]=await Promise.all([a?Oe(e,a,720,"mean"):Promise.resolve([]),i?Oe(e,i,720,"mean"):Promise.resolve([])]);this._rhrHistory=t,this._hrvHistory=s}catch{this._rhrHistory=[],this._hrvHistory=[]}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("resting_hr"),r=i("sleep_hrv"),n=s&&!Pt.has(s.state),o=r&&!Pt.has(r.state);if(!n&&!o)return this._message("mdi:heart-pulse",Se(a,"empty.recovery_trends.title"));const l=i("resting_hr_baseline"),c=i("hrv_baseline"),d=n&&l&&!Pt.has(l.state)?Number(s.state)-Number(l.state):void 0,u=o&&c&&!Pt.has(c.state)?Number(r.state)-Number(c.state):void 0,p=[];return this._rhrHistory.length&&p.push({points:this._rhrHistory,colorVar:"var(--sc-pulse)"}),this._hrvHistory.length&&p.push({points:this._hrvHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:heart-pulse"></ha-icon></div>
          <div class="title-block">
        ...
        <div class="stats">
          ${n?this._stat(String(Math.round(Number(s.state))),"bpm",void 0!==d?Se(a,"stat.resting_hr_delta",{delta:Ue(d)}):Se(a,"stat.resting_hr"),void 0!==d?d<=0?"good":"bad":void 0):G}
          ${o?this._stat(String(Math.round(Number(r.state))),"ms",void 0!==u?Se(a,"stat.hrv_delta",{delta:Ue(u)}):Se(a,"stat.hrv"),void 0!==u?u>=0?"good":"bad":void 0):G}
        </div>
      </ha-card>
    `}_stat(e,t,a,i){return I`
      <div class="stat ${i??""}">
    ...
    `}};Ht.styles=[Ee,Ne,n`
    `],e([ge()],Ht.prototype,"_config",void 0),e([ge()],Ht.prototype,"_history",void 0),Ht=e([ue("suunto-weekly-volume-card")],Ht);const Lt=new Set(["unknown","unavailable",""]);let qt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-curve-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{this._history=await Oe(this.hass,"suunto_app:hr",26,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="current_hr"]?a.states[t[s]]:void 0;var s;if(!i||Lt.has(i.state))return this._message("mdi:chart-bell-curve",Se(a,"empty.hr_curve.title"),Se(a,"empty.hr_curve.subtitle"));const r=this._history.map(e=>e.v),n=r.length?Math.min(...r):void 0,o=r.length?Math.max(...r):void 0;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `}};qt.styles=[Ee,Ne,n`
    `],e([ge()],qt.prototype,"_config",void 0),e([ge()],qt.prototype,"_history",void 0),qt=e([ue("suunto-hr-curve-card")],qt);const Ot=new Set(["unknown","unavailable",""]);let Bt=class extends Ce{constructor(){super(...arguments),this._durationHistory=[],this._qualityHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Oe(this.hass,"suunto_app:sleep_duration",720,"mean"),Oe(this.hass,"suunto_app:sleep_quality",720,"mean")]);this._durationHistory=e,this._qualityHistory=t}catch{this._durationHistory=[],this._qualityHistory=[]}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||Ot.has(s.state))return this._message("mdi:power-sleep",Se(a,"empty.sleep_trends.title"));const r=i("sleep_quality"),n=[];this._durationHistory.length&&n.push({points:this._durationHistory,colorVar:"var(--sc-pulse)"}),this._qualityHistory.length&&n.push({points:this._qualityHistory,colorVar:"var(--sc-amber)"});const o=Ke(60*Number(s.state));return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ...
          ${r&&!Ot.has(r.state)?this._stat(`${Math.round(Number(r.state))}%`,Se(a,"stat.quality")):G}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ge()],Wt.prototype,"_config",void 0),Wt=e([ue("suunto-just-finished-card")],Wt);const Gt=new Set(["unknown","unavailable",""]);let Ut=class extends Ce{constructor(){super(...arguments),this._stepsHistory=[],this._energyHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-activity-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Oe(this.hass,"suunto_app:steps",336,"sum"),Oe(this.hass,"suunto_app:energy",336,"sum")]);this._stepsHistory=Be(e),this._energyHistory=Be(t)}catch{this._stepsHistory=[],this._energyHistory=[]}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps");if(!s||Gt.has(s.state))return this._message("mdi:shoe-print",Se(a,"empty.activity_trends.title"));const r=i("daily_energy"),n=[];return this._stepsHistory.length&&n.push({points:this._stepsHistory,colorVar:"var(--sc-pulse)"}),this._energyHistory.length&&n.push({points:this._energyHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${r&&!Gt.has(r.state)?this._stat(`${Math.round(Number(r.state))} kcal`,Se(a,"stat.energy")):G}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ge()],Ut.prototype,"_config",void 0),e([ge()],Ut.prototype,"_stepsHistory",void 0),e([ge()],Ut.prototype,"_energyHistory",void 0),Ut=e([ue("suunto-activity-trends-card")],Ut);const Zt=new Set(["unknown","unavailable",""]);let Jt=class extends Ce{constructor(){super(...arguments),this._balanceHistory=[],this._stressHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-balance-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Oe(this.hass,"suunto_app:recovery_balance",336,"mean"),Oe(this.hass,"suunto_app:stress",336,"mean")]);this._balanceHistory=Ie(e),this._stressHistory=Ie(t)}catch{this._balanceHistory=[],this._stressHistory=[]}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Zt.has(s.state))return this._message("mdi:heart-flash",Se(a,"empty.recovery_balance_trend.title"));const r=i("stress_state"),n=[];return this._balanceHistory.length&&n.push({points:this._balanceHistory,colorVar:"var(--sc-pulse)"}),this._stressHistory.length&&n.push({points:this._stressHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ...
          ${r&&!Zt.has(r.state)?this._stat(r.state,Se(a,"stat.stress_level")):G}
        </div>
      </ha-card>
    `}_stat(e,t){return I`
      <div class="stat">
    ...
    `],e([ge()],Jt.prototype,"_config",void 0),e([ge()],Jt.prototype,"_balanceHistory",void 0),e([ge()],Jt.prototype,"_stressHistory",void 0),Jt=e([ue("suunto-recovery-balance-trend-card")],Jt);const Yt=new Set(["unknown","unavailable",""]);let Xt=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-readiness-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{this._history=await Oe(this.hass,"suunto_app:readiness",720,"mean")}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="readiness"]?a.states[t[s]]:void 0;var s;if(!i||Yt.has(i.state))return this._message("mdi:gauge",Se(a,"empty.readiness_trend.title"));const r=Number(i.state),n=function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,r);return I`
      <ha-card class="static">
        <div class="header">
    ...
    `}};function ta(e){const t=Math.round(60*e);if(0===t)return"±0:00";const a=t>0?"+":"-",i=Math.abs(t);return`${a}${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`}ea.styles=[Ee,Ne,n`
      .cal-grid {
        display: grid;
    ...
    `],e([ge()],ea.prototype,"_config",void 0),ea=e([ue("suunto-activity-calendar-card")],ea);let aa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-workout-comparison-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[],n=s?function(e){const t=e[0];if(!t?.activity)return;const a=e.slice(1).find(e=>e.activity===t.activity);return a?{current:t,previous:a}:void 0}(r):void 0;if(!n)return this._message("mdi:compare",Se(a,"empty.workout_comparison.title"),Se(a,"empty.workout_comparison.subtitle"));const{current:o,previous:l}=n,c=null!==o.distance_km&&null!==l.distance_km?o.distance_km-l.distance_km:void 0,d=null!==o.duration_min&&null!==l.duration_min?o.duration_min-l.duration_min:void 0,u=null!==o.avg_hr&&null!==l.avg_hr?o.avg_hr-l.avg_hr:void 0,p=o.distance_km&&o.duration_min?o.duration_min/o.distance_km:void 0,m=l.distance_km&&l.duration_min?l.duration_min/l.distance_km:void 0,h=void 0!==p&&void 0!==m?p-m:void 0;return I`
      <ha-card class="static">
        ...
        <div class="stats">
          ${null!==o.distance_km?this._stat(o.distance_km.toFixed(1),"km",void 0!==c?Se(a,"stat.distance_delta",{delta:Ue(c,1)}):Se(a,"stat.distance")):G}
          ${null!==o.duration_min?(()=>{const e=Ke(o.duration_min);return this._stat(e.value,e.unit,void 0!==d?Se(a,"stat.duration_delta",{delta:Ue(d,0)+" min"}):Se(a,"stat.duration"))})():G}
          ${null!==o.avg_hr?this._stat(String(Math.round(o.avg_hr)),"bpm",void 0!==u?Se(a,"stat.avg_hr_delta",{delta:Ue(u,0)}):Se(a,"stat.avg_hr")):G}
          ${void 0!==p?this._stat(`${Math.floor(p)}:${String(Math.round(p%1*60)).padStart(2,"0")}`,"/km",void 0!==h?Se(a,"stat.pace_delta",{delta:ta(h)}):Se(a,"stat.avg_pace")):G}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
    ...
    `],e([ge()],aa.prototype,"_config",void 0),aa=e([ue("suunto-workout-comparison-card")],aa);const ia=new Set(["unknown","unavailable",""]);let sa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-milestones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance");if(!s||ia.has(s.state))return this._message("mdi:earth",Se(a,"empty.milestones.title"));const r=i("lifetime_energy"),n=Number(s.state),o=n/40075,l=n/42.195,c=n/384400*100,d=r&&!ia.has(r.state)?Number(r.state)/550:void 0;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],sa.prototype,"_config",void 0),sa=e([ue("suunto-milestones-card")],sa);const ra=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];let na=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-athlete-profile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.lifetime_by_activity,s=i?a.states[i]:void 0,r=s?.attributes.activities??[],n=t.workouts_recent,o=n?a.states[n]:void 0,l=o?.attributes.workouts??[];if(0===r.length||0===l.length)return this._message("mdi:account-star",Se(a,"empty.athlete_profile.title"));const c=[...r].sort((e,t)=>t.workouts-e.workouts)[0].activity,d=function(e){for(const[t,a]of ra)if(t.test(e))return a;return"personality.activity.other"}(c),u=function(e){const t=e.filter(e=>Boolean(e.start)),a=t.filter(e=>{const t=new Date(e.start).getDay();return 0===t||6===t}).length,i=a/t.length;return i>=.6?"personality.schedule.weekend":i<=.25?"personality.schedule.weekday":"personality.schedule.balanced"}(l),p=function(e){const t={morning:0,afternoon:0,evening:0,night:0};for(const a of e){if(!a.start)continue;const e=new Date(a.start).getHours();e>=5&&e<12?t.morning++:e>=12&&e<18?t.afternoon++:e>=18&&e<23?t.evening++:t.night++}const a=Object.entries(t).sort((e,t)=>t[1]-e[1])[0][0];return{morning:{key:"personality.time.morning",icon:"mdi:weather-sunset-up"},afternoon:{key:"personality.time.afternoon",icon:"mdi:weather-sunny"},evening:{key:"personality.time.evening",icon:"mdi:weather-sunset"},night:{key:"personality.time.night",icon:"mdi:weather-night"}}[a]}(l);return I`
      <ha-card class="static">
        ...
        <div class="traits">
          <span class="chip accent"><ha-icon .icon=${nt(c)}></ha-icon>${Se(a,d)}</span>
    ...
    `],e([ge()],na.prototype,"_config",void 0),na=e([ue("suunto-athlete-profile-card")],na);let oa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-pace-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[],n=s?function(e){const t=e[0]?.activity;if(!t)return;const a=e.filter(e=>e.activity===t&&e.start&&e.distance_km&&e.duration_min).map(e=>({t:new Date(e.start).getTime(),v:e.duration_min/e.distance_km})).sort((e,t)=>e.t-t.t);if(a.length<2)return;const i=Math.ceil(a.length/2),s=a.slice(0,i),r=a.slice(i).length?a.slice(i):a.slice(-1),n=e=>e.reduce((e,t)=>e+t.v,0)/e.length,o=n(s),l=(n(r)-o)/o,c=l<-.03?"faster":l>.03?"slower":"steady";return{activity:t,points:a,latestPace:a[a.length-1].v,direction:c}}(r):void 0;if(!n)return this._message("mdi:speedometer",Se(a,"empty.pace_trend.title"),Se(a,"empty.pace_trend.subtitle"));const o="faster"===n.direction?{colorVar:"var(--sc-good)",label:Se(a,"pace_trend.faster")}:"slower"===n.direction?{colorVar:"var(--sc-warn)",label:Se(a,"pace_trend.slower")}:{colorVar:"var(--sc-pulse)",label:Se(a,"pace_trend.steady")};return I`
      <ha-card class="static">
        ...
        <div class="footer">
          <div class="stat">
            <div class="stat-value">${We(n.latestPace)}<span class="unit">/km</span></div>
    ...
    `],e([ge()],oa.prototype,"_config",void 0),oa=e([ue("suunto-pace-trend-card")],oa);let la=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-lap-splits-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.last_workout_laps,s=i?a.states[i]:void 0,r=s?.attributes.laps??[];if(!s||0===r.length)return this._message("mdi:flag-checkered",Se(a,"empty.lap_splits.title"),Se(a,"empty.lap_splits.subtitle"));const n=function(e){const t=e.map((e,t)=>({i:t,pace:e.pace_min_km})).filter(e=>null!==e.pace&&e.pace>0);return t.length>0?t.reduce((e,t)=>t.pace<e.pace?t:e).i:e.reduce((t,a,i)=>a.duration_minutes<e[t].duration_minutes?i:t,0)}(r),o=null!==r[n].pace_min_km&&r[n].pace_min_km>0?`${We(r[n].pace_min_km)}/km`:(()=>{const e=Ke(r[n].duration_minutes);return`${e.value} ${e.unit}`})(),l=r.map((e,t)=>{const i=Ke(e.duration_minutes),s=Se(a,"label.lap",{n:e.lap});return{value:e.duration_minutes,label:e.pace_min_km&&e.pace_min_km>0?`${s} · ${We(e.pace_min_km)}/km`:`${s} · ${i.value}${i.unit}`,colorVar:t===n?"var(--sc-good)":void 0}}),c=t.last_workout_start,d=c?a.states[c]:void 0,u=Se(a,"card.hr_zones.last_workout");return I`
      <ha-card class="static">
        ...
        <div class="scroll-list">
          ${r.map((e,t)=>{const a=Ke(e.duration_minutes);return I`
              <div class="lap-row">
                ...
                <div class="lap-value">
                  ${null!==e.pace_min_km&&e.pace_min_km>0?I`${We(e.pace_min_km)}<span class="unit">/km</span>`:I`${a.value}<span class="unit">${a.unit}</span>`}
                </div>
              </div>
            `})}
        </div>
    ...
    `],e([ge()],la.prototype,"_config",void 0),la=e([ue("suunto-lap-splits-card")],la);const ca=new Set(["unknown","unavailable",""]);let da=class extends Ce{constructor(){super(...arguments),this._pteHistory=[],this._epocHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-effect-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([Oe(this.hass,"suunto_app:pte",720,"mean"),Oe(this.hass,"suunto_app:epoc",720,"mean")]);this._pteHistory=e,this._epocHistory=t}catch{this._pteHistory=[],this._epocHistory=[]}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_pte");if(!s||ca.has(s.state))return this._message("mdi:lightning-bolt",Se(a,"empty.training_effect_trend.title"));const r=i("last_epoc"),n=[];return this._pteHistory.length&&n.push({points:this._pteHistory,colorVar:"var(--sc-pulse)"}),this._epocHistory.length&&n.push({points:this._epocHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats">
          ...
          ${r&&!ca.has(r.state)?this._stat(Number(r.state).toFixed(0),Se(a,"stat.epoc"),"ml/kg"):G}
        </div>
      </ha-card>
    `}_stat(e,t,a){return I`
      <div class="stat">
    ...
    `],e([ge()],da.prototype,"_config",void 0),e([ge()],da.prototype,"_pteHistory",void 0),e([ge()],da.prototype,"_epocHistory",void 0),da=e([ue("suunto-training-effect-trend-card")],da);const ua=new Set(["unknown","unavailable",""]);let pa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-status-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("readiness"),r=i("training_suggestion"),n=i("unusual_recovery"),o=s&&!ua.has(s.state)?Number(s.state):void 0,l=r&&!ua.has(r.state)?r.state:void 0;if(void 0===o&&void 0===l)return this._message("mdi:compass-outline",Se(a,"empty.training_status.title"),Se(a,"empty.training_status.subtitle"));const c=void 0!==o?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,o):void 0,d=void 0!==l?function(e,t){switch(t){case"hard":return{colorVar:"var(--sc-good)",label:Se(e,"band.suggestion.hard"),icon:"mdi:fire"};case"moderate":return{colorVar:"var(--sc-pulse)",label:Se(e,"band.suggestion.moderate"),icon:"mdi:walk"};case"easy":return{colorVar:"var(--sc-warn)",label:Se(e,"band.suggestion.easy"),icon:"mdi:leaf"};default:return{colorVar:"var(--sc-bad)",label:Se(e,"band.suggestion.rest"),icon:"mdi:bed-clock"}}}(a,l):void 0,u="on"===n?.state;return I`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ge()],pa.prototype,"_config",void 0),pa=e([ue("suunto-training-status-card")],pa);const ma=new Set(["unknown","unavailable",""]);function ha(e){return Math.max(0,Math.min(100,e))}function ga(e,t,a,i){const s=(i-90)*Math.PI/180;return[e+a*Math.cos(s),t+a*Math.sin(s)]}let va=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-profile-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("lifetime_distance"),n=i("lifetime_days"),o=i("acwr"),l=i("workouts_7d"),c=i("readiness"),d=i("workouts_recent"),u=d?.attributes.workouts??[],p=[s,o,l,c].some(e=>e&&!ma.has(e.state));if(!p&&0===u.length)return this._message("mdi:radar",Se(a,"empty.training_profile.title"),Se(a,"empty.training_profile.subtitle"));const m=e=>e&&!ma.has(e.state)?Number(e.state):0,h=m(r),g=m(n),v=g>0?h/g*7:0,y=v>0?ha(m(s)/(1.4*v)*100):0,_=ha(m(o)/1.5*100),b=ha(m(l)/7*100),f=ha(m(c)),w=new Set(u.map(e=>e.activity).filter(Boolean)).size,k=ha(w/5*100),x=[{label:Se(a,"stat.volume"),value:y},{label:Se(a,"stat.intensity"),value:_},{label:Se(a,"stat.consistency"),value:b},{label:Se(a,"stat.recovery"),value:f},{label:Se(a,"stat.variety"),value:k}],$=[...x].sort((e,t)=>t.value-e.value)[0],z=[...x].sort((e,t)=>e.value-t.value)[0],S=130,A=128,T=360/x.length,C=[.25,.5,.75,1].map(e=>{const t=x.map((t,a)=>ga(S,A,84*e,T*a).join(",")).join(" ");return K`<polygon class="radar-grid" points=${t}></polygon>`}),E=x.map((e,t)=>{const[a,i]=ga(S,A,84,T*t);return K`<line class="radar-axis" x1=${S} y1=${A} x2=${a} y2=${i}></line>`}),N=x.map((e,t)=>ga(S,A,84*e.value/100,T*t)),j=K`<polygon class="radar-fill" points=${N.map(e=>e.join(",")).join(" ")}></polygon>`,M=N.map(([e,t])=>K`<circle class="radar-vertex" cx=${e} cy=${t} r="3.2"></circle>`),R=x.map((e,t)=>{const a=T*t,[i,s]=ga(S,A,104.16,a);let r="middle";return a>10&&a<170&&(r="start"),a>190&&a<350&&(r="end"),K`
    ...
    `],e([ge()],va.prototype,"_config",void 0),va=e([ue("suunto-training-profile-card")],va);const ya=new Set(["unknown","unavailable",""]),_a=100,ba=[[0,0],[26,0],[32,-3],[38,0],[44,0],[47,5],[50,-22],[53,8],[56,-2],[60,0],[66,0],[70,-5],[74,0],[100,0]],fa=300;let wa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-heart-rate-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.current_hr?a.states[t.current_hr]:void 0;if(!i||ya.has(i.state))return this._message("mdi:heart-pulse",Se(a,"empty.heart_rate.title"));const s=Math.round(Number(i.state)),r=60/s,n=[];for(let e=0;e<=fa;e+=10)n.push(K`<line class="hr-grid-line ${e%50==0?"major":""}" x1=${e} y1="0" x2=${e} y2=${64}></line>`);for(let e=0;e<=64;e+=10)n.push(K`<line class="hr-grid-line ${e%50==0?"major":""}" x1="0" y1=${e} x2=${fa} y2=${e}></line>`);return I`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="hr-strip-wrap">
          <svg class="hr-strip" viewBox="0 0 ${fa} ${64}" preserveAspectRatio="none">
            ${n}
            <path
              class="hr-trace hr-scroll"
              d=${function(){const e=[];for(let t=Math.floor(-1)*_a;t<=400;t+=_a)for(const[a,i]of ba)e.push(`${t+a},${32+i}`);return"M"+e.join(" L")}()}
              style="animation-duration:${r}s; --drift-distance:-${_a}px"
            ></path>
    ...
    `],e([ge()],wa.prototype,"_config",void 0),wa=e([ue("suunto-heart-rate-card")],wa);const ka=new Set(["unknown","unavailable",""]),xa=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];function $a(e){if(e)for(const[t,a]of xa)if(t.test(e))return a;return"personality.activity.other"}function za(e){return Math.max(0,Math.min(99,Math.round(e)))}let Sa=class extends Ce{constructor(){super(...arguments),this._showHelp=!1}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-player-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl"),r=i("readiness"),n=i("workouts_30d"),o=i("form_tsb"),l=i("estimated_vo2max")??i("vo2max"),c=i("workouts_recent"),d=i("lifetime_by_activity"),u=[s,r,n].some(e=>e&&!ka.has(e.state));if(!u)return this._message("mdi:cards",Se(a,"empty.player.title"),Se(a,"empty.player.subtitle"));const p=e=>e&&!ka.has(e.state)?Number(e.state):0,m=c?.attributes.workouts??[],h=m.map(e=>e.tss).filter(e=>"number"==typeof e),g=h.length?h.reduce((e,t)=>e+t,0)/h.length:0,v=[{code:"STA",value:za(p(s)/100*99),helpKey:"player.help.sta"},{code:"PWR",value:za(g/150*99),helpKey:"player.help.pwr"},{code:"REC",value:za(p(r)),helpKey:"player.help.rec"},{code:"CON",value:za(p(n)/20*99),helpKey:"player.help.con"},{code:"END",value:za((p(l)-20)/40*99),helpKey:"player.help.end"},{code:"FRM",value:za((p(o)+30)/50*99),helpKey:"player.help.frm"}],y=za(v.reduce((e,t)=>e+t.value,0)/v.length),_=function(e){return e>=85?{key:"player.tier.legendary",colorVar:"var(--player-legendary)"}:e>=70?{key:"player.tier.gold",colorVar:"var(--player-gold)"}:e>=50?{key:"player.tier.silver",colorVar:"var(--player-silver)"}:{key:"player.tier.bronze",colorVar:"var(--player-bronze)"}}(y),b=[...d?.attributes.activities??[]].sort((e,t)=>t.workouts-e.workouts)[0],f=b?.activity??m[0]?.activity;let w="";try{const e=ke(a,this._configuredDeviceId);w=a.devices?.[e]?.name_by_user||a.devices?.[e]?.name||""}catch{}return I`
      <ha-card class="static player-card" style="--tier-color:${_.colorVar}">
        <div class="pc-top">
          ...
          <div class="pc-top-right">
            ...
            <div class="pc-badge">
              <span class="dot"><ha-icon .icon=${nt(f)}></ha-icon></span>
              ${f??""}
            </div>
          </div>
        </div>
        ...
        <div class="pc-avatar-wrap">
          <div class="pc-avatar"><ha-icon .icon=${nt(f)}></ha-icon></div>
        </div>
        ${w?I`<div class="pc-name">${w}</div>`:G}
        <div class="pc-archetype">${Se(a,"player.archetype",{activity:Se(a,$a(f))})}</div>
    ...
    `],e([ge()],Ea.prototype,"_config",void 0),Ea=e([ue("suunto-achievements-card")],Ea);const Na={"achievements.badge.century_club":"100","achievements.badge.workouts_250":"250","achievements.badge.workouts_500":"500","achievements.badge.workouts_1000":"1000","achievements.badge.distance_1000":"1000 km","achievements.badge.distance_5000":"5000 km","achievements.badge.around_globe":"Globe","achievements.badge.hours_100":"100 h","achievements.badge.hours_500":"500 h","achievements.badge.days_100":"100 d","achievements.badge.full_year":"365 d","achievements.badge.energy_100k":"100k","achievements.badge.energy_1m":"1M","achievements.badge.multi_sport":"3+","achievements.badge.jack_of_all_trades":"5+","achievements.badge.specialist":"100+","achievements.badge.solid_engine":"VO2 40+","achievements.badge.elite_engine":"VO2 55+","achievements.badge.consistency_king":"14d","achievements.badge.iron_will":"30d"};let ja=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-achievements-compact-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=Ta(a,t);if(!i)return this._message("mdi:trophy-outline",Se(a,"empty.achievements.title"),Se(a,"empty.achievements.subtitle"));const{allBadges:s,unlockedCount:r}=i,n=s.length?Math.round(r/s.length*100):0,o=[...s].filter(e=>!e.unlocked).sort((e,t)=>t.current/t.target-e.current/e.target)[0],l=2*Math.PI*16,c=l*(1-n/100);return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:trophy-outline"></ha-icon></div>
          <div class="title-block">
    ...
    `}_badge(e,t){return I`
      <div class="badge ${t.unlocked?"unlocked":"locked"}" title=${Se(e,t.nameKey,t.nameVars)}>
        ...
        <span class="bl">${Na[t.nameKey]??Se(e,t.nameKey,t.nameVars)}</span>
      </div>
    `}};ja.styles=[Ee,Ne,n`
      .header {
        align-items: center;
    ...
    `],e([ge()],ja.prototype,"_config",void 0),ja=e([ue("suunto-achievements-compact-card")],ja);const Ma=new Set(["unknown","unavailable",""]);function Ra(e){return 500*e*e}let Da=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-level-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_energy"),r=i("lifetime_workouts");if(!s||Ma.has(s.state))return this._message("mdi:trophy-award",Se(a,"empty.level.title"),Se(a,"empty.level.subtitle"));const n=r&&!Ma.has(r.state)?Number(r.state):0,o=Math.round(Number(s.state)/10),l=function(e){return Math.floor(Math.sqrt(e/500))}(o),c=Ra(l),d=Ra(l+1),u=Math.max(0,Math.min(1,(o-c)/(d-c))),p=d-o,m=2*Math.PI*56;return I`
      <ha-card class="static level-card">
        <div class="lvl-ring-wrap">
          <svg width="128" height="128" viewBox="0 0 128 128">
            ${K`<circle cx="64" cy="64" r=${56} class="ring-track"></circle>`}
            ${K`<circle cx="64" cy="64" r=${56} class="ring-fill" stroke-dasharray=${m} stroke-dashoffset=${m*(1-u)}></circle>`}
          </svg>
    ...
    `],e([ge()],Da.prototype,"_config",void 0),Da=e([ue("suunto-level-card")],Da);const Pa=[[/cycl|bik/i,"cycling"],[/run/i,"running"],[/trek|hik/i,"trekking"],[/walk/i,"walking"],[/gym|strength|weight/i,"gym"],[/swim/i,"swim"],[/ski/i,"ski"],[/row/i,"row"]];const Fa={cycling:"var(--sc-pulse)",running:"var(--sc-bad)",trekking:"var(--sc-good)",walking:"var(--sc-zone-1)",gym:"var(--sc-zone-4)",swim:"var(--sc-sleep-light)",ski:"var(--sc-sleep-deep)",row:"var(--sc-sleep-rem)",other:"var(--sc-amber)"},Va=["var(--sc-pulse)","var(--sc-amber)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let Ha=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-class-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="lifetime_by_activity"]?a.states[t[s]]:void 0;var s;const r=i?.attributes.activities??[],n=r.reduce((e,t)=>e+t.workouts,0);if(!i||0===n)return this._message("mdi:sword-cross",Se(a,"empty.class.title"),Se(a,"empty.class.subtitle"));const o=[...r].sort((e,t)=>t.workouts-e.workouts).filter(e=>e.workouts>0),l=o[0],c=function(e){if(e)for(const[t,a]of Pa)if(t.test(e))return a;return"other"}(l?.activity),d=Fa[c],u=o.slice(0,5),p=o.slice(5).reduce((e,t)=>e+t.workouts,0);return I`
      <ha-card class="static" style="--class-accent:${d}">
        <div class="class-emblem"><ha-icon .icon=${nt(l?.activity)}></ha-icon></div>
        ...
        <div class="class-build">
          ${u.map((e,t)=>{const a=Math.round(e.workouts/n*100);return I`
              <div class="cb-row">
                ...
                <div class="ct"><div class="cf" style="width:${a}%;background:${0===t?d:Va[t%Va.length]}"></div></div>
    ...
    `],e([ge()],Ha.prototype,"_config",void 0),Ha=e([ue("suunto-class-card")],Ha);const La=new Set(["unknown","unavailable",""]);let qa=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-next-milestone-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance");if(!s||La.has(s.state))return this._message("mdi:flag-checkered",Se(a,"empty.next_milestone.title"));const r=Number(s.state),n=function(e){const t=e<1e4?1e3:5e3;return(Math.floor(e/t)+1)*t}(r),o=n-r,l=r/n*100,c=i("lifetime_workouts"),d=c&&!La.has(c.state)?Number(c.state):void 0,u=void 0!==d?function(e){const t=e<500?50:100;return(Math.floor(e/t)+1)*t}(d):void 0,p=void 0!==d&&void 0!==u?u-d:void 0,m=i("weekly_distance"),h=m&&!La.has(m.state)?Number(m.state):void 0,g=h&&h>0?Math.max(1,Math.ceil(o/h)):void 0;return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:flag-checkered"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ge()],Ba.prototype,"_config",void 0),Ba=e([ue("suunto-story-card")],Ba);const Ia=new Set(["unknown","unavailable",""]),Ka=208,Wa=104,Ga=78;function Ua(e,t){const a=e*Math.PI/180;return[Wa+t*Math.sin(a),Wa-t*Math.cos(a)]}let Za=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-clock-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("wake_time"),r=i("sleep_duration");if(!s||Ia.has(s.state)||!r||Ia.has(r.state))return this._message("mdi:sleep",Se(a,"empty.sleep_clock.title"),Se(a,"empty.sleep_clock.subtitle"));const n=new Date(s.state),o=Number(r.state);if(Number.isNaN(n.getTime())||!Number.isFinite(o)||o<=0)return this._message("mdi:sleep",Se(a,"empty.sleep_clock.title"),Se(a,"empty.sleep_clock.subtitle"));const l=new Date(n.getTime()-36e5*o),c=i("sleep_deep"),d=i("sleep_light"),u=i("sleep_rem"),p=c&&!Ia.has(c.state)?Number(c.state):0,m=d&&!Ia.has(d.state)?Number(d.state):0,h=u&&!Ia.has(u.state)?Number(u.state):0,g=p+m+h>0?[{colorVar:"var(--sc-sleep-deep)",minutes:p},{colorVar:"var(--sc-sleep-light)",minutes:m},{colorVar:"var(--sc-sleep-rem)",minutes:h}].filter(e=>e.minutes>0):[{colorVar:"var(--sc-sleep-light)",minutes:60*o}],v=(60*l.getHours()+l.getMinutes())/1440*360,y=60*o/1440*360,_=g.reduce((e,t)=>e+t.minutes,0);let b=v;const f=g.map(e=>{const t=e.minutes/_*y,a=function(e,t){const[a,i]=Ua(e,Ga),[s,r]=Ua(t,Ga),n=t-e>180?1:0;return`M ${a.toFixed(2)} ${i.toFixed(2)} A 78 78 0 ${n} 1 ${s.toFixed(2)} ${r.toFixed(2)}`}(b,b+t);return b+=t,{d:a,colorVar:e.colorVar}}),w=i("sleep_quality"),k=w&&!Ia.has(w.state)?Math.round(Number(w.state)):void 0,x=Ke(60*o),$=Ua(v,96),z=Ua(v+y,96);return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:sleep"></ha-icon></div>
          <div class="title-block">
        ...
        <div class="clock-wrap">
          <svg viewBox="0 0 ${Ka} ${Ka}">
            <circle cx=${Wa} cy=${Wa} r=${Ga} fill="none" stroke="var(--divider-color)" stroke-width=${15} />
            ${f.map(e=>K`<path d=${e.d} fill="none" stroke=${e.colorVar} stroke-width=${15} />`)}
            ${[0,90,180,270].map(e=>{const[t,a]=Ua(e,80),[i,s]=Ua(e,86);return K`<line x1=${t.toFixed(1)} y1=${a.toFixed(1)} x2=${i.toFixed(1)} y2=${s.toFixed(1)} stroke="var(--secondary-text-color)" stroke-width="1.5" />`})}
            ${[{angle:0,label:"0"},{angle:90,label:"6"},{angle:180,label:"12"},{angle:270,label:"18"}].map(({angle:e,label:t})=>{const[a,i]=Ua(e,100);return K`<text x=${a.toFixed(1)} y=${i.toFixed(1)} text-anchor="middle" dominant-baseline="middle" font-size="10" fill="var(--secondary-text-color)">${t}</text>`})}
          </svg>
        ...
        <div class="legend">
          ${p>0?I`<span class="legend-item"><i class="dot" style="background:var(--sc-sleep-deep)"></i>${Se(a,"label.deep")} &middot; ${Ke(p).value}${Ke(p).unit}</span>`:G}
          ${m>0?I`<span class="legend-item"><i class="dot" style="background:var(--sc-sleep-light)"></i>${Se(a,"label.light")} &middot; ${Ke(m).value}${Ke(m).unit}</span>`:G}
          ${h>0?I`<span class="legend-item"><i class="dot" style="background:var(--sc-sleep-rem)"></i>${Se(a,"label.rem")} &middot; ${Ke(h).value}${Ke(h).unit}</span>`:G}
        </div>
      </ha-card>
    `}};Za.styles=[Ee,Ne,n`
      .clock-wrap {
    ...
    `],e([ge()],Za.prototype,"_config",void 0),Za=e([ue("suunto-sleep-clock-card")],Za);const Ja=new Set(["unknown","unavailable",""]),Ya=960;function Xa(e){return`${e.getFullYear()}-${e.getMonth()}-${e.getDate()}`}function Qa(e){const t=new Map;for(const a of e){if(Ja.has(a.state))continue;const e=Xa(new Date(a.lastChanged)),i=t.get(e);(!i||a.lastChanged>i.lastChanged)&&t.set(e,a)}return t}function ei(e){const t=60*(e.getHours()-20)+e.getMinutes();return t<0?t+1440:t}let ti=class extends Ce{constructor(){super(...arguments),this._nights=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-rhythm-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.wake_time,i=t.sleep_duration;if(!a||!i)return;const s=`${a},${i}`,r=Date.now();if(!(s===this._historyKey&&r-this._historyFetchedAt<18e5)){this._historyKey=s,this._historyFetchedAt=r;try{const e=this.hass,t=await async function(e,t,a){if(0===t.length)return{};const i=new Date,s=new Date(i.getTime()-864e5*a),r=await e.callApi("GET",`history/period/${s.toISOString()}?filter_entity_id=${t.join(",")}&end_time=${i.toISOString()}`),n={};return t.forEach((e,t)=>{n[e]=(r[t]??[]).map(e=>({state:e.state,lastChanged:new Date(e.last_updated??e.last_changed).getTime()}))}),n}(e,[a,i],9);this._nights=this._buildNights(t[a]??[],t[i]??[])}catch{this._nights=[]}}}_buildNights(e,t){const a=Qa(e),i=Qa(t),s=[];for(const[e,t]of a){const a=i.get(e);if(!a)continue;const r=new Date(t.state),n=Number(a.state);Number.isNaN(r.getTime())||!Number.isFinite(n)||n<=0||s.push({wake:r,bedtime:new Date(r.getTime()-36e5*n)})}return s.sort((e,t)=>e.bedtime.getTime()-t.bedtime.getTime()),s.slice(-7)}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const t=this.hass;if(this._nights.length<2)return this._message("mdi:chart-timeline-variant",Se(t,"empty.sleep_rhythm.title"),Se(t,"empty.sleep_rhythm.subtitle"));const a=this._nights.map(e=>ei(e.bedtime)),i=a.reduce((e,t)=>e+t,0)/a.length,s=a.reduce((e,t)=>e+(t-i)**2,0)/a.length,r=Math.round(Math.sqrt(s)),n=this._nights.reduce((e,t)=>e+(60*t.wake.getHours()+t.wake.getMinutes()),0)/this._nights.length,o=(1200+i)%1440,l=e=>{const t=new Date;return t.setHours(0,0,0,0),t.setMinutes(Math.round(e)),t};return I`
      <ha-card class="static">
        ...
        <div class="rhythm-chart">
          ${this._nights.map(e=>{const a=ei(e.bedtime),s=ei(e.wake)-a,r=a/Ya*100,n=(s<0?s+1440:s)/Ya*100,o=Math.abs(a-i)>30;return I`
              <div class="rhythm-row">
                <div class="rhythm-day">${(e=>new Intl.DateTimeFormat(t.language,{weekday:"short"}).format(e))(e.bedtime)}</div>
                <div class="rhythm-track">
                  <div class="rhythm-avgline" style="left:${i/Ya*100}%"></div>
                  <div class="rhythm-bar ${o?"late":""}" style="left:${r}%;width:${n}%"></div>
                </div>
              </div>
            `})}
          <div class="rhythm-axis">
            ${Array.from({length:9},(e,t)=>2*t).map(e=>I`<span style="left:${60*e/Ya*100}%">${(20+e)%24}</span>`)}
          </div>
        </div>

        <div class="rhythm-stats">
          <span class="chip">${Se(t,"sleep_rhythm.avg_bedtime",{time:Ge(l(o),t.language)})}</span>
          <span class="chip">${Se(t,"sleep_rhythm.avg_wake",{time:Ge(l(n),t.language)})}</span>
        ...
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ...
              ${l?Je(new Date(l.state),a.language):G}
            </div>
          </div>
        </div>
    ...
    `],e([ge()],ii.prototype,"_config",void 0),ii=e([ue("suunto-route-card")],ii);const si=new Set(["unknown","unavailable",""]);let ri=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-month-story-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("month_distance");if(!s||si.has(s.state))return this._message("mdi:calendar-month",Se(a,"empty.month_story.title"));const r=i("month_time"),n=i("month_energy"),o=i("month_workouts"),l=i("month_active_days"),c=o?.attributes.main_activity,d=o?.attributes.main_activity_workouts,u=o?.attributes.main_activity_pct,p=o&&!si.has(o.state)?Number(o.state):void 0,m=i("training_records_month"),h=m&&!si.has(m.state)?Number(m.state):void 0;return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:calendar-month"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ge()],ri.prototype,"_config",void 0),ri=e([ue("suunto-month-story-card")],ri);const ni=new Set(["unknown","unavailable",""]);let oi=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-year-story-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("year_distance");if(!s||ni.has(s.state))return this._message("mdi:calendar-star",Se(a,"empty.year_story.title"));const r=i("year_time"),n=i("year_energy"),o=i("year_workouts"),l=i("year_active_days"),c=o?.attributes.main_activity,d=o?.attributes.main_activity_workouts,u=o?.attributes.main_activity_pct,p=o&&!ni.has(o.state)?Number(o.state):void 0,m=i("training_records_year"),h=m&&!ni.has(m.state)?Number(m.state):void 0;return I`
      <ha-card class="static">
        <div class="header">
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${Se(a,"card.best_efforts.subtitle",{count:s,total:li.length})}
            </div>
          </div>
        </div>

        <div class="effort-list">
          ${li.map(e=>{const t=i.attributes[`${e.key}_seconds`],s="string"==typeof e.label?e.label:Se(a,e.label.translationKey);if(!t)return I`
              ...
              <div class="effort-row">
                ...
                <div class="effort-main">
                  ...
                  <div class="effort-meta">
                    ...
                    ${t.start_time?Je(new Date(t.start_time),a.language):G}
                  </div>
                </div>
                <div class="effort-pace">${We(r)}<span class="u">/km</span></div>
              </div>
            `})}
        </div>
      </ha-card>
    ...
    `],e([ge()],ci.prototype,"_config",void 0),ci=e([ue("suunto-best-efforts-card")],ci);const di=new Set(["unknown","unavailable",""]);let ui=class extends Ce{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-steps-goal-editor")}static getStubConfig(){return{type:"custom:suunto-steps-trend-card",goal_steps:Xe}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(!(e===this._historyKey&&t-this._historyFetchedAt<6e5)){this._historyKey=e,this._historyFetchedAt=t;try{this._history=Be(await Oe(this.hass,"suunto_app:steps",336,"sum"))}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="daily_steps"]?a.states[t[s]]:void 0;var s;if(!i||di.has(i.state))return this._message("mdi:chart-bar",Se(a,"empty.steps_trend.title"));const r=this._config.goal_steps??Xe,n=this._history.map(e=>({value:e.v,colorVar:e.v>=r?"var(--sc-good)":"var(--sc-amber)",label:`${new Date(e.t).toLocaleDateString(a.language,{month:"short",day:"numeric"})} · ${Math.round(e.v).toLocaleString(a.language)}`})),o=this._history.filter(e=>e.v>=r).length,l=this._history.length?this._history.reduce((e,t)=>e+t.v,0)/this._history.length:0;return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:chart-bar"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ge()],ui.prototype,"_config",void 0),e([ge()],ui.prototype,"_history",void 0),ui=e([ue("suunto-steps-trend-card")],ui);let pi=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-month-records-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=Ca(a,t,"training_records_month").filter(e=>e.entry);return i.length?I`
      <ha-card class="static">
        <div class="header">
    ...
    `:this._message("mdi:medal-outline",Se(a,"empty.month_records.title"),Se(a,"empty.month_records.subtitle"))}_recordRow(e,t,a,i,s){const r=i.start_time?Je(new Date(i.start_time),e.language):void 0;return I`
      <div class="rrow">
        <div class="ic">${t}</div>
        <div class="info">
          <div class="name">${Se(e,a)}</div>
    ...
    `],e([ge()],pi.prototype,"_config",void 0),pi=e([ue("suunto-month-records-card")],pi);let mi=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-year-records-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=Ca(a,t,"training_records_year").filter(e=>e.entry);return i.length?I`
      <ha-card class="static">
        <div class="header">
    ...
    `:this._message("mdi:trophy-award",Se(a,"empty.year_records.title"),Se(a,"empty.year_records.subtitle"))}_recordRow(e,t,a,i,s){const r=i.start_time?Je(new Date(i.start_time),e.language):void 0;return I`
      <div class="rrow">
        <div class="ic">${t}</div>
        <div class="info">
          <div class="name">${Se(e,a)}</div>
