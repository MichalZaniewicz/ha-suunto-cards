...
`;function Ne(e){return W`
  ...
  `}function Pe(e,t,a=300,i=70){if(0===e.length)return K;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return I`
  ...
  `}const Fe=new Set(["unknown","unavailable",""]);let He=class extends Te{static getConfigElement(){return document.createElement("suunto-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-goal-card",goal_km:50}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||Fe.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_goal.title"));const r=this._config.goal_km??50,n=Number(i.state),o=r>0?n/r*100:0,c=o>=100?"var(--sc-good)":"var(--sc-amber)";return W`
      <ha-card class="static">
        <div class="header">
  ...
  `,e([me({attribute:!1})],Le.prototype,"hass",void 0),e([ve()],Le.prototype,"_config",void 0),Le=e([ue("suunto-goal-editor")],Le);const Oe=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function qe(e){if(e)for(const[t,a]of Oe)if(t.test(e))return a;return"mdi:run-fast"}const Be={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};async function We(e,t,a,i="mean"){const s=new Date,r=new Date(s.getTime()-36e5*a),n=await e.callWS({type:"recorder/statistics_during_period",start_time:r.toISOString(),end_time:s.toISOString(),statistic_ids:[t],period:"hour",types:["mean","min","max","sum"]});return(n?.[t]??[]).map(e=>({t:e.start,v:Number(e[i])})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}function Ie(e){const t=[...e].sort((e,t)=>e.t-t.t),a=new Map;for(let e=1;e<t.length;e++){const i=t[e].v-t[e-1].v;if(!Number.isFinite(i)||i<0)continue;const s=new Date(t[e].t).toDateString();a.set(s,(a.get(s)??0)+i)}return[...a.entries()].map(([e,t])=>({t:new Date(e).getTime(),v:t})).sort((e,t)=>e.t-t.t)}function Ge(e){const t=new Map;for(const a of e){const e=new Date(a.t).toDateString(),i=t.get(e)??{sum:0,count:0};i.sum+=a.v,i.count+=1,t.set(e,i)}return[...t.entries()].map(([e,{sum:t,count:a}])=>({t:new Date(e).getTime(),v:t/a})).sort((e,t)=>e.t-t.t)}function Ke(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Ue(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function Ze(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Xe(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const Je=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Qe(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of Je)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const Ye=new Set(["unknown","unavailable",""]);let et=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||Ye.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),c=i("last_avg_hr"),l=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),p=i("last_pte"),h=i("last_epoc"),m=i("last_feeling"),v=i("last_tss"),g=i("last_cal_per_km"),y=i("last_cadence"),_=i("last_pct_hrmax"),f=i("last_workout_weather"),b=i("last_workout_tags"),w=i("last_workout_achievements"),k=o?Ke(Number(o.state)):void 0,x=void 0===d&&void 0!==u,$=m&&!Ye.has(m.state)?Number(m.state):void 0,z=p&&!Ye.has(p.state)?Number(p.state):void 0,S=w?Number(w.state):0;return W`
    ...
    `],e([ve()],Pt.prototype,"_config",void 0),Pt=e([ue("suunto-just-finished-card")],Pt);const Ft=new Set(["unknown","unavailable",""]);let Ht=class extends Te{constructor(){super(...arguments),this._stepsHistory=[],this._energyHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-activity-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([We(this.hass,"suunto_app:steps",336,"sum"),We(this.hass,"suunto_app:energy",336,"sum")]);this._stepsHistory=Ie(e),this._energyHistory=Ie(t)}catch{this._stepsHistory=[],this._energyHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps");if(!s||Ft.has(s.state))return this._message("mdi:shoe-print",Se(a,"empty.activity_trends.title"));const r=i("daily_energy"),n=[];return this._stepsHistory.length&&n.push({points:this._stepsHistory,colorVar:"var(--sc-pulse)"}),this._energyHistory.length&&n.push({points:this._energyHistory,colorVar:"var(--sc-amber)"}),W`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${r&&!Ft.has(r.state)?this._stat(`${Math.round(Number(r.state))} kcal`,Se(a,"stat.energy")):K}
        </div>
      </ha-card>
    `}_stat(e,t){return W`
      <div class="stat">
    ...
    `],e([ve()],Ht.prototype,"_config",void 0),e([ve()],Ht.prototype,"_stepsHistory",void 0),e([ve()],Ht.prototype,"_energyHistory",void 0),Ht=e([ue("suunto-activity-trends-card")],Ht);const Lt=new Set(["unknown","unavailable",""]);let Ot=class extends Te{constructor(){super(...arguments),this._balanceHistory=[],this._stressHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-balance-trend-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){if(!this.hass)return;const e=this._configuredDeviceId??"auto",t=Date.now();if(e===this._historyKey&&t-this._historyFetchedAt<6e5)return;this._historyKey=e,this._historyFetchedAt=t;try{const[e,t]=await Promise.all([We(this.hass,"suunto_app:recovery_balance",336,"mean"),We(this.hass,"suunto_app:stress",336,"mean")]);this._balanceHistory=Ge(e),this._stressHistory=Ge(t)}catch{this._balanceHistory=[],this._stressHistory=[]}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Lt.has(s.state))return this._message("mdi:heart-flash",Se(a,"empty.recovery_balance_trend.title"));const r=i("stress_state"),n=[];return this._balanceHistory.length&&n.push({points:this._balanceHistory,colorVar:"var(--sc-pulse)"}),this._stressHistory.length&&n.push({points:this._stressHistory,colorVar:"var(--sc-amber)"}),W`
      <ha-card class="static">
        <div class="header">
    ...
    `}};function Gt(e){const t=Math.round(60*e);if(0===t)return"±0:00";const a=t>0?"+":"-",i=Math.abs(t);return`${a}${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`}It.styles=[Ee,je,n`
      .cal-grid {
        display: grid;
    ...
    `],e([ve()],It.prototype,"_config",void 0),It=e([ue("suunto-activity-calendar-card")],It);let Kt=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-workout-comparison-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[],n=s?function(e){const t=e[0];if(!t?.activity)return;const a=e.slice(1).find(e=>e.activity===t.activity);return a?{current:t,previous:a}:void 0}(r):void 0;if(!n)return this._message("mdi:compare",Se(a,"empty.workout_comparison.title"),Se(a,"empty.workout_comparison.subtitle"));const{current:o,previous:c}=n,l=null!==o.distance_km&&null!==c.distance_km?o.distance_km-c.distance_km:void 0,d=null!==o.duration_min&&null!==c.duration_min?o.duration_min-c.duration_min:void 0,u=null!==o.avg_hr&&null!==c.avg_hr?o.avg_hr-c.avg_hr:void 0,p=o.distance_km&&o.duration_min?o.duration_min/o.distance_km:void 0,h=c.distance_km&&c.duration_min?c.duration_min/c.distance_km:void 0,m=void 0!==p&&void 0!==h?p-h:void 0;return W`
      <ha-card class="static">
        ...
        <div class="stats">
          ...
          ${void 0!==p?this._stat(`${Math.floor(p)}:${String(Math.round(p%1*60)).padStart(2,"0")}`,"/km",void 0!==m?Se(a,"stat.pace_delta",{delta:Gt(m)}):Se(a,"stat.avg_pace")):K}
        </div>
      </ha-card>
    `}_stat(e,t,a){return W`
      <div class="stat">
    ...
    `],e([ve()],ya.prototype,"_config",void 0),e([ve()],ya.prototype,"_showHelp",void 0),ya=e([ue("suunto-player-card")],ya);const _a=new Set(["unknown","unavailable",""]);function fa(e,t){const a=a=>t[a]?e.states[t[a]]:void 0,i=a("lifetime_workouts"),s=a("lifetime_distance");if(!i&&!s)return null;const r=a("lifetime_time"),n=a("lifetime_days"),o=a("lifetime_energy"),c=a("lifetime_by_activity"),l=a("estimated_vo2max")??a("vo2max"),d=a("training_records"),u=(p=e.language,e=>Math.round(e).toLocaleString(p));var p;const h=function(e){return t=>`${Math.round(t).toLocaleString(e)} km`}(e.language),m=e=>e&&!_a.has(e.state)?Number(e.state):0,v=c?.attributes.activities??[],g=v.filter(e=>e.workouts>0).length,y=[...v].sort((e,t)=>t.workouts-e.workouts)[0],_=d&&!_a.has(d.state)?Number(d.state):0,f=m(i),b=m(s),w=m(r),k=m(n),x=m(o),$=m(l),z=[{headingKey:"achievements.category.workouts",badges:[{icon:"💯",nameKey:"achievements.badge.century_club",unlocked:f>=100,current:f,target:100,format:u},{icon:"🎖️",nameKey:"achievements.badge.workouts_250",unlocked:f>=250,current:f,target:250,format:u},{icon:"🏅",nameKey:"achievements.badge.workouts_500",unlocked:f>=500,current:f,target:500,format:u},{icon:"👑",nameKey:"achievements.badge.workouts_1000",unlocked:f>=1e3,current:f,target:1e3,format:u}]},{headingKey:"achievements.category.distance",badges:[{icon:"🚴",nameKey:"achievements.badge.distance_1000",unlocked:b>=1e3,current:b,target:1e3,format:h},{icon:"🗺️",nameKey:"achievements.badge.distance_5000",unlocked:b>=5e3,current:b,target:5e3,format:h},{icon:"🌍",nameKey:"achievements.badge.around_globe",unlocked:b>=40075,current:b,target:40075,format:h}]},{headingKey:"achievements.category.time",badges:[{icon:"⏱️",nameKey:"achievements.badge.hours_100",unlocked:w>=100,current:w,target:100,format:u},{icon:"⌛",nameKey:"achievements.badge.hours_500",unlocked:w>=500,current:w,target:500,format:u}]},{headingKey:"achievements.category.days",badges:[{icon:"📅",nameKey:"achievements.badge.days_100",unlocked:k>=100,current:k,target:100,format:u},{icon:"🗓️",nameKey:"achievements.badge.full_year",unlocked:k>=365,current:k,target:365,format:u}]},{headingKey:"achievements.category.energy",badges:[{icon:"🔥",nameKey:"achievements.badge.energy_100k",unlocked:x>=1e5,current:x,target:1e5,format:u},{icon:"☄️",nameKey:"achievements.badge.energy_1m",unlocked:x>=1e6,current:x,target:1e6,format:u}]},{headingKey:"achievements.category.variety",badges:[{icon:"🎽",nameKey:"achievements.badge.multi_sport",unlocked:g>=3,current:g,target:3,format:u},{icon:"🧭",nameKey:"achievements.badge.jack_of_all_trades",unlocked:g>=5,current:g,target:5,format:u},...y?[{icon:"⭐",nameKey:"achievements.badge.specialist",nameVars:{activity:y.activity},unlocked:y.workouts>=100,current:y.workouts,target:100,format:u}]:[]]},{headingKey:"achievements.category.fitness",badges:[{icon:"💪",nameKey:"achievements.badge.solid_engine",unlocked:$>=40,current:$,target:40,format:u},{icon:"⚡",nameKey:"achievements.badge.elite_engine",unlocked:$>=55,current:$,target:55,format:u},{icon:"🔥",nameKey:"achievements.badge.consistency_king",unlocked:_>=14,current:_,target:14,format:u},{icon:"🛡️",nameKey:"achievements.badge.iron_will",unlocked:_>=30,current:_,target:30,format:u}]}],S=z.flatMap(e=>e.badges);return{groups:z,allBadges:S,unlockedCount:S.filter(e=>e.unlocked).length}}let ba=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-achievements-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 6}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=fa(a,t);if(!i)return this._message("mdi:trophy-outline",Se(a,"empty.achievements.title"),Se(a,"empty.achievements.subtitle"));const{groups:s,allBadges:r,unlockedCount:n}=i,o=function(e,t){const a=t.training_records?e.states[t.training_records]:void 0,i=a&&!_a.has(a.state)?Number(a.state):0,s=a?.attributes??{};return[{icon:"🔥",labelKey:"records.streak",entry:i>0?{value:i}:void 0,render:t=>Ae(e,t.value,"records.streak_days_one","records.streak_days_other")},{icon:"⚡",labelKey:"records.pace",entry:s.fastest_pace_min_km,render:e=>`${Ue(e.value)} /km`},{icon:"🏔️",labelKey:"records.climb",entry:s.biggest_climb_m,render:e=>`${Math.round(e.value)} m`},{icon:"⏳",labelKey:"records.workout",entry:s.longest_workout_min,render:e=>{const t=Ke(e.value);return`${t.value} ${t.unit}`}},{icon:"📏",labelKey:"records.distance",entry:s.farthest_workout_km,render:e=>`${e.value} km`},{icon:"🥵",labelKey:"records.session",entry:s.hardest_workout_tss,render:e=>`${e.value} TSS`}]}(a,t);return W`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([ve()],ba.prototype,"_config",void 0),ba=e([ue("suunto-achievements-card")],ba);const wa={"achievements.badge.century_club":"100","achievements.badge.workouts_250":"250","achievements.badge.workouts_500":"500","achievements.badge.workouts_1000":"1000","achievements.badge.distance_1000":"1000 km","achievements.badge.distance_5000":"5000 km","achievements.badge.around_globe":"Globe","achievements.badge.hours_100":"100 h","achievements.badge.hours_500":"500 h","achievements.badge.days_100":"100 d","achievements.badge.full_year":"365 d","achievements.badge.energy_100k":"100k","achievements.badge.energy_1m":"1M","achievements.badge.multi_sport":"3+","achievements.badge.jack_of_all_trades":"5+","achievements.badge.specialist":"100+","achievements.badge.solid_engine":"VO2 40+","achievements.badge.elite_engine":"VO2 55+","achievements.badge.consistency_king":"14d","achievements.badge.iron_will":"30d"};let ka=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-achievements-compact-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=fa(a,t);if(!i)return this._message("mdi:trophy-outline",Se(a,"empty.achievements.title"),Se(a,"empty.achievements.subtitle"));const{allBadges:s,unlockedCount:r}=i,n=s.length?Math.round(r/s.length*100):0,o=[...s].filter(e=>!e.unlocked).sort((e,t)=>t.current/t.target-e.current/e.target)[0],c=2*Math.PI*16,l=c*(1-n/100);return W`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge"><ha-icon icon="mdi:trophy-outline"></ha-icon></div>
          <div class="title-block">
          ...
          <div class="ring-wrap">
            <svg width="40" height="40" viewBox="0 0 40 40">
              ...
              <circle cx="20" cy="20" r=${16} class="ring-fill" stroke-dasharray=${c} stroke-dashoffset=${l}></circle>
            </svg>
    ...
    `}_badge(e,t){return W`
      <div class="badge ${t.unlocked?"unlocked":"locked"}" title=${Se(e,t.nameKey,t.nameVars)}>
        ${t.unlocked?K:W`<span class="lock-pin">🔒</span>`}
    ...
    `],e([ve()],ka.prototype,"_config",void 0),ka=e([ue("suunto-achievements-compact-card")],ka);const xa=new Set(["unknown","unavailable",""]);function $a(e){return 500*e*e}let za=class extends Te{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-level-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_energy"),r=i("lifetime_workouts");if(!s||xa.has(s.state))return this._message("mdi:trophy-award",Se(a,"empty.level.title"),Se(a,"empty.level.subtitle"));const n=r&&!xa.has(r.state)?Number(r.state):0,o=Math.round(Number(s.state)/10),c=function(e){return Math.floor(Math.sqrt(e/500))}(o),l=$a(c),d=$a(c+1),u=Math.max(0,Math.min(1,(o-l)/(d-l))),p=d-o,h=2*Math.PI*56;return W`
