 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $=globalThis,x=e=>e,S=$.trustedTypes,z=S?S.createPolicy("lit-html",{createHTML:e=>e}):void 0,A="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,C="?"+E,T=`<${C}>`,N=document,R=()=>N.createComment(""),M=e=>null===e||"object"!=typeof e&&"function"!=typeof e,P=Array.isArray,V="[ \t\n\f\r]",j=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,D=/>/g,O=RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),F=/'/g,L=/"/g,q=/^(?:script|style|textarea|title)$/i,B=(e=>(t,...a)=>({_$litType$:e,strings:t,values:a}))(1),U=Symbol.for("lit-noChange"),I=Symbol.for("lit-nothing"),G=new WeakMap,W=N.createTreeWalker(N,129);function Z(e,t){if(!P(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==z?z.createHTML(t):t}const K=(e,t)=>{const a=e.length-1,i=[];let s,r=2===t?"<svg>":3===t?"<math>":"",n=j;for(let t=0;t<a;t++){const a=e[t];let o,c,l=-1,d=0;for(;d<a.length&&(n.lastIndex=d,c=n.exec(a),null!==c);)d=n.lastIndex,n===j?"!--"===c[1]?n=H:void 0!==c[1]?n=D:void 0!==c[2]?(q.test(c[2])&&(s=RegExp("</"+c[2],"g")),n=O):void 0!==c[3]&&(n=O):n===O?">"===c[0]?(n=s??j,l=-1):void 0===c[1]?l=-2:(l=n.lastIndex-c[2].length,o=c[1],n=void 0===c[3]?O:'"'===c[3]?L:F):n===L||n===F?n=O:n===H||n===D?n=j:(n=O,s=void 0);const u=n===O&&e[t+1].startsWith("/>")?" ":"";r+=n===j?a+T:l>=0?(i.push(o),a.slice(0,l)+A+a.slice(l)+E+u):a+E+(-2===l?t:u)}return[Z(e,r+(e[a]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),i]};class Q{constructor({strings:e,_$litType$:t},a){let i;this.parts=[];let s=0,r=0;const n=e.length-1,o=this.parts,[c,l]=K(e,t);if(this.el=Q.createElement(c,a),W.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(i=W.nextNode())&&o.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const e of i.getAttributeNames())if(e.endsWith(A)){const t=l[r++],a=i.getAttribute(e).split(E),n=/([.?@])?(.*)/.exec(t);o.push({type:1,index:s,name:n[2],strings:a,ctor:"."===n[1]?te:"?"===n[1]?ae:"@"===n[1]?ie:ee}),i.removeAttribute(e)}else e.startsWith(E)&&(o.push({type:6,index:s}),i.removeAttribute(e));if(q.test(i.tagName)){const e=i.textContent.split(E),t=e.length-1;if(t>0){i.textContent=S?S.emptyScript:"";for(let a=0;a<t;a++)i.append(e[a],R()),W.nextNode(),o.push({type:2,index:++s});i.append(e[t],R())}}}else if(8===i.nodeType)if(i.data===C)o.push({type:2,index:s});else{let e=-1;for(;-1!==(e=i.data.indexOf(E,e+1));)o.push({type:7,index:s}),e+=E.length-1}s++}}static createElement(e,t){const a=N.createElement("template");return a.innerHTML=e,a}}function J(e,t,a=e,i){if(t===U)return t;let s=void 0!==i?a._$Co?.[i]:a._$Cl;const r=M(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(e),s._$AT(e,a,i)),void 0!==i?(a._$Co??=[])[i]=s:a._$Cl=s),void 0!==s&&(t=J(e,s._$AS(e,t.values),s,i)),t}class Y{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:a}=this._$AD,i=(e?.creationScope??N).importNode(t,!0);W.currentNode=i;let s=W.nextNode(),r=0,n=0,o=a[0];for(;void 0!==o;){if(r===o.index){let t;2===o.type?t=new X(s,s.nextSibling,this,e):1===o.type?t=new o.ctor(s,o.name,o.strings,this,e):6===o.type&&(t=new se(s,this,e)),this._$AV.push(t),o=a[++n]}r!==o?.index&&(s=W.nextNode(),r++)}return W.currentNode=N,i}p(e){let t=0;for(const a of this._$AV)void 0!==a&&(void 0!==a.strings?(a._$AI(e,a,t),t+=a.strings.length-2):a._$AI(e[t])),t++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,a,i){this.type=2,this._$AH=I,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=J(this,e,t),M(e)?e===I||null==e||""===e?(this._$AH!==I&&this._$AR(),this._$AH=I):e!==this._$AH&&e!==U&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>P(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==I&&M(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:a}=e,i="number"==typeof a?this._$AC(e):(void 0===a.el&&(a.el=Q.createElement(Z(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(t);else{const e=new Y(i,this),a=e.u(this.options);e.p(t),this.T(a),this._$AH=e}}_$AC(e){let t=G.get(e.strings);return void 0===t&&G.set(e.strings,t=new Q(e)),t}k(e){P(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,i=0;for(const s of e)i===t.length?t.push(a=new X(this.O(R()),this.O(R()),this,this.options)):a=t[i],a._$AI(s),i++;i<t.length&&(this._$AR(a&&a._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=x(e).nextSibling;x(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ee{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,a,i,s){this.type=1,this._$AH=I,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=s,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=I}_$AI(e,t=this,a,i){const s=this.strings;let r=!1;if(void 0===s)e=J(this,e,t,0),r=!M(e)||e!==this._$AH&&e!==U,r&&(this._$AH=e);else{const i=e;let n,o;for(e=s[0],n=0;n<s.length-1;n++)o=J(this,i[a+n],t,n),o===U&&(o=this._$AH[n]),r||=!M(o)||o!==this._$AH[n],o===I?e=I:e!==I&&(e+=(o??"")+s[n+1]),this._$AH[n]=o}r&&!i&&this.j(e)}j(e){e===I?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class te extends ee{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===I?void 0:e}}class ae extends ee{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==I)}}class ie extends ee{constructor(e,t,a,i,s){super(e,t,a,i,s),this.type=5}_$AI(e,t=this){if((e=J(this,e,t,0)??I)===U)return;const a=this._$AH,i=e===I&&a!==I||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==I&&(a===I||i);i&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class se{constructor(e,t,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){J(this,e)}}const re=$.litHtmlPolyfillSupport;re?.(Q,X),($.litHtmlVersions??=[]).push("3.3.3");const ne=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Ce=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function Te(e){if(e)for(const[t,a]of Ce)if(t.test(e))return a;return"mdi:run-fast"}const Ne={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};function Re(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Me(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function Pe(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Ve(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const je=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function He(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of je)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const De=new Set(["unknown","unavailable",""]);let Oe=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||De.has(s.state))return this._message("mdi:calendar-blank-outline",$e(a,"empty.last_workout.title"),$e(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),c=i("last_avg_hr"),l=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),h=i("last_pte"),p=i("last_epoc"),m=i("last_feeling"),v=i("last_tss"),g=i("last_cal_per_km"),_=i("last_workout_weather"),f=i("last_workout_tags"),y=i("last_workout_achievements"),b=o?Re(Number(o.state)):void 0,w=void 0===d&&void 0!==u,k=m&&!De.has(m.state)?Number(m.state):void 0,$=h&&!De.has(h.state)?Number(h.state):void 0,x=y?Number(y.state):0;return B`
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        ...
        <div class="stats">
          ${n?this._stat((Number(n.state)/1e3).toFixed(1),"km",$e(a,"stat.distance")):I}
          ${b?this._stat(b.value,b.unit,$e(a,"stat.duration")):I}
          ${d?this._stat(Me(Number(d.state)),"/km",$e(a,"stat.avg_pace")):w?this._stat(Number(u.state).toFixed(1),"km/h",$e(a,"stat.avg_speed")):I}
          ${c?this._stat(String(Math.round(Number(c.state))),"bpm",$e(a,"stat.avg_hr"),!0):I}
          ${l?this._stat(String(Math.round(Number(l.state))),"bpm",$e(a,"stat.max_hr"),!0):I}
          ${void 0!==$?B`
                <div class="stat">
        ...
        ${v||p||void 0!==k||g?B`
              <hr />
              <div class="secondary">
                ${v?this._secondary(String(Math.round(Number(v.state))),$e(a,"stat.tss")):I}
                ${p?this._secondary(Number(p.state).toFixed(1),$e(a,"stat.epoc")):I}
                ${void 0!==k?B`
                      <div class="sec-item">
                        <div class="feeling">
                    ...
                    `:I}
                ${g?this._secondary(`${Math.round(Number(g.state))}`,$e(a,"stat.energy"),"kcal/km"):I}
              </div>
            `:I}
        ${_&&!De.has(_.state)?B`
              <div class="weather">
                ...
                ${_.attributes.condition?B`<span class="sep">·</span><span class="cond">${_.attributes.condition}</span>`:I}
        ...
        ${f&&!De.has(f.state)||x>0?B`
              <div class="footer">
                ${f&&!De.has(f.state)?B`<span class="chip"><ha-icon icon="mdi:tag-outline"></ha-icon>${f.state}</span>`:I}
                ${x>0?B`
                      <span
                        class="chip accent"
    ...
    `}_secondary(e,t,a){return B`
      <div class="sec-item">
        <div class="sec-value">${e}${a?B` <span class="sec-unit">${a}</span>`:I}</div>
  ...
  `}Oe.styles=[Ae,Ee,n`
    ...
    `],e([pe()],Oe.prototype,"_config",void 0),Oe=e([le("suunto-last-workout-card")],Oe);const qe=e=>`var(--sc-zone-${e})`;let Be=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-hr-zones-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=[];for(let e=1;e<=5;e++){const s=t[`last_zone${e}`],r=s?a.states[s]:void 0;r&&!Number.isNaN(Number(r.state))&&i.push({n:e,minutes:Number(r.state),lower:r.attributes.lower_limit_bpm,upper:r.attributes.upper_limit_bpm})}const s=i.reduce((e,t)=>e+t.minutes,0);if(0===i.length||s<=0)return this._message("mdi:heart-pulse",$e(a,"empty.hr_zones.title"),$e(a,"empty.hr_zones.subtitle"));const r=t.last_workout_start,n=r?a.states[r]:void 0,o=$e(a,"card.hr_zones.last_workout");return B`
      <ha-card class="static">
        <div class="header">
    ...
    `],e([pe()],Be.prototype,"_config",void 0),Be=e([le("suunto-hr-zones-card")],Be);const Ue=new Set(["unknown","unavailable",""]);let Ie=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||Ue.has(s.state))return this._message("mdi:sleep",$e(a,"empty.sleep_readiness.title"),$e(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),c=i("sleep_rem"),l=i("sleep_quality"),d=i("sleep_spo2"),u=i("sleep_hrv"),h=i("hrv_baseline"),p=i("hrv_status"),m=i("resting_hr"),v=i("resting_hr_baseline"),g=i("readiness"),_=i("nap_duration"),f=g&&!Ue.has(g.state)?Number(g.state):void 0,y=void 0!==f?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:$e(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:$e(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:$e(e,"band.readiness.low")}}(a,f):void 0,b=u&&h&&!Ue.has(h.state)?Number(u.state)-Number(h.state):void 0,w=m&&v&&!Ue.has(v.state)?Number(m.state)-Number(v.state):void 0,k=[n&&!Ue.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:$e(a,"label.deep")}:void 0,o&&!Ue.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:$e(a,"label.light")}:void 0,c&&!Ue.has(c.state)?{flexGrow:Number(c.state),colorVar:"var(--sc-sleep-rem)",title:$e(a,"label.rem")}:void 0].filter(e=>void 0!==e),$=Re(60*Number(s.state)),x=_&&!Ue.has(_.state)?Number(_.state):void 0,S=!!_?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(_.attributes.date)),z={duration:`${$.value} ${$.unit}`};return B`
      <ha-card class="static">
        ...
        <div class="stats">
          ${l?this._stat(String(Math.round(Number(l.state))),"%",$e(a,"stat.quality")):I}
          ${u?this._stat(String(Math.round(Number(u.state))),"ms",void 0!==b?$e(a,"stat.hrv_delta",{delta:Ve(b)}):$e(a,"stat.hrv"),void 0!==b?b>=0?"good":"bad":void 0):I}
          ${m?this._stat(String(Math.round(Number(m.state))),"bpm",void 0!==w?$e(a,"stat.resting_hr_delta",{delta:Ve(w)}):$e(a,"stat.resting_hr"),void 0!==w?w<=0?"good":"bad":void 0):I}
          ${d?this._stat(String(Math.round(Number(d.state))),"%",$e(a,"stat.spo2")):I}
        </div>
    ...
    `],e([pe()],Ie.prototype,"_config",void 0),Ie=e([le("suunto-sleep-readiness-card")],Ie);const Ge=new Set(["unknown","unavailable",""]);let We=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("recovery_balance");if(!s||Ge.has(s.state))return this._message("mdi:battery-heart-variant",$e(a,"empty.recovery.title"));const r=i("is_recovering"),n=i("recovery_until"),o=i("recovery_time"),c=i("stress_state"),l=i("workout_today"),d=Number(s.state),u=function(e,t){return t>=60?{colorVar:"var(--sc-good)",label:$e(e,"band.recovery.well")}:t>=30?{colorVar:"var(--sc-warn)",label:$e(e,"band.recovery.partial")}:{colorVar:"var(--sc-bad)",label:$e(e,"band.recovery.low")}}(a,d),h="on"===r?.state;let p=$e(a,"band.recovery.fully");if(h&&n&&!Ge.has(n.state)){const e=new Date(n.state).getTime()-Date.now();if(e>0){const t=Re(e/6e4);p=$e(a,"band.recovery.recovering",{time:`${t.value} ${t.unit}`})}}return B`
      <ha-card class="static">
        <div class="header">
        ...
        ${c||o?B`
              <div class="stats two">
                ${c&&!Ge.has(c.state)?this._stat(c.state,"",$e(a,"stat.stress_level")):I}
                ${o&&!Ge.has(o.state)?this._stat(Number(o.state).toFixed(1),"h",$e(a,"stat.recovery_window")):I}
              </div>
            `:I}
        ${"on"===l?.state?B`<div class="footer"><span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${$e(a,"chip.workout_logged_today")}</span></div>`:I}
      </ha-card>
    `}_stat(e,t,a){return B`
      <div class="stat">
        <div class="stat-value">${e}${t?B`<span class="unit">${t}</span>`:I}</div>
        <div class="stat-label">${a}</div>
      </div>
    `}};We.styles=[Ae,Ee,n`
      .readiness-row {
    ...
    `],e([pe()],We.prototype,"_config",void 0),We=e([le("suunto-recovery-card")],We);const Ze=new Set(["unknown","unavailable",""]);let Ke=class extends ze{constructor(){super(...arguments),this._history=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-training-load-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const t=e.map.fitness_ctl;if(!t)return;const a=Date.now();if(!(t===this._historyEntityId&&a-this._historyFetchedAt<6e5)){this._historyEntityId=t,this._historyFetchedAt=a;try{const e=new Date(a-2592e6).toISOString(),i=await this.hass.callApi("GET",`history/period/${e}?filter_entity_id=${t}&no_attributes`),s=(i?.[0]??[]).map(e=>({t:new Date(e.last_updated??e.last_changed??"").getTime(),v:Number(e.state)})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v));this._history=s}catch{this._history=[]}}}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl");if(!s||Ze.has(s.state))return this._message("mdi:arm-flex",$e(a,"empty.training_load.title"),$e(a,"empty.training_load.subtitle"));const r=i("fatigue_atl"),n=i("form_tsb"),o=i("acwr"),c=n&&!Ze.has(n.state)?Number(n.state):void 0,l=void 0!==c?function(e,t){return t>5?{colorVar:"var(--sc-good)",label:$e(e,"band.form.fresh")}:t<-20?{colorVar:"var(--sc-bad)",label:$e(e,"band.form.very_fatigued")}:t<-5?{colorVar:"var(--sc-warn)",label:$e(e,"band.form.fatigued")}:{colorVar:"var(--sc-pulse)",label:$e(e,"band.form.neutral")}}(a,c):void 0,d=o&&!Ze.has(o.state)?Number(o.state):void 0,u=void 0!==d?function(e,t){return t>1.3?{colorVar:"var(--sc-bad)",label:$e(e,"band.acwr.high")}:t<.8?{colorVar:"var(--sc-warn)",label:$e(e,"band.acwr.low")}:{colorVar:"var(--sc-good)",label:$e(e,"band.acwr.safe")}}(a,d):void 0;return B`
      <ha-card class="static">
        ...
        ${function(e,t,a=300,i=56){if(e.length<2)return I;const s=e.map(e=>e.v),r=Math.min(...s),n=Math.max(...s)-r||1,o=.12*i,c=i-2*o,l=a/(e.length-1),d=e.map((e,t)=>[t*l,o+c-(e.v-r)/n*c]),u=d.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),h=`${u} L${a},${i} L0,${i} Z`,[p,m]=d[d.length-1];return B`
  ...
  `}(this._history,"var(--sc-amber)")}
        ...
        <div class="stats three">
          ...
          ${r?this._stat(Number(r.state).toFixed(0),$e(a,"stat.atl")):I}
          ${void 0!==c?this._stat(Ve(c,1),$e(a,"stat.tsb"),l?.colorVar):I}
        </div>
    ...
    `],e([pe()],Ke.prototype,"_config",void 0),e([pe()],Ke.prototype,"_history",void 0),Ke=e([le("suunto-training-load-card")],Ke);const Qe=new Set(["unknown","unavailable",""]),Je=["var(--sc-amber)","var(--sc-pulse)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let Ye=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-week-stats-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("weekly_distance"),r=i("weekly_time"),n=i("workouts_7d"),o=i("workouts_30d"),c=i("lifetime_by_activity");if(!s&&!c)return this._message("mdi:calendar-week",$e(a,"empty.week_stats.title"));const l=(c?.attributes.activities??[]).slice().sort((e,t)=>t.distance_km-e.distance_km),d=l.slice(0,5),u=l.length-d.length;return B`
      <ha-card class="static">
        <div class="header">
        ...
        ${s||r||n?B`
              <div class="stats three">
                ${s&&!Qe.has(s.state)?this._stat(Number(s.state).toFixed(1),"km",$e(a,"stat.distance")):I}
                ${r&&!Qe.has(r.state)?this._stat(Number(r.state).toFixed(1),"h",$e(a,"stat.time")):I}
                ${n&&!Qe.has(n.state)?this._stat(n.state,"",$e(a,"stat.workouts")):I}
              </div>
            `:I}
        ...
        ${d.length?B`
            ...
            `:I}
        ${o&&!Qe.has(o.state)?B`<div class="footer"><span class="chip">${$e(a,"chip.workouts_30d",{count:o.state})}</span></div>`:I}
      </ha-card>
    `}_stat(e,t,a){return B`
      <div class="stat">
        <div class="stat-value">${e}${t?B`<span class="unit">${t}</span>`:I}</div>
    ...
    `],e([pe()],Ye.prototype,"_config",void 0),Ye=e([le("suunto-week-stats-card")],Ye);const Xe=new Set(["unknown","unavailable",""]);let et=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-today-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("daily_steps"),r=i("daily_energy"),n=i("current_hr"),o=i("workout_today"),c=i("is_recovering");if(!s&&!r&&!n)return this._message("mdi:pulse",$e(a,"empty.today.title"));const l=n&&!Xe.has(n.state)?Math.round(Number(n.state)):void 0;return B`
      <ha-card class="static">
        ...
        <div class="stats three">
          ${s&&!Xe.has(s.state)?this._stat(Number(s.state).toLocaleString(a.language),"",$e(a,"stat.steps")):I}
          ${r&&!Xe.has(r.state)?this._stat(Math.round(Number(r.state)).toLocaleString(a.language),"kcal",$e(a,"stat.energy")):I}
          ${void 0!==l?B`
                <div class="stat hr">
        ...
        ${"on"===o?.state||"on"===c?.state?B`
              <div class="footer">
                ${"on"===o?.state?B`<span class="chip accent"><ha-icon icon="mdi:calendar-check"></ha-icon>${$e(a,"chip.workout_today")}</span>`:I}
                ${"on"===c?.state?B`<span class="chip"><ha-icon icon="mdi:bed-clock"></ha-icon>${$e(a,"chip.recovering")}</span>`:I}
              </div>
            `:I}
      </ha-card>
    `}_stat(e,t,a){return B`
    ...
    `],e([pe()],et.prototype,"_config",void 0),et=e([le("suunto-today-card")],et);const tt=new Set(["unknown","unavailable",""]);let at=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-lifetime-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 3}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("lifetime_distance"),r=i("lifetime_time"),n=i("lifetime_energy"),o=i("lifetime_workouts"),c=i("lifetime_days");return!s||tt.has(s.state)?this._message("mdi:trophy-variant",$e(a,"empty.lifetime.title")):B`
      <ha-card class="static">
        ...
        <div class="stats three">
          ...
          ${r?this._stat(Number(r.state).toFixed(0),"h",$e(a,"stat.time")):I}
          ${n?this._stat(Math.round(Number(n.state)).toLocaleString(a.language),"kcal",$e(a,"stat.energy")):I}
          ${o?this._stat(o.state,"",$e(a,"stat.workouts")):I}
          ${c?this._stat(c.state,"",$e(a,"stat.active_days")):I}
        </div>
      </ha-card>
    `}_stat(e,t,a){return B`
      <div class="stat">
    ...
    `],e([pe()],at.prototype,"_config",void 0),at=e([le("suunto-lifetime-card")],at);let it=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recent-workouts-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t.workouts_recent,s=i?a.states[i]:void 0,r=s?.attributes.workouts??[];return s&&0!==r.length?B`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="scroll-list">
          ${r.map(e=>{const t=null!==e.duration_min?Re(e.duration_min):void 0;return B`
              <div class="workout-row">
                ...
                <div class="row-stats">
                  ${null!==e.distance_km?B`<span>${e.distance_km} km</span>`:I}
                  ${null!==e.distance_km&&t?B`<span class="sep">·</span>`:I}
                  ${t?B`<span>${t.value} ${t.unit}</span>`:I}
                </div>
              </div>
            `})}
        </div>
      </ha-card>
    `:this._message("mdi:format-list-bulleted",$e(a,"empty.recent_workouts.title"))}};it.styles=[Ae,Ee,n`
      .workout-row {
        display: grid;
    ...
    `],e([pe()],it.prototype,"_config",void 0),it=e([le("suunto-recent-workouts-card")],it);const st=new Set(["unknown","unavailable",""]);let rt=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-elevation-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_ascent"),r=i("last_descent");if((!s||st.has(s.state))&&(!r||st.has(r.state)))return this._message("mdi:image-filter-hdr",$e(a,"empty.elevation.title"),$e(a,"empty.elevation.subtitle"));const n=i("last_ascent_time"),o=i("last_descent_time"),c=i("last_min_altitude"),l=i("last_max_altitude"),d=i("last_ascent_rate"),u=i("last_workout_start");return B`
      <ha-card class="static">
        <div class="header">
        ...
        <div class="stats three">
          ${s&&!st.has(s.state)?this._stat(Math.round(Number(s.state)).toString(),"m",$e(a,"stat.ascent")):I}
          ${r&&!st.has(r.state)?this._stat(Math.round(Number(r.state)).toString(),"m",$e(a,"stat.descent")):I}
          ${n&&!st.has(n.state)?(()=>{const e=Re(Number(n.state));return this._stat(e.value,e.unit,$e(a,"stat.ascent_time"))})():I}
          ${o&&!st.has(o.state)?(()=>{const e=Re(Number(o.state));return this._stat(e.value,e.unit,$e(a,"stat.descent_time"))})():I}
          ${c&&!st.has(c.state)?this._stat(Math.round(Number(c.state)).toString(),"m",$e(a,"stat.min_altitude")):I}
          ${l&&!st.has(l.state)?this._stat(Math.round(Number(l.state)).toString(),"m",$e(a,"stat.max_altitude")):I}
        </div>
    ...
    `],e([pe()],rt.prototype,"_config",void 0),rt=e([le("suunto-elevation-card")],rt);const nt=new Set(["unknown","unavailable",""]);let ot=class extends ze{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-location-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return I;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_workout_location"),r=s?.attributes.latitude,n=s?.attributes.longitude,o=t.last_workout_location;if(!s||nt.has(s.state)||void 0===r||void 0===n)return this._message("mdi:map-marker",$e(a,"empty.location.title"),$e(a,"empty.location.subtitle"));const c=i("last_activity"),l=i("last_workout_start"),d=`https://www.google.com/maps?q=${r},${n}`,u=o?this._getMapElement(o):void 0;return B`
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${c?B`${c.state}`:I}
              ${c&&l?B`<span class="sep">·</span>`:I}
              ${l?He(new Date(l.state),a.language):I}
            </div>
          </div>
        </div>

        ${u?B`<div class="map-wrap">${u}</div>`:I}
    ...
    `}_getMapElement(e){if(!this._mapEl||this._mapEntityId!==e){if(!customElements.get("hui-map-card"))return;try{const t=document.createElement("hui-map-card");t.setConfig({type:"map",entities:[e],default_zoom:13}),this._mapEl=t,this._mapEntityId=e}catch{return}}return this._mapEl.hass=this.hass,this._mapEl}};ot.styles=[Ae,Ee,n`
      .subtitle .sep {
        opacity: 0.45;
        margin: 0 3px;
      }
      ...
      <ha-card class="static">
        <div class="header">
          ...
          <div class="title-block">
            ...
            <div class="subtitle">
              ${o?$e(a,"fitness.measured",{time:He(new Date(o),a.language),activity:c??""}):I}
            </div>
          </div>
        </div>
        ...
        <div class="stats three">
          ...
          ${r&&!ct.has(r.state)?this._stat(Number(r.state).toFixed(1),"ml/kg/min",$e(a,"stat.estimated_vo2max")):I}
          ${n&&!ct.has(n.state)?this._stat(String(Math.round(Number(n.state))),"",$e(a,"stat.fitness_age")):I}
        </div>
      </ha-card>
    `}_stat(e,t,a){return B`
      <div class="stat">
      ...
      <ha-card @click=${()=>this._openMoreInfo(t.last_activity)}>
        ...
        ${u.length?B`
              <div class="compact-stats">
                ${u.map((e,t)=>B`${t>0?B`<span class="sep">·</span>`:I}${e}`)}
              </div>
            `:I}
      </ha-card>
