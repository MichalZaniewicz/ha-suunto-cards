...
`;function je(e){return I`
  ...
  `}function Me(e,t,a=300,i=56){if(e.length<2)return K;const s=e.map(e=>e.v),r=Math.min(...s),n=Math.max(...s)-r||1,o=.12*i,l=i-2*o,c=a/(e.length-1),d=e.map((e,t)=>[t*c,o+l-(e.v-r)/n*l]),u=d.map(([e,t],a)=>`${0===a?"M":"L"}${e.toFixed(1)},${t.toFixed(1)}`).join(" "),m=`${u} L${a},${i} L0,${i} Z`,[p,h]=d[d.length-1];return I`
  ...
  `}function Ve(e,t=300,a=160){if(e.length<2)return K;const i=e.reduce((e,t)=>e+t.lat,0)/e.length*(Math.PI/180),s=Math.cos(i)||1,r=e.map(e=>e.lon*s),n=e.map(e=>-e.lat),o=Math.min(...r),l=Math.min(...n),c=Math.max(...r)-o||1e-6,d=Math.max(...n)-l||1e-6,u=t-28,m=a-28,p=Math.min(u/c,m/d),h=14+(u-c*p)/2,v=14+(m-d*p)/2,g=e=>[h+(e.lon*s-o)*p,v+(-e.lat-l)*p],y=e.map(e=>e.speedKmh),_=Math.min(...y),b=Math.max(...y),f=e.slice(1).map((t,a)=>{const[i,s]=g(e[a]),[r,n]=g(t),o=function(e,t,a){const i=a-t;if(i<.5)return"var(--sc-amber)";const s=(e-t)/i;return`var(--sc-sev-${Math.min(5,Math.max(1,Math.ceil(5*s)||1))})`}(t.speedKmh,_,b);return G`<line x1=${i.toFixed(1)} y1=${s.toFixed(1)} x2=${r.toFixed(1)} y2=${n.toFixed(1)} stroke=${o} stroke-width="4" stroke-linecap="round"></line>`}),[w,k]=g(e[0]),[x,$]=g(e[e.length-1]);return I`
  ...
  `}function Pe(e,t,a=300,i=70){if(0===e.length)return K;const s=Math.max(...e.map(e=>e.value),1e-4),r=(a-4*(e.length-1))/e.length,n=e.map((e,a)=>{const n=Math.max(e.value/s*i,2);return G`
  ...
  `}const He=new Set(["unknown","unavailable",""]);let Le=class extends Ce{static getConfigElement(){return document.createElement("suunto-goal-editor")}static getStubConfig(){return{type:"custom:suunto-weekly-goal-card",goal_km:50}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="weekly_distance"]?a.states[t[s]]:void 0;var s;if(!i||He.has(i.state))return this._message("mdi:target",Se(a,"empty.weekly_goal.title"));const r=this._config.goal_km??50,n=Number(i.state),o=r>0?n/r*100:0,l=o>=100?"var(--sc-good)":"var(--sc-amber)";return I`
    ...
    `],e([ve()],Le.prototype,"_config",void 0),Le=e([ue("suunto-weekly-goal-card")],Le);let qe=class extends ce{setConfig(e){this._config=e}render(){if(!this.hass||!this._config)return K;const e=we(this.hass);return I`
      ${e.length>1?I`
            <ha-device-picker
              .hass=${this.hass}
              .value=${this._config.device_id??""}
  ...
  `,e([he({attribute:!1})],qe.prototype,"hass",void 0),e([ve()],qe.prototype,"_config",void 0),qe=e([ue("suunto-goal-editor")],qe);const Oe=[[/cycl|bik/i,"mdi:bike"],[/run/i,"mdi:run"],[/trek|hik/i,"mdi:hiking"],[/walk/i,"mdi:walk"],[/gym|strength|weight/i,"mdi:dumbbell"],[/swim/i,"mdi:swim"],[/ski/i,"mdi:ski"],[/row/i,"mdi:rowing"]];function Be(e){if(e)for(const[t,a]of Oe)if(t.test(e))return a;return"mdi:run-fast"}const Ie={"01":"mdi:weather-sunny","02":"mdi:weather-partly-cloudy","03":"mdi:weather-cloudy","04":"mdi:weather-cloudy","09":"mdi:weather-pouring",10:"mdi:weather-rainy",11:"mdi:weather-lightning",13:"mdi:weather-snowy",50:"mdi:weather-fog"};async function Ge(e,t,a,i="mean"){const s=new Date,r=new Date(s.getTime()-36e5*a),n=await e.callWS({type:"recorder/statistics_during_period",start_time:r.toISOString(),end_time:s.toISOString(),statistic_ids:[t],period:"hour",types:["mean","min","max","sum"]});return(n?.[t]??[]).map(e=>({t:e.start,v:Number(e[i])})).filter(e=>Number.isFinite(e.t)&&Number.isFinite(e.v))}function We(e){const t=[...e].sort((e,t)=>e.t-t.t),a=new Map;for(let e=1;e<t.length;e++){const i=t[e].v-t[e-1].v;if(!Number.isFinite(i)||i<0)continue;const s=new Date(t[e].t).toDateString();a.set(s,(a.get(s)??0)+i)}return[...a.entries()].map(([e,t])=>({t:new Date(e).getTime(),v:t})).sort((e,t)=>e.t-t.t)}function Ke(e){const t=new Map;for(const a of e){const e=new Date(a.t).toDateString(),i=t.get(e)??{sum:0,count:0};i.sum+=a.v,i.count+=1,t.set(e,i)}return[...t.entries()].map(([e,{sum:t,count:a}])=>({t:new Date(e).getTime(),v:t/a})).sort((e,t)=>e.t-t.t)}function Ue(e){if(e>=60){const t=Math.floor(e/60),a=Math.round(e%60);return{value:`${t}:${String(a).padStart(2,"0")}`,unit:"h"}}return{value:String(Math.round(e)),unit:"min"}}function Ze(e){const t=Math.round(60*e);return`${Math.floor(t/60)}:${String(t%60).padStart(2,"0")}`}function Xe(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric",minute:"2-digit"}).format(e)}function Ye(e,t=0){const a=Number(e.toFixed(t));return 0===a?"±0":a>0?`+${a}`:String(a)}const Je=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]];function Qe(e,t){const a=(e.getTime()-Date.now())/1e3,i=new Intl.RelativeTimeFormat(t,{numeric:"auto"});for(const[e,t]of Je)if(Math.abs(a)>=t)return i.format(Math.round(a/t),e);return i.format(Math.round(a/60),"minute")}const et=new Set(["unknown","unavailable",""]);let tt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-last-workout-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_activity");if(!s||et.has(s.state))return this._message("mdi:calendar-blank-outline",Se(a,"empty.last_workout.title"),Se(a,"empty.last_workout.subtitle"));const r=i("last_workout_start"),n=i("last_distance"),o=i("last_duration"),l=i("last_avg_hr"),c=i("last_max_hr"),d=i("last_avg_pace"),u=i("last_avg_speed"),m=i("last_pte"),p=i("last_epoc"),h=i("last_feeling"),v=i("last_tss"),g=i("last_cal_per_km"),y=i("last_cadence"),_=i("last_pct_hrmax"),b=i("last_workout_weather"),f=i("last_workout_tags"),w=i("last_workout_achievements"),k=o?Ue(Number(o.state)):void 0,x=void 0===d&&void 0!==u,$=h&&!et.has(h.state)?Number(h.state):void 0,z=m&&!et.has(m.state)?Number(m.state):void 0,S=w?Number(w.state):0;return I`
    ...
    `],e([ve()],it.prototype,"_config",void 0),it=e([ue("suunto-hr-zones-card")],it);const st=new Set(["unknown","unavailable",""]);let rt=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-readiness-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("sleep_duration");if(!s||st.has(s.state))return this._message("mdi:sleep",Se(a,"empty.sleep_readiness.title"),Se(a,"empty.sleep_readiness.subtitle"));const r=i("wake_time"),n=i("sleep_deep"),o=i("sleep_light"),l=i("sleep_rem"),c=i("sleep_quality"),d=i("sleep_spo2"),u=i("sleep_hrv"),m=i("hrv_baseline"),p=i("hrv_status"),h=i("resting_hr"),v=i("resting_hr_baseline"),g=i("readiness"),y=i("nap_duration"),_=i("sleep_avg_hr"),b=i("sleep_min_hr"),f=i("sleep_time"),w=i("unusual_recovery"),k=g&&!st.has(g.state)?Number(g.state):void 0,x=void 0!==k?function(e,t){return t>=70?{colorVar:"var(--sc-good)",label:Se(e,"band.readiness.great")}:t>=40?{colorVar:"var(--sc-warn)",label:Se(e,"band.readiness.fair")}:{colorVar:"var(--sc-bad)",label:Se(e,"band.readiness.low")}}(a,k):void 0,$=u&&m&&!st.has(m.state)?Number(u.state)-Number(m.state):void 0,z=h&&v&&!st.has(v.state)?Number(h.state)-Number(v.state):void 0,S=[n&&!st.has(n.state)?{flexGrow:Number(n.state),colorVar:"var(--sc-sleep-deep)",title:Se(a,"label.deep")}:void 0,o&&!st.has(o.state)?{flexGrow:Number(o.state),colorVar:"var(--sc-sleep-light)",title:Se(a,"label.light")}:void 0,l&&!st.has(l.state)?{flexGrow:Number(l.state),colorVar:"var(--sc-sleep-rem)",title:Se(a,"label.rem")}:void 0].filter(e=>void 0!==e),A=Ue(60*Number(s.state)),T=y&&!st.has(y.state)?Number(y.state):void 0,C=!!y?.attributes.date&&function(e){const t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(new Date(y.attributes.date)),E={duration:`${A.value} ${A.unit}`};return I`
      <ha-card class="static">
        ...
        ${p&&!st.has(p.state)||T||f&&!st.has(f.state)||"on"===w?.state?I`
              <div class="footer">
    ...
    `],e([ve()],At.prototype,"_config",void 0),e([ve()],At.prototype,"_ctlHistory",void 0),e([ve()],At.prototype,"_atlHistory",void 0),e([ve()],At.prototype,"_tsbHistory",void 0),At=e([ue("suunto-pmc-card")],At);const Tt=new Set(["unknown","unavailable",""]);let Ct=class extends Ce{constructor(){super(...arguments),this._rhrHistory=[],this._hrvHistory=[],this._historyFetchedAt=0}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-recovery-trends-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}willUpdate(e){e.has("hass")&&this.hass&&this._config&&this._maybeFetchHistory()}async _maybeFetchHistory(){const e=this._resolveEntities();if("error"in e||!this.hass)return;const{map:t}=e,a=t.resting_hr,i=t.sleep_hrv;if(!a&&!i)return;const s=[a,i].filter(e=>Boolean(e)).join(","),r=Date.now();if(!(s===this._historyKey&&r-this._historyFetchedAt<6e5)){this._historyKey=s,this._historyFetchedAt=r;try{const e=this.hass,[t,s]=await Promise.all([a?Ge(e,a,720,"mean"):Promise.resolve([]),i?Ge(e,i,720,"mean"):Promise.resolve([])]);this._rhrHistory=t,this._hrvHistory=s}catch{this._rhrHistory=[],this._hrvHistory=[]}}}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("resting_hr"),r=i("sleep_hrv"),n=s&&!Tt.has(s.state),o=r&&!Tt.has(r.state);if(!n&&!o)return this._message("mdi:heart-pulse",Se(a,"empty.recovery_trends.title"));const l=i("resting_hr_baseline"),c=i("hrv_baseline"),d=n&&l&&!Tt.has(l.state)?Number(s.state)-Number(l.state):void 0,u=o&&c&&!Tt.has(c.state)?Number(r.state)-Number(c.state):void 0,m=[];return this._rhrHistory.length&&m.push({points:this._rhrHistory,colorVar:"var(--sc-pulse)"}),this._hrvHistory.length&&m.push({points:this._hrvHistory,colorVar:"var(--sc-amber)"}),I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:heart-pulse"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ve()],pa.prototype,"_config",void 0),pa=e([ue("suunto-heart-rate-card")],pa);const ha=new Set(["unknown","unavailable",""]),va=[[/cycl|bik/i,"personality.activity.cycling"],[/run/i,"personality.activity.running"],[/trek|hik/i,"personality.activity.trekking"],[/walk/i,"personality.activity.walking"],[/gym|strength|weight/i,"personality.activity.gym"],[/swim/i,"personality.activity.swim"],[/ski/i,"personality.activity.ski"],[/row/i,"personality.activity.row"]];function ga(e){if(e)for(const[t,a]of va)if(t.test(e))return a;return"personality.activity.other"}function ya(e){return Math.max(0,Math.min(99,Math.round(e)))}let _a=class extends Ce{constructor(){super(...arguments),this._showHelp=!1}static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-player-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 5}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("fitness_ctl"),r=i("readiness"),n=i("workouts_30d"),o=i("form_tsb"),l=i("estimated_vo2max")??i("vo2max"),c=i("workouts_recent"),d=i("lifetime_by_activity"),u=[s,r,n].some(e=>e&&!ha.has(e.state));if(!u)return this._message("mdi:cards",Se(a,"empty.player.title"),Se(a,"empty.player.subtitle"));const m=e=>e&&!ha.has(e.state)?Number(e.state):0,p=c?.attributes.workouts??[],h=p.map(e=>e.tss).filter(e=>"number"==typeof e),v=h.length?h.reduce((e,t)=>e+t,0)/h.length:0,g=[{code:"STA",value:ya(m(s)/100*99),helpKey:"player.help.sta"},{code:"PWR",value:ya(v/150*99),helpKey:"player.help.pwr"},{code:"REC",value:ya(m(r)),helpKey:"player.help.rec"},{code:"CON",value:ya(m(n)/20*99),helpKey:"player.help.con"},{code:"END",value:ya((m(l)-20)/40*99),helpKey:"player.help.end"},{code:"FRM",value:ya((m(o)+30)/50*99),helpKey:"player.help.frm"}],y=ya(g.reduce((e,t)=>e+t.value,0)/g.length),_=function(e){return e>=85?{key:"player.tier.legendary",colorVar:"var(--player-legendary)"}:e>=70?{key:"player.tier.gold",colorVar:"var(--player-gold)"}:e>=50?{key:"player.tier.silver",colorVar:"var(--player-silver)"}:{key:"player.tier.bronze",colorVar:"var(--player-bronze)"}}(y),b=[...d?.attributes.activities??[]].sort((e,t)=>t.workouts-e.workouts)[0],f=b?.activity??p[0]?.activity;let w="";try{const e=ke(a,this._configuredDeviceId);w=a.devices?.[e]?.name_by_user||a.devices?.[e]?.name||""}catch{}return I`
      <ha-card class="static player-card" style="--tier-color:${_.colorVar}">
        ...
        <div class="pc-archetype">${Se(a,"player.archetype",{activity:Se(a,ga(f))})}</div>
    ...
    `],e([ve()],Sa.prototype,"_config",void 0),Sa=e([ue("suunto-level-card")],Sa);const Aa=[[/cycl|bik/i,"cycling"],[/run/i,"running"],[/trek|hik/i,"trekking"],[/walk/i,"walking"],[/gym|strength|weight/i,"gym"],[/swim/i,"swim"],[/ski/i,"ski"],[/row/i,"row"]];const Ta={cycling:"var(--sc-pulse)",running:"var(--sc-bad)",trekking:"var(--sc-good)",walking:"var(--sc-zone-1)",gym:"var(--sc-zone-4)",swim:"var(--sc-sleep-light)",ski:"var(--sc-sleep-deep)",row:"var(--sc-sleep-rem)",other:"var(--sc-amber)"},Ca=["var(--sc-pulse)","var(--sc-amber)","var(--sc-good)","var(--sc-sleep-rem)","var(--sc-zone-4)","var(--sc-sleep-deep)"];let Ea=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-class-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=t[s="lifetime_by_activity"]?a.states[t[s]]:void 0;var s;const r=i?.attributes.activities??[],n=r.reduce((e,t)=>e+t.workouts,0);if(!i||0===n)return this._message("mdi:sword-cross",Se(a,"empty.class.title"),Se(a,"empty.class.subtitle"));const o=[...r].sort((e,t)=>t.workouts-e.workouts).filter(e=>e.workouts>0),l=o[0],c=function(e){if(e)for(const[t,a]of Aa)if(t.test(e))return a;return"other"}(l?.activity),d=Ta[c],u=o.slice(0,5),m=o.slice(5).reduce((e,t)=>e+t.workouts,0);return I`
          ...
          <div class="milestone-side">
            ...
            ${void 0!==m&&void 0!==u?I`
                  <div class="sub-milestone">
                    ...
                    <div class="txt">
                      ${Ae(a,m,"next_milestone.workouts_one","next_milestone.workouts_other",{target:u})}
                    </div>
                  </div>
                `:K}
            ${void 0!==v&&void 0!==h?I`
                  <div class="chip accent">
                    <ha-icon icon="mdi:trending-up"></ha-icon>
                    ${Ae(a,v,"next_milestone.eta_one","next_milestone.eta_other",{pace:h.toFixed(0),weeks:v})}
                  </div>
                `:K}
          </div>
        </div>
        ...
        ${void 0!==p?I`
              <div class="story-block">
                ...
                <div>
                  <div class="t1">
                    ${Se(a,"records.streak")}:
                    ${Ae(a,p,"records.streak_days_one","records.streak_days_other",{count:p})}
                  </div>
    ...
    `],e([ve()],Ma.prototype,"_config",void 0),Ma=e([ue("suunto-story-card")],Ma);const Da=new Set(["unknown","unavailable",""]),Fa=208,Va=104,Pa=78;function Ha(e,t){const a=e*Math.PI/180;return[Va+t*Math.sin(a),Va-t*Math.cos(a)]}let La=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-sleep-clock-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("wake_time"),r=i("sleep_duration");if(!s||Da.has(s.state)||!r||Da.has(r.state))return this._message("mdi:sleep",Se(a,"empty.sleep_clock.title"),Se(a,"empty.sleep_clock.subtitle"));const n=new Date(s.state),o=Number(r.state);if(Number.isNaN(n.getTime())||!Number.isFinite(o)||o<=0)return this._message("mdi:sleep",Se(a,"empty.sleep_clock.title"),Se(a,"empty.sleep_clock.subtitle"));const l=new Date(n.getTime()-36e5*o),c=i("sleep_deep"),d=i("sleep_light"),u=i("sleep_rem"),m=c&&!Da.has(c.state)?Number(c.state):0,p=d&&!Da.has(d.state)?Number(d.state):0,h=u&&!Da.has(u.state)?Number(u.state):0,v=m+p+h>0?[{colorVar:"var(--sc-sleep-deep)",minutes:m},{colorVar:"var(--sc-sleep-light)",minutes:p},{colorVar:"var(--sc-sleep-rem)",minutes:h}].filter(e=>e.minutes>0):[{colorVar:"var(--sc-sleep-light)",minutes:60*o}],g=(60*l.getHours()+l.getMinutes())/1440*360,y=60*o/1440*360,_=v.reduce((e,t)=>e+t.minutes,0);let b=g;const f=v.map(e=>{const t=e.minutes/_*y,a=function(e,t){const[a,i]=Ha(e,Pa),[s,r]=Ha(t,Pa),n=t-e>180?1:0;return`M ${a.toFixed(2)} ${i.toFixed(2)} A 78 78 0 ${n} 1 ${s.toFixed(2)} ${r.toFixed(2)}`}(b,b+t);return b+=t,{d:a,colorVar:e.colorVar}}),w=i("sleep_quality"),k=w&&!Da.has(w.state)?Math.round(Number(w.state)):void 0,x=Ue(60*o),$=Ha(g,96),z=Ha(g+y,96);return I`
      <ha-card class="static">
        <div class="header">
          <div class="icon-badge pulse"><ha-icon icon="mdi:sleep"></ha-icon></div>
          <div class="title-block">
    ...
    `],e([ve()],Wa.prototype,"_config",void 0),e([ve()],Wa.prototype,"_nights",void 0),Wa=e([ue("suunto-sleep-rhythm-card")],Wa);const Ka=new Set(["unknown","unavailable",""]);let Ua=class extends Ce{static getConfigElement(){return document.createElement("suunto-device-editor")}static getStubConfig(){return{type:"custom:suunto-route-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 4}render(){if(!this._config||!this.hass)return K;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,a=this.hass,i=e=>t[e]?a.states[t[e]]:void 0,s=i("last_workout_location"),r=s?.attributes.route,n=(r??[]).map(([e,t,a])=>({lat:e,lon:t,speedKmh:a}));if(!s||Ka.has(s.state)||n.length<2)return this._message("mdi:map-marker-path",Se(a,"empty.route.title"),Se(a,"empty.route.subtitle"));const o=i("last_activity"),l=i("last_workout_start"),c=i("last_distance"),d=i("last_duration"),u=i("last_avg_pace"),m=`https://www.google.com/maps?q=${n[0].lat},${n[0].lon}`;return I`
      <ha-card class="static">
        ...
        <div class="footer-row">
          ...
          <a class="chip accent link" href=${m} target="_blank" rel="noopener noreferrer">
            <ha-icon icon="mdi:open-in-new"></ha-icon>
            ${Se(a,"location.open_in_maps")}
          </a>
        </div>
